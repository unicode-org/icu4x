...
import { StringIterator } from "./StringIterator.mjs"
...
export class ExemplarCharacters {
    ...
    codePointRanges() {
        ...
        const result = wasm.icu4x_ExemplarCharacters_code_point_ranges_mv1(this.ffiValue);
    ...
    strings() {
        const result = wasm.icu4x_ExemplarCharacters_strings_mv1(this.ffiValue);
    
        try {
            return new StringIterator(diplomatRuntime.internalConstructor, result, []);
        }
