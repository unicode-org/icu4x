...
const UnicodeSetData_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class UnicodeSetData {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      UnicodeSetData_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static load_basic_emoji(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new UnicodeSetData(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
