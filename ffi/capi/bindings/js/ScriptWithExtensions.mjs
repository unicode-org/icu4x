...
export class ScriptWithExtensions {
     ...
     */
        ...
        try {        return new ScriptWithExtensions(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new ScriptWithExtensionsBorrowed(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
