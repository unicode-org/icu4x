...
export class LineBreak {
     ...
     *
     * See the [Rust documentation for `to_icu4c_value`](https://docs.rs/icu/2.1.0/icu/properties/props/struct.LineBreak.html#method.to_icu4c_value) for more information.
     */
     ...
     *
     * See the [Rust documentation for `from_icu4c_value`](https://docs.rs/icu/2.1.0/icu/properties/props/struct.LineBreak.html#method.from_icu4c_value) for more information.
     */
