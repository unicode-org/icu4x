...
const DecomposingNormalizer_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class DecomposingNormalizer {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      DecomposingNormalizer_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static create_nfd(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new DecomposingNormalizer(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
