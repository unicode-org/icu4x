...
export class SentenceSegmenter {
     ...
     */
        ...
        try {        return new SentenceSegmenter(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new SentenceBreakIteratorUtf16(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
