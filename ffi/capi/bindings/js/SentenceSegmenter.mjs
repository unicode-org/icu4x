...
import { SentenceBreakOptions } from "./SentenceBreakOptions.mjs"
...
export class SentenceSegmenter {
    ...
    static withOptions(provider, options) {
        const diplomatReceive = new diplomatRuntime.DiplomatReceiveBuf(wasm, 5, 4, true);
        
        const result = wasm.icu4x_SentenceSegmenter_create_with_options_v1_mv1(diplomatReceive.buffer, provider.ffiValue, options.ffiValue);
