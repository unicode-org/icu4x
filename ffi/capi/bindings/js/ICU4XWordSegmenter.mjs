...
import { ICU4XWordBreakIteratorLatin1 } from "./ICU4XWordBreakIteratorLatin1.mjs"
import { ICU4XWordBreakIteratorUtf16 } from "./ICU4XWordBreakIteratorUtf16.mjs"
import { ICU4XWordBreakIteratorUtf8 } from "./ICU4XWordBreakIteratorUtf8.mjs"
...
export class ICU4XWordSegmenter {
  ...
  segment_utf8(arg_input) {
    ...
    const diplomat_out = new ICU4XWordBreakIteratorUtf8(wasm.ICU4XWordSegmenter_segment_utf8(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
  ...
  segment_utf16(arg_input) {
    ...
    const diplomat_out = new ICU4XWordBreakIteratorUtf16(wasm.ICU4XWordSegmenter_segment_utf16(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
    buf_arg_input.garbageCollect();
    return diplomat_out;
  }
  ...
  segment_latin1(arg_input) {
    ...
    const diplomat_out = new ICU4XWordBreakIteratorLatin1(wasm.ICU4XWordSegmenter_segment_latin1(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
    buf_arg_input.garbageCollect();
    return diplomat_out;
  }
}
