...
const RegionDisplayNames_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class RegionDisplayNames {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      RegionDisplayNames_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static create(arg_provider, arg_locale) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new RegionDisplayNames(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
