 ...
 * Result of a single iteration of {@link ICU4XCodePointRangeIterator `ICU4XCodePointRangeIterator`}. Logically can be considered to be an `Option<RangeInclusive<u32>>`,
