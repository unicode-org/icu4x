...
export class GraphemeClusterSegmenter {
     ...
     */
        ...
        try {        return new GraphemeClusterSegmenter(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new GraphemeClusterBreakIteratorUtf16(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
