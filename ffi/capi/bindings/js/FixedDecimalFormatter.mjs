...
import { DataStruct } from "./DataStruct.mjs"
...
export class FixedDecimalFormatter {
    ...
    static createWithDecimalSymbolsV1(dataStruct, groupingStrategy) {
        
        const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
        const result = wasm.ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1(diplomat_receive_buffer, dataStruct.ffiValue, groupingStrategy.ffiValue);
