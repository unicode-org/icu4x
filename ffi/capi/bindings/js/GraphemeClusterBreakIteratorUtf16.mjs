...
const GraphemeClusterBreakIteratorUtf16_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class GraphemeClusterBreakIteratorUtf16 {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      GraphemeClusterBreakIteratorUtf16_box_destroy_registry.register(this, underlying);
    }
  }
