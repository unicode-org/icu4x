...
export class ICU4XLocaleCanonicalizer {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/localeocaleCanonicalizer.html#method.new Rust documentation for `new`} for more information.
   ...
   * See the {@link https://docs.rs/icu/latest/icu/localeocaleCanonicalizer.html#method.new_with_expander Rust documentation for `new_with_expander`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/localeocaleCanonicalizer.html#method.canonicalize Rust documentation for `canonicalize`} for more information.
   */
