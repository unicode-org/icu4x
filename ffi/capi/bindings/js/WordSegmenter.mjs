...
import { WordBreakOptions } from "./WordBreakOptions.mjs"
...
export class WordSegmenter {
    ...
    static createAutoWithOptionsV1(provider, options) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_auto_with_options_v1_mv1(diplomatReceive.buffer, provider.ffiValue, options.ffiValue);
    ...
    static createLstmWithOptionsV1(provider, options) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_lstm_with_options_v1_mv1(diplomatReceive.buffer, provider.ffiValue, options.ffiValue);
    ...
    static createDictionaryWithOptionsV1(provider, options) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_dictionary_with_options_v1_mv1(diplomatReceive.buffer, provider.ffiValue, options.ffiValue);
