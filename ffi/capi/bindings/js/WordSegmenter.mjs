...
export class WordSegmenter {
    ...
    static createAuto(provider, locale) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_auto_mv1(diplomatReceive.buffer, provider.ffiValue, locale.ffiValue);
    ...
    static createLstm(provider, locale) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_lstm_mv1(diplomatReceive.buffer, provider.ffiValue, locale.ffiValue);
    ...
    static createDictionary(provider, locale) {
        ...
        const result = wasm.icu4x_WordSegmenter_create_dictionary_mv1(diplomatReceive.buffer, provider.ffiValue, locale.ffiValue);
