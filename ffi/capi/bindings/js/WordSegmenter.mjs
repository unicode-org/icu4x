...
export class WordSegmenter {
    ...
    segmentUtf8(input) {
        ...
        const result = wasm.ICU4XWordSegmenter_segment_utf8(this.ffiValue, inputSlice.ptr, inputSlice.size);
    
        try {
    
            return new WordBreakIteratorUtf8(result, [], aEdges);
        } finally {
    ...
    segmentLatin1(input) {
        ...
        // This lifetime edge depends on lifetimes 'a
        let aEdges = [this, inputSlice];
        const result = wasm.ICU4XWordSegmenter_segment_latin1(this.ffiValue, inputSlice.ptr, inputSlice.size);
    
        try {
    
            return new WordBreakIteratorLatin1(result, [], aEdges);
        } finally {
