...
import { WordBreakIteratorLatin1 } from "./WordBreakIteratorLatin1.mjs"
import { WordBreakIteratorUtf16 } from "./WordBreakIteratorUtf16.mjs"
import { WordBreakIteratorUtf8 } from "./WordBreakIteratorUtf8.mjs"

const WordSegmenter_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class WordSegmenter {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      WordSegmenter_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static create_auto(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new WordSegmenter(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
  ...
  segment_utf8(arg_input) {
    ...
    const diplomat_out = new WordBreakIteratorUtf8(wasm.ICU4XWordSegmenter_segment_utf8(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
  ...
  segment_utf16(arg_input) {
    ...
    const diplomat_out = new WordBreakIteratorUtf16(wasm.ICU4XWordSegmenter_segment_utf16(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
    buf_arg_input.garbageCollect();
    return diplomat_out;
  }
  ...
  segment_latin1(arg_input) {
    ...
    const diplomat_out = new WordBreakIteratorLatin1(wasm.ICU4XWordSegmenter_segment_latin1(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
    buf_arg_input.garbageCollect();
    return diplomat_out;
  }
}
