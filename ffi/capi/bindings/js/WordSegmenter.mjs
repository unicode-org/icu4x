...
export class WordSegmenter {
     ...
     */
        ...
        try {        return new WordSegmenter(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new WordBreakIteratorUtf16(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
