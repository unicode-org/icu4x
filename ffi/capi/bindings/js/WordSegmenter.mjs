...
export class WordSegmenter {
    ...
    static createAuto(provider, locale) {
        
        const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
        const result = wasm.icu4x_WordSegmenter_create_auto_mv1(diplomat_receive_buffer, provider.ffiValue, locale.ffiValue);
    ...
    static createLstm(provider, locale) {
        
        const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
        const result = wasm.icu4x_WordSegmenter_create_lstm_mv1(diplomat_receive_buffer, provider.ffiValue, locale.ffiValue);
    ...
    static createDictionary(provider, locale) {
        
        const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
        const result = wasm.icu4x_WordSegmenter_create_dictionary_mv1(diplomat_receive_buffer, provider.ffiValue, locale.ffiValue);
