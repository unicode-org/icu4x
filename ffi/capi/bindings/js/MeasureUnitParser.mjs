...
export class MeasureUnitParser {
    ...
    #defaultConstructor() {
        ...
        try {
            return new MeasureUnitParser(diplomatRuntime.internalConstructor, result, []);
        }
    ...
    parse(unitId) {
        ...
        const result = wasm.icu4x_MeasureUnitParser_parse_mv1(this.ffiValue, unitIdSlice.ptr);
