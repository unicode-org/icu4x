...
export class MeasureUnitParser {
     ...
     */
        ...
        const result = wasm.icu4x_MeasureUnitParser_create_mv1();

        try {        return new MeasureUnitParser(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        const result = wasm.icu4x_MeasureUnitParser_create_with_provider_mv1(diplomatReceive.buffer, provider.ffiValue);
     ...
     */
        ...
        try {        return result === 0 ? null : new MeasureUnit(diplomatRuntime.internalConstructor, result, []);
        }
