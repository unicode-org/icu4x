...
export class TimeZoneInfo {
    ...
    setLocalTime(date, time) {wasm.icu4x_TimeZoneInfo_set_local_time_mv1(this.ffiValue, date.ffiValue, time.ffiValue);
    ...
    get getLocalTime() {
        ...
        const result = wasm.icu4x_TimeZoneInfo_get_local_time_mv1(diplomatReceive.buffer, this.ffiValue);
