...
export class LocaleDirectionality {
     ...
     */
        ...
        try {        return new LocaleDirectionality(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new LocaleDirection(diplomatRuntime.internalConstructor, result);
        }
