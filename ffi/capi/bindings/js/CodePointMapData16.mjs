...
export class CodePointMapData16 {
     ...
     */
        ...
        try {        return new CodePointRangeIterator(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
     ...
     */
        ...
        try {        return new CodePointMapData16(diplomatRuntime.internalConstructor, result, []);
        }
