...
const Time_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class Time {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      Time_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static create(arg_hour, arg_minute, arg_second, arg_nanosecond) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new Time(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
