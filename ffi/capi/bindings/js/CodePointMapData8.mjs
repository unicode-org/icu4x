...
const CodePointMapData8_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class CodePointMapData8 {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      CodePointMapData8_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  get_set_for_value(arg_value) {
    return new CodePointSetData(wasm.ICU4XCodePointMapData8_get_set_for_value(this.underlying, arg_value), true, []);
  }
  ...
  static load_general_category(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new CodePointMapData8(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
