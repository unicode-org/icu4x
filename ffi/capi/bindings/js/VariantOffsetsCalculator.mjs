...
export class VariantOffsetsCalculator {
     ...
     */
    computeOffsetsForTimeZoneAndLocalDatetime(timeZone, localDate, localTime) {
        const diplomatReceive = new diplomatRuntime.DiplomatReceiveBuf(wasm, 9, 4, true);
        
        const result = wasm.icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(diplomatReceive.buffer, this.ffiValue, timeZone.ffiValue, localDate.ffiValue, localTime.ffiValue);
