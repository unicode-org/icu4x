...
export class IsoDate {
    ...
    static fromString(v) {
        ...
        try {
            ...
            if (!diplomatRuntime.resultFlag(wasm, diplomat_receive_buffer, 4)) {
                const cause = ParseError[Array.from(ParseError.values.keys())[diplomatRuntime.enumDiscriminant(wasm, diplomat_receive_buffer)]];
                throw new Error('ParseError: ' + cause.value, { cause });
            }
            return new IsoDate(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), []);
        } finally {
