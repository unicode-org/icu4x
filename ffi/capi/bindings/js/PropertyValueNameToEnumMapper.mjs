...
const PropertyValueNameToEnumMapper_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class PropertyValueNameToEnumMapper {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      PropertyValueNameToEnumMapper_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static load_general_category(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new PropertyValueNameToEnumMapper(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
