...
import { LineBreakOptionsV1 } from "./LineBreakOptionsV1.mjs"
...
export class LineSegmenter {
    ...
    static createAutoWithOptionsV1(provider, options) {
    ...
    static createLstmWithOptionsV1(provider, options) {
    ...
    static createDictionaryWithOptionsV1(provider, options) {
    ...
    segmentUtf8(input) {
        ...
        const result = wasm.ICU4XLineSegmenter_segment_utf8(this.ffiValue, inputSlice.ptr, inputSlice.size);
    
        try {
    
            return new LineBreakIteratorUtf8(result, [], aEdges);
        } finally {
    ...
    segmentLatin1(input) {
        ...
        // This lifetime edge depends on lifetimes 'a
        let aEdges = [this, inputSlice];
        const result = wasm.ICU4XLineSegmenter_segment_latin1(this.ffiValue, inputSlice.ptr, inputSlice.size);
    
        try {
    
            return new LineBreakIteratorLatin1(result, [], aEdges);
        } finally {
