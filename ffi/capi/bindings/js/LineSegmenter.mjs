...
export class LineSegmenter {
     ...
     */
        ...
        try {        return new LineSegmenter(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new LineBreakIteratorUtf16(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
