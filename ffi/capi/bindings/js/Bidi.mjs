...
export class Bidi {
     ...
     */
        ...
        try {        return new Bidi(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new BidiInfo(diplomatRuntime.internalConstructor, result, [], textEdges);
        }
     ...
     */
        ...
        try {        return new ReorderedIndexMap(diplomatRuntime.internalConstructor, result, []);
        }
