...
export class DateTimeFormatterLoadError {
    ...
    static #objectValues = {
        ...
        [2050]: new DateTimeFormatterLoadError(diplomatRuntime.internalConstructor, diplomatRuntime.internalConstructor, 2050),
    ...
    static UnsupportedCalendar = DateTimeFormatterLoadError.#objectValues[2050];
