...
export class WordSegmenter {
    ...
    static createAuto(provider: DataProvider, locale: Locale): WordSegmenter;

    static createLstm(provider: DataProvider, locale: Locale): WordSegmenter;

    static createDictionary(provider: DataProvider, locale: Locale): WordSegmenter;
