...
export class CanonicalDecomposition {
     ...
     */
        ...
        try {        return new CanonicalDecomposition(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return Decomposed._fromFFI(diplomatRuntime.internalConstructor, diplomatReceive.buffer);
        }
