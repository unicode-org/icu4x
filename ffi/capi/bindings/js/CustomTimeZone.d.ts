...
import { TimeZoneIdMapper } from "./TimeZoneIdMapper";
import { TimeZoneInvalidIdError } from "./TimeZoneInvalidIdError";
import { TimeZoneInvalidOffsetError } from "./TimeZoneInvalidOffsetError";
...
export class CustomTimeZone {
   ...
   */
  static create_from_string(s: string): CustomTimeZone | never;
   ...
   */
  static create_empty(): CustomTimeZone;
   ...
   */
  static create_utc(): CustomTimeZone;
   ...
   */
  static create_gmt(): CustomTimeZone;
   ...
   */
  static create_bst(): CustomTimeZone;
   ...
   * @throws {@link FFIError}<{@link TimeZoneInvalidIdError}>
   */
  try_set_iana_time_zone_id(mapper: TimeZoneIdMapper, id: string): void | never;
   ...
   */
  maybe_calculate_metazone(metazone_calculator: MetazoneCalculator, local_datetime: IsoDateTime): void;
}
