...
export class WindowsParser {
     ...
     */
        ...
        try {        return new WindowsParser(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return result === 0 ? null : new TimeZone(diplomatRuntime.internalConstructor, result, []);
        }
