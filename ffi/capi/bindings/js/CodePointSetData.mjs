...
const CodePointSetData_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class CodePointSetData {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      CodePointSetData_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static load_for_general_category_group(arg_provider, arg_group) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new CodePointSetData(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
