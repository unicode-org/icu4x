...
export class IanaParserExtended {
     ...
     */
        ...
        try {        return new IanaParserExtended(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return TimeZoneAndCanonicalAndNormalized._fromFFI(diplomatRuntime.internalConstructor, diplomatReceive.buffer, aEdges);
        }
     ...
     */
        ...
        try {        return new TimeZoneAndCanonicalIterator(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
     ...
     */
        ...
        try {        return new TimeZoneAndCanonicalAndNormalizedIterator(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
