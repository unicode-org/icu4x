...
export class LocaleFallbacker {
     ...
     */
        ...
        try {        return new LocaleFallbacker(diplomatRuntime.internalConstructor, result, []);
        }
     ...
     */
        ...
        try {        return new LocaleFallbackerWithConfig(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
