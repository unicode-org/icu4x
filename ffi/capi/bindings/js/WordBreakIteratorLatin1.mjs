...
/** 
 * See the [Rust documentation for `WordBreakIteratorLatin1`](https://docs.rs/icu/latest/icu/segmenter/word/type.WordBreakIteratorLatin1.html) for more information.
 */
...
export class WordBreakIteratorLatin1 {
     ...
     *
     * See the [Rust documentation for `next`](https://docs.rs/icu/latest/icu/segmenter/word/type.WordBreakIteratorLatin1.html#method.next) for more information.
     */
    next() {
     ...
     *
     * See the [Rust documentation for `word_type`](https://docs.rs/icu/latest/icu/segmenter/word/type.WordBreakIteratorLatin1.html#method.word_type) for more information.
     */
    get wordType() {
     ...
     *
     * See the [Rust documentation for `is_word_like`](https://docs.rs/icu/latest/icu/segmenter/word/type.WordBreakIteratorLatin1.html#method.is_word_like) for more information.
     */
    get isWordLike() {
