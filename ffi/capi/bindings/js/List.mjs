...
const List_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class List {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      List_box_destroy_registry.register(this, underlying);
    }
  }

  static create() {
    return new List(wasm.ICU4XList_create(), true, []);
  }

  static create_with_capacity(arg_capacity) {
    return new List(wasm.ICU4XList_create_with_capacity(arg_capacity), true, []);
  }
