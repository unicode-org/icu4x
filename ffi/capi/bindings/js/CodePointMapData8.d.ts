...
export class CodePointMapData8 {
   ...
   */
  get_set_for_value(value: u8): CodePointSetData;
   ...
   */
  static load_general_category(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_bidi_class(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_east_asian_width(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_hangul_syllable_type(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_indic_syllabic_category(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_line_break(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static try_grapheme_cluster_break(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_word_break(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_sentence_break(provider: DataProvider): CodePointMapData8 | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_joining_type(provider: DataProvider): CodePointMapData8 | never;
}
