...
export class ScriptWithExtensionsBorrowed {
     ...
     */
        ...
        try {        return new ScriptExtensionsSet(diplomatRuntime.internalConstructor, result, [], aEdges);
        }
     ...
     */
        ...
        try {        return new CodePointSetData(diplomatRuntime.internalConstructor, result, []);
        }
