...
import { ScriptExtensionsSet } from "./ScriptExtensionsSet";
...
export class ScriptWithExtensionsBorrowed {
   ...
   */
  get_script_extensions_val(code_point: u32): ScriptExtensionsSet;
   ...
   */
  get_script_extensions_set(script: u16): CodePointSetData;
}
