...
static createFromFieldSetBuilder(locale, builder) {
        ...
        const result = wasm.icu4x_ZonedDateTimeFormatter_create_from_field_set_builder_mv1(diplomatReceive.buffer, locale.ffiValue, ...DateTimeFieldSetBuilder._fromSuppliedValue(diplomatRuntime.internalConstructor, builder)._intoFFI(functionCleanupArena, {}));
...
static createFromFieldSetBuilderWithProvider(provider, locale, builder) {
        ...
        const result = wasm.icu4x_ZonedDateTimeFormatter_create_from_field_set_builder_with_provider_mv1(diplomatReceive.buffer, provider.ffiValue, locale.ffiValue, ...DateTimeFieldSetBuilder._fromSuppliedValue(diplomatRuntime.internalConstructor, builder)._intoFFI(functionCleanupArena, {}));
