...
const MetazoneCalculator_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class MetazoneCalculator {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      MetazoneCalculator_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  static create(arg_provider) {
    return (() => {
      ...
      if (is_ok) {
        const ok_value = new MetazoneCalculator(diplomatRuntime.ptrRead(wasm, diplomat_receive_buffer), true, []);
