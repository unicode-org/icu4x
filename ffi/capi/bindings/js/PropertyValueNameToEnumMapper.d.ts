...
export class PropertyValueNameToEnumMapper {
   ...
   */
  static load_general_category(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_hangul_syllable_type(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_east_asian_width(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_bidi_class(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_indic_syllabic_category(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_line_break(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_grapheme_cluster_break(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_word_break(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_sentence_break(provider: DataProvider): PropertyValueNameToEnumMapper | never;
   ...
   * @throws {@link FFIError}<{@link DataError}>
   */
  static load_script(provider: DataProvider): PropertyValueNameToEnumMapper | never;
}
