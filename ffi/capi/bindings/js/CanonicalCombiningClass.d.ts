...
/**
 * See the [Rust documentation for `CanonicalCombiningClass`](https://docs.rs/icu/2.1.0/icu/properties/props/struct.CanonicalCombiningClass.html) for more information.
 */
export class CanonicalCombiningClass {
     ...
     *
     * See the [Rust documentation for `to_icu4c_value`](https://docs.rs/icu/2.1.0/icu/properties/props/struct.CanonicalCombiningClass.html#method.to_icu4c_value) for more information.
     */
     ...
     *
     * See the [Rust documentation for `from_icu4c_value`](https://docs.rs/icu/2.1.0/icu/properties/props/struct.CanonicalCombiningClass.html#method.from_icu4c_value) for more information.
     */
