...
export class ICU4XLocaleFallbackIterator {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbackIterator.html#method.get Rust documentation for `get`} for more information.
   */
  get(): ICU4XLocale;
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbackIterator.html#method.step Rust documentation for `step`} for more information.
   */
  step(): void;
}
