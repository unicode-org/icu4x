...
const GraphemeClusterBreakIteratorLatin1_box_destroy_registry = new FinalizationRegistry(underlying => {
...
export class GraphemeClusterBreakIteratorLatin1 {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      GraphemeClusterBreakIteratorLatin1_box_destroy_registry.register(this, underlying);
    }
  }
