 ...
 * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbackerWithConfig.html Rust documentation for `LocaleFallbackerWithConfig`} for more information.
 */
export class ICU4XLocaleFallbackerWithConfig {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbacker.html#method.fallback_for Rust documentation for `fallback_for`} for more information.
   */
