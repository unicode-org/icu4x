...
export class DateTimeFormatter {
    ...
    static createWithLength(locale, length) {
        ...
        const result = wasm.icu4x_DateTimeFormatter_create_with_length_mv1(diplomatReceive.buffer, locale.ffiValue, length.ffiValue);
    ...
    static createWithLengthAndProvider(provider, locale, length) {
        ...
        const result = wasm.icu4x_DateTimeFormatter_create_with_length_and_provider_mv1(diplomatReceive.buffer, provider.ffiValue, locale.ffiValue, length.ffiValue);
    ...
    calendarBcp47() {
        const result = wasm.icu4x_DateTimeFormatter_calendar_bcp47_mv1(this.ffiValue);
