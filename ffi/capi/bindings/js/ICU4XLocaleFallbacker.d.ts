...
export class ICU4XLocaleFallbacker {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbacker.html#method.new Rust documentation for `new`} for more information.
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbacker.html#method.new_without_data Rust documentation for `new_without_data`} for more information.
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/locale/struct.LocaleFallbacker.html#method.for_config Rust documentation for `for_config`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
