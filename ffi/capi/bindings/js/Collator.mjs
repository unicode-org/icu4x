...
import { CollatorOptionsV1 } from "./CollatorOptionsV1.mjs"
...
export class Collator {
    ...
    compareUtf16(left, right) {
        ...
        const result = wasm.ICU4XCollator_compare_utf16_(this.ffiValue, leftSlice.ptr, leftSlice.size, rightSlice.ptr, rightSlice.size);
    ...
    compare(left, right) {
        ...
        const leftSlice = diplomatRuntime.DiplomatBuf.str8(wasm, left);
        
        const rightSlice = diplomatRuntime.DiplomatBuf.str8(wasm, right);
        const result = wasm.ICU4XCollator_compare_(this.ffiValue, leftSlice.ptr, leftSlice.size, rightSlice.ptr, rightSlice.size);
    ...
    get resolvedOptions() {
        ...
        try {
            ...
            return new CollatorResolvedOptionsV1(diplomat_receive_buffer);
        } finally {
