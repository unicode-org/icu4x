...
export class PluralRules {
     ...
     */
        ...
        try {        return new PluralCategory(diplomatRuntime.internalConstructor, result);
        }
     ...
     */
        ...
        try {        return PluralCategories._fromFFI(diplomatRuntime.internalConstructor, diplomatReceive.buffer);
        }
