...
internal interface BidiClassLib: Library {
    fun icu4x_BidiClass_for_char_mv1(ch: Int): Int
    fun icu4x_BidiClass_long_name_mv1(inner: Int): OptionSlice
    fun icu4x_BidiClass_short_name_mv1(inner: Int): OptionSlice
    fun icu4x_BidiClass_to_integer_value_mv1(inner: Int): FFIUint8
...
enum class BidiClass {
    ...
    companion object {
        internal val libClass: Class<BidiClassLib> = BidiClassLib::class.java
        internal val lib: BidiClassLib = Native.load("icu4x", libClass) 
        fun fromNative(native: Int): BidiClass {
            return BidiClass.entries[native]
        }

        fun default(): BidiClass {
            return LeftToRight
        }
        @JvmStatic
        ...
        */
        fun forChar(ch: Int): BidiClass {
            ...
            return (BidiClass.fromNative(returnVal))
        }
        @JvmStatic
        ...
        */
        fun fromIntegerValue(other: UByte): BidiClass? {
            ...
            return BidiClass.fromNative(intermediateOption)
        }
    }
