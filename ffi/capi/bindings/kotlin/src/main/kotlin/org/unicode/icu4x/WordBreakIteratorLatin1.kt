...
internal interface WordBreakIteratorLatin1Lib: Library {
    fun icu4x_WordBreakIteratorLatin1_destroy_mv1(handle: Pointer)
    fun icu4x_WordBreakIteratorLatin1_next_mv1(handle: Pointer): Int
...
class WordBreakIteratorLatin1 internal constructor (
    ...
    internal class WordBreakIteratorLatin1Cleaner(val handle: Pointer, val lib: WordBreakIteratorLatin1Lib) : Runnable {
        override fun run() {
            lib.icu4x_WordBreakIteratorLatin1_destroy_mv1(handle)
        }
    }

    companion object {
        internal val libClass: Class<WordBreakIteratorLatin1Lib> = WordBreakIteratorLatin1Lib::class.java
