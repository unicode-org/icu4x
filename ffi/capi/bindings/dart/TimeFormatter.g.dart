...
final class TimeFormatter implements ffi.Finalizable {
  ...
  String formatIsoDatetime(IsoDateTime value) {
    final writeable = _Writeable();
    _ICU4XTimeFormatter_format_iso_datetime(_ffi, value._ffi, writeable._ffi);
    return writeable.finalize();
  }
}
...
// ignore: non_constant_identifier_names
external void _ICU4XTimeFormatter_format_time(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> value, ffi.Pointer<ffi.Opaque> writeable);
...
// ignore: non_constant_identifier_names
external void _ICU4XTimeFormatter_format_datetime(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> value, ffi.Pointer<ffi.Opaque> writeable);
...
// ignore: non_constant_identifier_names
external void _ICU4XTimeFormatter_format_iso_datetime(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> value, ffi.Pointer<ffi.Opaque> writeable);
