...
final class ZonedDateTimeFormatter implements ffi.Finalizable {
  ...
  String formatZonedDatetime(Date date, Time time, TimeZoneInfo zone) {
    final write = _Write();
    final result = _icu4x_ZonedDateTimeFormatter_format_zoned_datetime_mv1(_ffi, date._ffi, time._ffi, zone._ffi, write._ffi);
    if (!result.isOk) {
  ...
  String formatZonedIsoDatetime(IsoDate date, Time time, TimeZoneInfo zone) {
    final write = _Write();
    final result = _icu4x_ZonedDateTimeFormatter_format_zoned_iso_datetime_mv1(_ffi, date._ffi, time._ffi, zone._ffi, write._ffi);
    if (!result.isOk) {
      throw DateTimeFormatError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return write.finalize();
...
@meta.RecordUse()
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_ZonedDateTimeFormatter_format_zoned_datetime_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_ZonedDateTimeFormatter_format_zoned_datetime_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> date, ffi.Pointer<ffi.Opaque> time, ffi.Pointer<ffi.Opaque> zone, ffi.Pointer<ffi.Opaque> write);

@meta.RecordUse()
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_ZonedDateTimeFormatter_format_zoned_iso_datetime_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_ZonedDateTimeFormatter_format_zoned_iso_datetime_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> date, ffi.Pointer<ffi.Opaque> time, ffi.Pointer<ffi.Opaque> zone, ffi.Pointer<ffi.Opaque> write);
