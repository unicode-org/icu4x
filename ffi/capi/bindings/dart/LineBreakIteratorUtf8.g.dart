...
final class LineBreakIteratorUtf8 implements ffi.Finalizable {
  ...
  LineBreakIteratorUtf8._(this._underlying, bool isOwned, this._edge_self, this._edge_a) {
    if (isOwned) {
...
@meta.ResourceIdentifier('ICU4XLineBreakIteratorUtf8_destroy')
...
@meta.ResourceIdentifier('ICU4XLineBreakIteratorUtf8_next')
