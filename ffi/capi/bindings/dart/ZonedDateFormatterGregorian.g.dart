...
final class ZonedDateFormatterGregorian implements ffi.Finalizable {
  ...
  factory ZonedDateFormatterGregorian.fromFieldSetBuilder(Locale locale, DateTimeFieldSetBuilder builder) {
    final temp = _FinalizedArena();
    final result = _icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1(locale._ffi, builder._toFfi(temp.arena));
    if (!result.isOk) {
  ...
  ///
  /// Throws [DateTimeFormatterBuildOrLoadError] on failure.
  factory ZonedDateFormatterGregorian.fromFieldSetBuilderWithProvider(DataProvider provider, Locale locale, DateTimeFieldSetBuilder builder) {
    final temp = _FinalizedArena();
    final result = _icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1(provider._ffi, locale._ffi, builder._toFfi(temp.arena));
    if (!result.isOk) {
      throw DateTimeFormatterBuildOrLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return ZonedDateFormatterGregorian._fromFfi(result.union.ok, []);
...
@_DiplomatFfiUse('icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, _DateTimeFieldSetBuilderFfi)>(isLeaf: true, symbol: 'icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1(ffi.Pointer<ffi.Opaque> locale, _DateTimeFieldSetBuilderFfi builder);

@_DiplomatFfiUse('icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, _DateTimeFieldSetBuilderFfi)>(isLeaf: true, symbol: 'icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1(ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale, _DateTimeFieldSetBuilderFfi builder);
