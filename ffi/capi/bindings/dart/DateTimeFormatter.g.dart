...
final class DateTimeFormatter implements ffi.Finalizable {
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneGenericShort(Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_generic_short_mv1(_ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneGenericShortAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_generic_short_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneGenericLongAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_generic_long_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneSpecificShort(Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_specific_short_mv1(_ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneSpecificShortAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_specific_short_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneSpecificLong(Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_specific_long_mv1(_ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneSpecificLongAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_specific_long_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneLocalizedOffsetShort(Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_localized_offset_short_mv1(_ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneLocalizedOffsetShortAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_localized_offset_short_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneLocalizedOffsetLong(Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_localized_offset_long_mv1(_ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
  ...
  ///
  /// Throws [DateTimeFormatterLoadError] on failure.
  NeoZonedDateTimeFormatter withZoneLocalizedOffsetLongAndProvider(DataProvider provider, Locale locale) {
    final result = _icu4x_DateTimeFormatter_with_zone_localized_offset_long_and_provider_mv1(_ffi, provider._ffi, locale._ffi);
    if (!result.isOk) {
      throw DateTimeFormatterLoadError.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return NeoZonedDateTimeFormatter._fromFfi(result.union.ok, []);
...
@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_generic_short_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_generic_short_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_generic_short_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_generic_short_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_generic_short_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_generic_short_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);
...
@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_generic_long_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_generic_long_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_generic_long_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_specific_short_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_specific_short_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_specific_short_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_specific_short_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_specific_short_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_specific_short_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_specific_long_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_specific_long_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_specific_long_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_specific_long_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_specific_long_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_specific_long_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_localized_offset_short_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_localized_offset_short_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_localized_offset_short_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_localized_offset_short_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_localized_offset_short_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_localized_offset_short_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_localized_offset_long_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_localized_offset_long_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_localized_offset_long_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> locale);

@_DiplomatFfiUse('icu4x_DateTimeFormatter_with_zone_localized_offset_long_and_provider_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTimeFormatter_with_zone_localized_offset_long_and_provider_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTimeFormatter_with_zone_localized_offset_long_and_provider_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> provider, ffi.Pointer<ffi.Opaque> locale);
