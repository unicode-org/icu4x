...
final class PropertyValueNameToEnumMapper implements ffi.Finalizable {
  ...
  int getStrict(String name) {
    ...
    final result = _ICU4XPropertyValueNameToEnumMapper_get_strict(
        _ffi, nameView.allocIn(temp), nameView.length);
    temp.releaseAll();
    return result;
  }
  ...
  factory PropertyValueNameToEnumMapper.bidiClass(DataProvider provider) {
    final result =
        _ICU4XPropertyValueNameToEnumMapper_load_bidi_class(provider._ffi);
    if (!result.isOk) {
      throw Error.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return PropertyValueNameToEnumMapper._fromFfi(result.union.ok, []);
  ...
  factory PropertyValueNameToEnumMapper.lineBreak(DataProvider provider) {
    final result =
        _ICU4XPropertyValueNameToEnumMapper_load_line_break(provider._ffi);
    if (!result.isOk) {
      throw Error.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return PropertyValueNameToEnumMapper._fromFfi(result.union.ok, []);
  ...
  factory PropertyValueNameToEnumMapper.wordBreak(DataProvider provider) {
    final result =
        _ICU4XPropertyValueNameToEnumMapper_load_word_break(provider._ffi);
    if (!result.isOk) {
      throw Error.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return PropertyValueNameToEnumMapper._fromFfi(result.union.ok, []);
  ...
  factory PropertyValueNameToEnumMapper.sentenceBreak(DataProvider provider) {
    final result =
        _ICU4XPropertyValueNameToEnumMapper_load_sentence_break(provider._ffi);
    if (!result.isOk) {
      throw Error.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return PropertyValueNameToEnumMapper._fromFfi(result.union.ok, []);
  ...
  factory PropertyValueNameToEnumMapper.script(DataProvider provider) {
    final result =
        _ICU4XPropertyValueNameToEnumMapper_load_script(provider._ffi);
    if (!result.isOk) {
      throw Error.values.firstWhere((v) => v._ffi == result.union.err);
    }
    return PropertyValueNameToEnumMapper._fromFfi(result.union.ok, []);
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_get_strict')
@ffi.Native<
        ffi.Int16 Function(
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_get_loose')
@ffi.Native<
        ffi.Int16 Function(
            ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size)>(
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_general_category')
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_hangul_syllable_type')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_east_asian_width')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_bidi_class')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_indic_syllabic_category')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_line_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_grapheme_cluster_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_word_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_sentence_break')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true,
...
@RecordSymbol('ICU4XPropertyValueNameToEnumMapper_load_script')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>)>(
