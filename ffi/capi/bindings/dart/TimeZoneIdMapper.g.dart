...
final class TimeZoneIdMapper implements ffi.Finalizable {
  ...
  String ianaToBcp47(String value) {
    ...
    final write = _Write();
    final result = _icu4x_TimeZoneIdMapper_iana_to_bcp47_mv1(_ffi, valueView.allocIn(temp), valueView.length, write._ffi);
    temp.releaseAll();
    if (!result.isOk) {
  ...
  String normalizeIana(String value) {
    ...
    final valueView = value.utf8View;
    final write = _Write();
    final result = _icu4x_TimeZoneIdMapper_normalize_iana_mv1(_ffi, valueView.allocIn(temp), valueView.length, write._ffi);
    temp.releaseAll();
    if (!result.isOk) {
      throw TimeZoneInvalidIdError();
    }
  ...
  String canonicalizeIana(String value) {
    ...
    final valueView = value.utf8View;
    final write = _Write();
    final result = _icu4x_TimeZoneIdMapper_canonicalize_iana_mv1(_ffi, valueView.allocIn(temp), valueView.length, write._ffi);
    temp.releaseAll();
    if (!result.isOk) {
      throw TimeZoneInvalidIdError();
    }
  ...
  String findCanonicalIanaFromBcp47(String value) {
    ...
    final valueView = value.utf8View;
    final write = _Write();
    final result = _icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1(_ffi, valueView.allocIn(temp), valueView.length, write._ffi);
    temp.releaseAll();
    if (!result.isOk) {
      throw TimeZoneInvalidIdError();
    }
...
@ffi.Native<_ResultVoidTimeZoneInvalidIdErrorFfi Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_iana_to_bcp47_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidTimeZoneInvalidIdErrorFfi _icu4x_TimeZoneIdMapper_iana_to_bcp47_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_normalize_iana_mv1')
@ffi.Native<_ResultVoidTimeZoneInvalidIdErrorFfi Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_normalize_iana_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidTimeZoneInvalidIdErrorFfi _icu4x_TimeZoneIdMapper_normalize_iana_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_canonicalize_iana_mv1')
@ffi.Native<_ResultVoidTimeZoneInvalidIdErrorFfi Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_canonicalize_iana_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidTimeZoneInvalidIdErrorFfi _icu4x_TimeZoneIdMapper_canonicalize_iana_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1')
@ffi.Native<_ResultVoidTimeZoneInvalidIdErrorFfi Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidTimeZoneInvalidIdErrorFfi _icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);
