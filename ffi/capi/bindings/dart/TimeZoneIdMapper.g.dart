...
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_iana_to_bcp47_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_TimeZoneIdMapper_iana_to_bcp47_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_normalize_iana_mv1')
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_normalize_iana_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_TimeZoneIdMapper_normalize_iana_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_canonicalize_iana_mv1')
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_canonicalize_iana_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_TimeZoneIdMapper_canonicalize_iana_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);

@meta.ResourceIdentifier('icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1')
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Uint8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_TimeZoneIdMapper_find_canonical_iana_from_bcp47_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Uint8> valueData, int valueLength, ffi.Pointer<ffi.Opaque> write);
