...
final class ZonedDateTime {
  ...
  factory ZonedDateTime.fromString(String v, Calendar calendar, IanaParser ianaParser) {
    final temp = _FinalizedArena();
    final result = _icu4x_ZonedDateTime_from_string_mv1(v._utf8AllocIn(temp.arena), calendar._ffi, ianaParser._ffi);
    if (!result.isOk) {
...
@ffi.Native<_ResultZonedDateTimeFfiInt32 Function(_SliceUtf8, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_ZonedDateTime_from_string_mv1')
// ignore: non_constant_identifier_names
external _ResultZonedDateTimeFfiInt32 _icu4x_ZonedDateTime_from_string_mv1(_SliceUtf8 v, ffi.Pointer<ffi.Opaque> calendar, ffi.Pointer<ffi.Opaque> ianaParser);
