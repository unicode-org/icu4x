...
final class DateFormatterGregorian implements ffi.Finalizable {
  ...
  String formatIso(IsoDate date) {
    final write = _Write();
    _icu4x_DateFormatterGregorian_format_iso_mv1(_ffi, date._ffi, write._ffi);
...
// ignore: non_constant_identifier_names
external void _icu4x_DateFormatterGregorian_format_iso_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> date, ffi.Pointer<ffi.Opaque> write);
