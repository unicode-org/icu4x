...
final class DateTime implements ffi.Finalizable {
  ...
  factory DateTime.fromString(String v) {
    ...
    final result = _icu4x_DateTime_create_from_string_mv1(vView.allocIn(temp), vView.length);
    temp.releaseAll();
    if (!result.isOk) {
...
@meta.ResourceIdentifier('icu4x_DateTime_create_from_string_mv1')
@ffi.Native<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Uint8>, ffi.Size)>(isLeaf: true, symbol: 'icu4x_DateTime_create_from_string_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTime_create_from_string_mv1(ffi.Pointer<ffi.Uint8> vData, int vLength);
