...
final class DateTime implements ffi.Finalizable {
  ...
  ///
  /// See the [Rust documentation for `try_new_from_codes`](https://docs.rs/icu/latest/icu/timezone/struct.DateTime.html#method.try_new_from_codes) for more information.
  ///
  /// Throws [CalendarError] on failure.
  factory DateTime.fromCodesInCalendar(String eraCode, int year, String monthCode, int day, int hour, int minute, int second, int nanosecond, Calendar calendar) {
    ...
    final result = _icu4x_DateTime_from_codes_in_calendar_mv1(eraCode._utf8AllocIn(temp.arena), year, monthCode._utf8AllocIn(temp.arena), day, hour, minute, second, nanosecond, calendar._ffi);
    if (!result.isOk) {
      throw CalendarError.values[result.union.err];
    }
    return DateTime._fromFfi(result.union.ok, []);
  ...
  ///
  /// See the [Rust documentation for `to_iso`](https://docs.rs/icu/latest/icu/timezone/struct.DateTime.html#method.to_iso) for more information.
  IsoDateTime toIso() {
...
@meta.RecordUse()
@ffi.Native<_ResultOpaqueInt32 Function(_SliceUtf8, ffi.Int32, _SliceUtf8, ffi.Uint8, ffi.Uint8, ffi.Uint8, ffi.Uint8, ffi.Uint32, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTime_from_codes_in_calendar_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTime_from_codes_in_calendar_mv1(_SliceUtf8 eraCode, int year, _SliceUtf8 monthCode, int day, int hour, int minute, int second, int nanosecond, ffi.Pointer<ffi.Opaque> calendar);
...
@meta.RecordUse()
@ffi.Native<_ResultOpaqueInt32 Function(_SliceUtf8, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTime_from_string_mv1')
// ignore: non_constant_identifier_names
external _ResultOpaqueInt32 _icu4x_DateTime_from_string_mv1(_SliceUtf8 v, ffi.Pointer<ffi.Opaque> calendar);
...
@meta.RecordUse()
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_DateTime_day_of_month_mv1')
// ignore: non_constant_identifier_names
...
@meta.RecordUse()
@ffi.Native<ffi.Uint8 Function(ffi.Pointer<ffi.Opaque>, ffi.Int32)>(isLeaf: true, symbol: 'icu4x_DateTime_week_of_month_mv1')
// ignore: non_constant_identifier_names
