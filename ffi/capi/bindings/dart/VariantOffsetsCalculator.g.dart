...
final class VariantOffsetsCalculator implements ffi.Finalizable {
  ...
  VariantOffsets? computeOffsetsForTimeZoneAndLocalDatetime(TimeZone timeZone, IsoDate localDate, Time localTime) {
    final result = _icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(_ffi, timeZone._ffi, localDate._ffi, localTime._ffi);
    if (!result.isOk) {
      return null;
    }
...
@_DiplomatFfiUse('icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1')
@ffi.Native<_ResultVariantOffsetsFfiVoid Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true, symbol: 'icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1')
// ignore: non_constant_identifier_names
external _ResultVariantOffsetsFfiVoid _icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> timeZone, ffi.Pointer<ffi.Opaque> localDate, ffi.Pointer<ffi.Opaque> localTime);
