...
final class VariantOffsetsCalculator implements ffi.Finalizable {
  ...
  VariantOffsets? computeOffsetsFromTimeZoneAndDateTime(TimeZone timeZone, IsoDate localDate, Time localTime) {
    final result = _icu4x_VariantOffsetsCalculator_compute_offsets_from_time_zone_and_date_time_mv2(_ffi, timeZone._ffi, localDate._ffi, localTime._ffi);
    if (!result.isOk) {
      return null;
    }
...
// ignore: non_constant_identifier_names
external _ResultVariantOffsetsFfiVoid _icu4x_VariantOffsetsCalculator_compute_offsets_from_time_zone_and_date_time_mv2(ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> timeZone, ffi.Pointer<ffi.Opaque> localDate, ffi.Pointer<ffi.Opaque> localTime);
