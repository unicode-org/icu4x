...
final class Collator implements ffi.Finalizable {
  ...
  static final _finalizer =
      ffi.NativeFinalizer(ffi.Native.addressOf(_ICU4XCollator_destroy));
  ...
  factory Collator(
      DataProvider provider, Locale locale, CollatorOptions options) {
  ...
  int compare(String left, String right) {
    ...
    final result = _ICU4XCollator_compare_utf16_(_ffi, leftView.allocIn(temp),
        leftView.length, rightView.allocIn(temp), rightView.length);
    temp.releaseAll();
    return result;
  }
...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Void>)>(
    isLeaf: true, symbol: 'ICU4XCollator_destroy')
...
@ffi.Native<
    _ResultOpaqueInt32 Function(
        ...
        ffi.Pointer<ffi.Opaque>,
        _CollatorOptionsFfi)>(isLeaf: true, symbol: 'ICU4XCollator_create_v1')
// ignore: non_constant_identifier_names
...
@ffi.Native<
    ffi.Int8 Function(
        ...
        ffi.Size,
        ffi.Pointer<ffi.Uint16>,
        ffi.Size)>(isLeaf: true, symbol: 'ICU4XCollator_compare_utf16_')
// ignore: non_constant_identifier_names
...
@ffi.Native<_ResolvedCollatorOptionsFfi Function(ffi.Pointer<ffi.Opaque>)>(
    isLeaf: true, symbol: 'ICU4XCollator_resolved_options')
// ignore: non_constant_identifier_names
