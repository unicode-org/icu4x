...
typedef struct icu4x_TimeFormatter_create_with_length_mv1_result {union {TimeFormatter* ok; PatternLoadError err;}; bool is_ok;} icu4x_TimeFormatter_create_with_length_mv1_result;
