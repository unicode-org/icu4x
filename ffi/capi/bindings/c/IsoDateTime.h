...
typedef struct icu4x_IsoDateTime_create_from_string_mv1_result {union {IsoDateTime* ok; FromIxdtfError err;}; bool is_ok;} icu4x_IsoDateTime_create_from_string_mv1_result;
