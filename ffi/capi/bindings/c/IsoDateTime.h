...
typedef struct icu4x_IsoDateTime_from_string_mv1_result {union {IsoDateTime* ok; CalendarFromStrError err;}; bool is_ok;} icu4x_IsoDateTime_from_string_mv1_result;
