...
icu4x_FixedDecimalFormatter_create_with_grouping_strategy_mv1_result icu4x_FixedDecimalFormatter_create_with_grouping_strategy_mv1(const Locale* locale, FixedDecimalGroupingStrategy_option grouping_strategy);

typedef struct icu4x_FixedDecimalFormatter_create_with_grouping_strategy_and_provider_mv1_result {union {FixedDecimalFormatter* ok; DataError err;}; bool is_ok;} icu4x_FixedDecimalFormatter_create_with_grouping_strategy_and_provider_mv1_result;
icu4x_FixedDecimalFormatter_create_with_grouping_strategy_and_provider_mv1_result icu4x_FixedDecimalFormatter_create_with_grouping_strategy_and_provider_mv1(const DataProvider* provider, const Locale* locale, FixedDecimalGroupingStrategy_option grouping_strategy);
