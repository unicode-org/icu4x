...
struct ICU4XDecomposingNormalizer_create_nfd_result {union {ICU4XDecomposingNormalizer* ok; ICU4XDataError err;}; bool is_ok;};
struct ICU4XDecomposingNormalizer_create_nfd_result ICU4XDecomposingNormalizer_create_nfd(const ICU4XDataProvider* provider);

struct ICU4XDecomposingNormalizer_create_nfkd_result {union {ICU4XDecomposingNormalizer* ok; ICU4XDataError err;}; bool is_ok;};
struct ICU4XDecomposingNormalizer_create_nfkd_result ICU4XDecomposingNormalizer_create_nfkd(const ICU4XDataProvider* provider);
