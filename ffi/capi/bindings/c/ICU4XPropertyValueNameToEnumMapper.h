...
#include "diplomat_result_box_ICU4XPropertyValueNameToEnumMapper_ICU4XError.d.h"
...
diplomat_result_box_ICU4XPropertyValueNameToEnumMapper_ICU4XError ICU4XPropertyValueNameToEnumMapper_load_hangul_syllable_type(const ICU4XDataProvider* provider);
