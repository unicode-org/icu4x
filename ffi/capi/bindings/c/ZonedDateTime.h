...
typedef struct icu4x_ZonedDateTime_from_string_mv1_result {union {ZonedDateTime ok; Rfc9557ParseError err;}; bool is_ok;} icu4x_ZonedDateTime_from_string_mv1_result;
icu4x_ZonedDateTime_from_string_mv1_result icu4x_ZonedDateTime_from_string_mv1(DiplomatStringView v, const Calendar* calendar, const IanaParser* iana_parser);
