...
typedef struct icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result {union { DataError err;}; bool is_ok;} icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result;
icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result icu4x_LineSegmenter_load_lstm_models_with_provider_mv1(LineSegmenter* self, const DataProvider* provider);

typedef struct icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result {union { DataError err;}; bool is_ok;} icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result;
icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1(LineSegmenter* self, const DataProvider* provider);
