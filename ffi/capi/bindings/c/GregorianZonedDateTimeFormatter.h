...
void icu4x_GregorianZonedDateTimeFormatter_format_iso_datetime_with_custom_time_zone_mv1(const GregorianZonedDateTimeFormatter* self, const IsoDateTime* datetime, const TimeZone* time_zone, const TimeZoneCalculator* timezone_calculator, DiplomatWrite* write);
