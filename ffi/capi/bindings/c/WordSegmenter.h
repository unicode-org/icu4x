...
WordSegmenter* icu4x_WordSegmenter_create_for_non_complex_scripts_mv1(void);

typedef struct icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_mv1_result {union {WordSegmenter* ok; DataError err;}; bool is_ok;} icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_mv1_result;
icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_mv1_result icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_mv1(const Locale* locale);

typedef struct icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_and_provider_mv1_result {union {WordSegmenter* ok; DataError err;}; bool is_ok;} icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_and_provider_mv1_result;
icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_and_provider_mv1_result icu4x_WordSegmenter_create_for_non_complex_scripts_with_content_locale_and_provider_mv1(const DataProvider* provider, const Locale* locale);

typedef struct icu4x_WordSegmenter_load_lstm_models_with_provider_mv1_result {union { DataError err;}; bool is_ok;} icu4x_WordSegmenter_load_lstm_models_with_provider_mv1_result;
icu4x_WordSegmenter_load_lstm_models_with_provider_mv1_result icu4x_WordSegmenter_load_lstm_models_with_provider_mv1(WordSegmenter* self, const DataProvider* provider);

typedef struct icu4x_WordSegmenter_load_dictinoary_models_with_provider_mv1_result {union { DataError err;}; bool is_ok;} icu4x_WordSegmenter_load_dictinoary_models_with_provider_mv1_result;
icu4x_WordSegmenter_load_dictinoary_models_with_provider_mv1_result icu4x_WordSegmenter_load_dictinoary_models_with_provider_mv1(WordSegmenter* self, const DataProvider* provider);
