...
LocaleCanonicalizer* icu4x_LocaleCanonicalizer_create_mv1(void);

typedef struct icu4x_LocaleCanonicalizer_create_with_provider_mv1_result {union {LocaleCanonicalizer* ok; DataError err;}; bool is_ok;} icu4x_LocaleCanonicalizer_create_with_provider_mv1_result;
icu4x_LocaleCanonicalizer_create_with_provider_mv1_result icu4x_LocaleCanonicalizer_create_with_provider_mv1(const DataProvider* provider);
