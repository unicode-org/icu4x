...
struct ICU4XMetazoneCalculator_create_result {union {ICU4XMetazoneCalculator* ok; ICU4XDataError err;}; bool is_ok;};
struct ICU4XMetazoneCalculator_create_result ICU4XMetazoneCalculator_create(const ICU4XDataProvider* provider);
