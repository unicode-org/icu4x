...
struct ICU4XIsoDate_create_result {union {ICU4XIsoDate* ok; ICU4XCalendarError err;}; bool is_ok;};
struct ICU4XIsoDate_create_result ICU4XIsoDate_create(int32_t year, uint8_t month, uint8_t day);
