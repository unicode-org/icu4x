...
typedef struct icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result {union {VariantOffsets ok; }; bool is_ok;} icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result;
icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(const VariantOffsetsCalculator* self, const TimeZone* time_zone, const IsoDate* local_date, const Time* local_time);
