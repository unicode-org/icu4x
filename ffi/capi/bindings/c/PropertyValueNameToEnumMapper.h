...
PropertyValueNameToEnumMapper* icu4x_PropertyValueNameToEnumMapper_create_block_mv1(void);

typedef struct icu4x_PropertyValueNameToEnumMapper_create_block_with_provider_mv1_result {union {PropertyValueNameToEnumMapper* ok; DataError err;}; bool is_ok;} icu4x_PropertyValueNameToEnumMapper_create_block_with_provider_mv1_result;
icu4x_PropertyValueNameToEnumMapper_create_block_with_provider_mv1_result icu4x_PropertyValueNameToEnumMapper_create_block_with_provider_mv1(const DataProvider* provider);
