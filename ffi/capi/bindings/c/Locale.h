...
typedef struct icu4x_Locale_add_variant_mv1_result {union { LocaleParseError err;}; bool is_ok;} icu4x_Locale_add_variant_mv1_result;
icu4x_Locale_add_variant_mv1_result icu4x_Locale_add_variant_mv1(Locale* self, DiplomatStringView s);

typedef struct icu4x_Locale_remove_variant_mv1_result {union { LocaleParseError err;}; bool is_ok;} icu4x_Locale_remove_variant_mv1_result;
icu4x_Locale_remove_variant_mv1_result icu4x_Locale_remove_variant_mv1(Locale* self, DiplomatStringView s);
