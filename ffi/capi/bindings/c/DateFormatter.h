...
void icu4x_DateFormatter_format_mv1(const DateFormatter* self, const Date* value, DiplomatWrite* write);

void icu4x_DateFormatter_format_iso_mv1(const DateFormatter* self, const IsoDate* value, DiplomatWrite* write);
