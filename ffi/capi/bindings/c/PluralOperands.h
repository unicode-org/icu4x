...
typedef struct icu4x_PluralOperands_create_from_string_mv1_result {union {PluralOperands* ok; FixedDecimalParseError err;}; bool is_ok;} icu4x_PluralOperands_create_from_string_mv1_result;
...
PluralOperands* icu4x_PluralOperands_create_from_fixed_decimal_mv1(const FixedDecimal* x);
