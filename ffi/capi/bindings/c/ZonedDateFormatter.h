...
typedef struct icu4x_ZonedDateFormatter_create_from_field_set_builder_mv1_result {union {ZonedDateFormatter* ok; DateTimeFormatterBuildOrLoadError err;}; bool is_ok;} icu4x_ZonedDateFormatter_create_from_field_set_builder_mv1_result;
icu4x_ZonedDateFormatter_create_from_field_set_builder_mv1_result icu4x_ZonedDateFormatter_create_from_field_set_builder_mv1(const Locale* locale, DateTimeFieldSetBuilder builder);

typedef struct icu4x_ZonedDateFormatter_create_from_field_set_builder_with_provider_mv1_result {union {ZonedDateFormatter* ok; DateTimeFormatterBuildOrLoadError err;}; bool is_ok;} icu4x_ZonedDateFormatter_create_from_field_set_builder_with_provider_mv1_result;
icu4x_ZonedDateFormatter_create_from_field_set_builder_with_provider_mv1_result icu4x_ZonedDateFormatter_create_from_field_set_builder_with_provider_mv1(const DataProvider* provider, const Locale* locale, DateTimeFieldSetBuilder builder);
