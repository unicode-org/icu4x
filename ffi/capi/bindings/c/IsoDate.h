...
typedef struct icu4x_IsoDate_from_string_mv1_result {union {IsoDate* ok; CalendarFromStrError err;}; bool is_ok;} icu4x_IsoDate_from_string_mv1_result;
icu4x_IsoDate_from_string_mv1_result icu4x_IsoDate_from_string_mv1(const char* v_data, size_t v_len);

IsoDate* icu4x_IsoDate_unix_epoch_mv1();
