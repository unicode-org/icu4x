...
export function formatSameCalendar(dateFormatterLocaleName: string, dateFormatterLength: DateTimeLength, dateFormatterAlignment: DateTimeAlignment, dateFormatterYearStyle: YearStyle, dateYear: number, dateMonth: number, dateDay: number, dateCalendarLocaleName: string);
