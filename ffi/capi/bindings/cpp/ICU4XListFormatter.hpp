...
namespace capi {
    ...
    struct ICU4XListFormatter_create_and_with_length_result {union {ICU4XListFormatter* ok; ICU4XDataError err;}; bool is_ok;};
    struct ICU4XListFormatter_create_and_with_length_result ICU4XListFormatter_create_and_with_length(const ICU4XDataProvider* provider, const ICU4XLocale* locale, ICU4XListLength length);
    
    struct ICU4XListFormatter_create_or_with_length_result {union {ICU4XListFormatter* ok; ICU4XDataError err;}; bool is_ok;};
    struct ICU4XListFormatter_create_or_with_length_result ICU4XListFormatter_create_or_with_length(const ICU4XDataProvider* provider, const ICU4XLocale* locale, ICU4XListLength length);
    
    struct ICU4XListFormatter_create_unit_with_length_result {union {ICU4XListFormatter* ok; ICU4XDataError err;}; bool is_ok;};
    struct ICU4XListFormatter_create_unit_with_length_result ICU4XListFormatter_create_unit_with_length(const ICU4XDataProvider* provider, const ICU4XLocale* locale, ICU4XListLength length);
