...
diplomat_result_box_ICU4XMeasureUnit_ICU4XError ICU4XMeasureUnitParser_parse_measure_unit(const ICU4XMeasureUnitParser* self, const char* unit_id_data, size_t unit_id_len);
