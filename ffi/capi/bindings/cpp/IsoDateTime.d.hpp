...
public:
  ...
  inline const capi::IsoDateTime* AsFFI() const;
  inline capi::IsoDateTime* AsFFI();
  inline static const IsoDateTime* FromFFI(const capi::IsoDateTime* ptr);
  inline static IsoDateTime* FromFFI(capi::IsoDateTime* ptr);
