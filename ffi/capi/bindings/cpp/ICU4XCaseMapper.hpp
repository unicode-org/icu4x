...
namespace capi {
    ...
    struct ICU4XCaseMapper_create_result {union {ICU4XCaseMapper* ok; ICU4XDataError err;}; bool is_ok;};
    struct ICU4XCaseMapper_create_result ICU4XCaseMapper_create(const ICU4XDataProvider* provider);
