...
inline diplomat::result<std::unique_ptr<ICU4XDateTime>, ICU4XError> ICU4XDateTime::create_from_iso_in_calendar(int32_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second, uint32_t nanosecond, const ICU4XCalendar& calendar) {
  auto result = capi::ICU4XDateTime_create_from_iso_in_calendar(year,
    ...
    nanosecond,
    calendar.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<ICU4XDateTime>, ICU4XError>(diplomat::Ok<std::unique_ptr<ICU4XDateTime>>(std::unique_ptr<ICU4XDateTime>(ICU4XDateTime::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<ICU4XDateTime>, ICU4XError>(diplomat::Err<ICU4XError>(ICU4XError::FromFFI(result.err)));
}

inline diplomat::result<std::unique_ptr<ICU4XDateTime>, ICU4XError> ICU4XDateTime::create_from_codes_in_calendar(std::string_view era_code, int32_t year, std::string_view month_code, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second, uint32_t nanosecond, const ICU4XCalendar& calendar) {
