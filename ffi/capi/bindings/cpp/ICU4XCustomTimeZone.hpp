...
namespace capi {
    ...
    struct ICU4XCustomTimeZone_create_from_string_result {union {ICU4XCustomTimeZone* ok; ICU4XTimeZoneInvalidOffsetError err;}; bool is_ok;};
    struct ICU4XCustomTimeZone_create_from_string_result ICU4XCustomTimeZone_create_from_string(const char* s_data, size_t s_len);
    ...
    struct ICU4XCustomTimeZone_try_set_gmt_offset_seconds_result {union { ICU4XTimeZoneInvalidOffsetError err;}; bool is_ok;};
    struct ICU4XCustomTimeZone_try_set_gmt_offset_seconds_result ICU4XCustomTimeZone_try_set_gmt_offset_seconds(ICU4XCustomTimeZone* self, int32_t offset_seconds);
    
    void ICU4XCustomTimeZone_clear_gmt_offset(ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_gmt_offset_seconds_result {union {int32_t ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_gmt_offset_seconds_result ICU4XCustomTimeZone_gmt_offset_seconds(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_is_gmt_offset_positive_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_is_gmt_offset_positive_result ICU4XCustomTimeZone_is_gmt_offset_positive(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_is_gmt_offset_zero_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_is_gmt_offset_zero_result ICU4XCustomTimeZone_is_gmt_offset_zero(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_gmt_offset_has_minutes_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_gmt_offset_has_minutes_result ICU4XCustomTimeZone_gmt_offset_has_minutes(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_gmt_offset_has_seconds_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_gmt_offset_has_seconds_result ICU4XCustomTimeZone_gmt_offset_has_seconds(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_try_set_time_zone_id_result {union { ICU4XTimeZoneInvalidIdError err;}; bool is_ok;};
    struct ICU4XCustomTimeZone_try_set_time_zone_id_result ICU4XCustomTimeZone_try_set_time_zone_id(ICU4XCustomTimeZone* self, const char* id_data, size_t id_len);
    
    struct ICU4XCustomTimeZone_try_set_iana_time_zone_id_result {union { ICU4XTimeZoneInvalidIdError err;}; bool is_ok;};
    struct ICU4XCustomTimeZone_try_set_iana_time_zone_id_result ICU4XCustomTimeZone_try_set_iana_time_zone_id(ICU4XCustomTimeZone* self, const ICU4XTimeZoneIdMapper* mapper, const char* id_data, size_t id_len);
    
    void ICU4XCustomTimeZone_clear_time_zone_id(ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_time_zone_id_result { bool is_ok;};
    struct ICU4XCustomTimeZone_time_zone_id_result ICU4XCustomTimeZone_time_zone_id(const ICU4XCustomTimeZone* self, DiplomatWrite* write);
    
    struct ICU4XCustomTimeZone_try_set_metazone_id_result {union { ICU4XTimeZoneInvalidIdError err;}; bool is_ok;};
    struct ICU4XCustomTimeZone_try_set_metazone_id_result ICU4XCustomTimeZone_try_set_metazone_id(ICU4XCustomTimeZone* self, const char* id_data, size_t id_len);
    
    void ICU4XCustomTimeZone_clear_metazone_id(ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_metazone_id_result { bool is_ok;};
    struct ICU4XCustomTimeZone_metazone_id_result ICU4XCustomTimeZone_metazone_id(const ICU4XCustomTimeZone* self, DiplomatWrite* write);
    
    struct ICU4XCustomTimeZone_try_set_zone_variant_result { bool is_ok;};
    struct ICU4XCustomTimeZone_try_set_zone_variant_result ICU4XCustomTimeZone_try_set_zone_variant(ICU4XCustomTimeZone* self, const char* id_data, size_t id_len);
    
    void ICU4XCustomTimeZone_clear_zone_variant(ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_zone_variant_result { bool is_ok;};
    struct ICU4XCustomTimeZone_zone_variant_result ICU4XCustomTimeZone_zone_variant(const ICU4XCustomTimeZone* self, DiplomatWrite* write);
    ...
    struct ICU4XCustomTimeZone_is_standard_time_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_is_standard_time_result ICU4XCustomTimeZone_is_standard_time(const ICU4XCustomTimeZone* self);
    
    struct ICU4XCustomTimeZone_is_daylight_time_result {union {bool ok; }; bool is_ok;};
    struct ICU4XCustomTimeZone_is_daylight_time_result ICU4XCustomTimeZone_is_daylight_time(const ICU4XCustomTimeZone* self);
