...
namespace capi {
    ...
    struct ICU4XLocaleFallbacker_create_result {union {ICU4XLocaleFallbacker* ok; ICU4XDataError err;}; bool is_ok;};
    struct ICU4XLocaleFallbacker_create_result ICU4XLocaleFallbacker_create(const ICU4XDataProvider* provider);
    
    ICU4XLocaleFallbacker* ICU4XLocaleFallbacker_create_without_data();
    
    struct ICU4XLocaleFallbacker_for_config_result {union {ICU4XLocaleFallbackerWithConfig* ok; ICU4XLocaleParseError err;}; bool is_ok;};
    struct ICU4XLocaleFallbacker_for_config_result ICU4XLocaleFallbacker_for_config(const ICU4XLocaleFallbacker* self, ICU4XLocaleFallbackConfig config);
