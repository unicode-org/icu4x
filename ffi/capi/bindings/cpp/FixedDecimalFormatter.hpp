...
namespace capi {
    ...
    typedef struct ICU4XFixedDecimalFormatter_create_with_grouping_strategy_result {union {diplomat::capi::FixedDecimalFormatter* ok; diplomat::capi::DataError err;}; bool is_ok;} ICU4XFixedDecimalFormatter_create_with_grouping_strategy_result;
    ICU4XFixedDecimalFormatter_create_with_grouping_strategy_result ICU4XFixedDecimalFormatter_create_with_grouping_strategy(const diplomat::capi::DataProvider* provider, const diplomat::capi::Locale* locale, diplomat::capi::FixedDecimalGroupingStrategy grouping_strategy);
    
    typedef struct ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1_result {union {diplomat::capi::FixedDecimalFormatter* ok; diplomat::capi::DataError err;}; bool is_ok;} ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1_result;
    ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1_result ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1(const diplomat::capi::DataStruct* data_struct, diplomat::capi::FixedDecimalGroupingStrategy grouping_strategy);
    
    void ICU4XFixedDecimalFormatter_format(const diplomat::capi::FixedDecimalFormatter* self, const diplomat::capi::FixedDecimal* value, diplomat::capi::DiplomatWrite* write);
...
inline diplomat::result<std::unique_ptr<FixedDecimalFormatter>, DataError> FixedDecimalFormatter::create_with_grouping_strategy(const DataProvider& provider, const Locale& locale, FixedDecimalGroupingStrategy grouping_strategy) {
  auto result = diplomat::capi::ICU4XFixedDecimalFormatter_create_with_grouping_strategy(provider.AsFFI(),
    locale.AsFFI(),
...
inline diplomat::result<std::unique_ptr<FixedDecimalFormatter>, DataError> FixedDecimalFormatter::create_with_decimal_symbols_v1(const DataStruct& data_struct, FixedDecimalGroupingStrategy grouping_strategy) {
  auto result = diplomat::capi::ICU4XFixedDecimalFormatter_create_with_decimal_symbols_v1(data_struct.AsFFI(),
    grouping_strategy.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<FixedDecimalFormatter>, DataError>(diplomat::Ok<std::unique_ptr<FixedDecimalFormatter>>(std::unique_ptr<FixedDecimalFormatter>(FixedDecimalFormatter::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<FixedDecimalFormatter>, DataError>(diplomat::Err<DataError>(DataError::FromFFI(result.err)));
}
...
inline std::string FixedDecimalFormatter::format(const FixedDecimal& value) const {
  ...
  diplomat::capi::ICU4XFixedDecimalFormatter_format(this->AsFFI(),
    value.AsFFI(),
    &write);
  return output;
}
...
inline void FixedDecimalFormatter::operator delete(void* ptr) {
  diplomat::capi::ICU4XFixedDecimalFormatter_destroy(reinterpret_cast<diplomat::capi::FixedDecimalFormatter*>(ptr));
}
