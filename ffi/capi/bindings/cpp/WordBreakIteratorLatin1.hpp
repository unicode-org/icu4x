...
inline const capi::WordBreakIteratorLatin1* WordBreakIteratorLatin1::AsFFI() const {
  return reinterpret_cast<const capi::WordBreakIteratorLatin1*>(this);
}

inline capi::WordBreakIteratorLatin1* WordBreakIteratorLatin1::AsFFI() {
  return reinterpret_cast<capi::WordBreakIteratorLatin1*>(this);
}

inline const WordBreakIteratorLatin1* WordBreakIteratorLatin1::FromFFI(const capi::WordBreakIteratorLatin1* ptr) {
  return reinterpret_cast<const WordBreakIteratorLatin1*>(ptr);
}

inline WordBreakIteratorLatin1* WordBreakIteratorLatin1::FromFFI(capi::WordBreakIteratorLatin1* ptr) {
  return reinterpret_cast<WordBreakIteratorLatin1*>(ptr);
}

inline void WordBreakIteratorLatin1::operator delete(void* ptr) {
  capi::ICU4XWordBreakIteratorLatin1_destroy(reinterpret_cast<capi::WordBreakIteratorLatin1*>(ptr));
}
