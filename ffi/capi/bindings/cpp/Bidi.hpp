...
namespace capi {
    ...
    typedef struct ICU4XBidi_create_result {union {diplomat::capi::Bidi* ok; diplomat::capi::DataError err;}; bool is_ok;} ICU4XBidi_create_result;
    ICU4XBidi_create_result ICU4XBidi_create(const diplomat::capi::DataProvider* provider);
    
    diplomat::capi::BidiInfo* ICU4XBidi_for_text(const diplomat::capi::Bidi* self, const char* text_data, size_t text_len, uint8_t default_level);
    
    diplomat::capi::ReorderedIndexMap* ICU4XBidi_reorder_visual(const diplomat::capi::Bidi* self, const uint8_t* levels_data, size_t levels_len);
...
inline diplomat::result<std::unique_ptr<Bidi>, DataError> Bidi::create(const DataProvider& provider) {
  auto result = diplomat::capi::ICU4XBidi_create(provider.AsFFI());
...
inline std::unique_ptr<BidiInfo> Bidi::for_text(std::string_view text, uint8_t default_level) const {
  auto result = diplomat::capi::ICU4XBidi_for_text(this->AsFFI(),
    text.data(),
    text.size(),
    default_level);
...
inline std::unique_ptr<ReorderedIndexMap> Bidi::reorder_visual(diplomat::span<const uint8_t> levels) const {
  auto result = diplomat::capi::ICU4XBidi_reorder_visual(this->AsFFI(),
    levels.data(),
    levels.size());
...
inline bool Bidi::level_is_rtl(uint8_t level) {
  auto result = diplomat::capi::ICU4XBidi_level_is_rtl(level);
  return result;
}

inline bool Bidi::level_is_ltr(uint8_t level) {
  auto result = diplomat::capi::ICU4XBidi_level_is_ltr(level);
  return result;
}

inline uint8_t Bidi::level_rtl() {
  auto result = diplomat::capi::ICU4XBidi_level_rtl();
  return result;
}

inline uint8_t Bidi::level_ltr() {
  auto result = diplomat::capi::ICU4XBidi_level_ltr();
  return result;
}
...
inline void Bidi::operator delete(void* ptr) {
  diplomat::capi::ICU4XBidi_destroy(reinterpret_cast<diplomat::capi::Bidi*>(ptr));
}
