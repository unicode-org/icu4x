...
class ICU4XFixedDecimalFormatter {
 public:
   ...
   */
  template<typename W> void format_to_write(const ICU4XFixedDecimal& value, W& write) const;
...
template<typename W> inline void ICU4XFixedDecimalFormatter::format_to_write(const ICU4XFixedDecimal& value, W& write) const {
...
inline std::string ICU4XFixedDecimalFormatter::format(const ICU4XFixedDecimal& value) const {
  ...
  capi::ICU4XFixedDecimalFormatter_format(this->inner.get(), value.AsFFI(), &diplomat_write_out);
