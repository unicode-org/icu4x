...
namespace capi {
    ...
    void ICU4XCustomTimeZone_set_gmt_offset_eighths_of_hour(diplomat::capi::CustomTimeZone* self, int8_t offset_eighths_of_hour);
...
inline void CustomTimeZone::set_gmt_offset_eighths_of_hour(int8_t offset_eighths_of_hour) {
  diplomat::capi::ICU4XCustomTimeZone_set_gmt_offset_eighths_of_hour(this->AsFFI(),
