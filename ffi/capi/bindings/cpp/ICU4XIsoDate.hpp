...
class ICU4XIsoDate {
 public:
  ...
  inline explicit ICU4XIsoDate(capi::ICU4XIsoDate* i) : inner(i) {}
...
inline uint16_t ICU4XIsoDate::day_of_year() const {
  return capi::ICU4XIsoDate_day_of_year(this->inner.get());
}
...
inline ICU4XWeekOf ICU4XIsoDate::week_of_year(const ICU4XWeekCalculator& calculator) const {
  capi::ICU4XWeekOf diplomat_raw_struct_out_value = capi::ICU4XIsoDate_week_of_year(this->inner.get(), calculator.AsFFI());
