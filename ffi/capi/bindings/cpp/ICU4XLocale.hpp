...
class ICU4XLocale {
 public:
   ...
   */
  template<typename W> diplomat::result<std::monostate, ICU4XError> get_unicode_extension_to_write(const std::string_view bytes, W& write) const;
   ...
   * See the [Rust documentation for `id`](https://docs.rs/icu/latest/icu/locid/struct.Locale.html#structfield.id) for more information.
   */
  template<typename W> diplomat::result<std::monostate, ICU4XError> region_to_write(W& write) const;
   ...
   * See the [Rust documentation for `id`](https://docs.rs/icu/latest/icu/locid/struct.Locale.html#structfield.id) for more information.
   */
  template<typename W> diplomat::result<std::monostate, ICU4XError> script_to_write(W& write) const;
...
template<typename W> inline diplomat::result<std::monostate, ICU4XError> ICU4XLocale::get_unicode_extension_to_write(const std::string_view bytes, W& write) const {
  capi::DiplomatWrite write_writer = diplomat::WriteTrait<W>::Construct(write);
...
template<typename W> inline diplomat::result<std::monostate, ICU4XError> ICU4XLocale::region_to_write(W& write) const {
  capi::DiplomatWrite write_writer = diplomat::WriteTrait<W>::Construct(write);
...
template<typename W> inline diplomat::result<std::monostate, ICU4XError> ICU4XLocale::script_to_write(W& write) const {
  capi::DiplomatWrite write_writer = diplomat::WriteTrait<W>::Construct(write);
