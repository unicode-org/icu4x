...
public:
  ...
  inline static diplomat::result<std::unique_ptr<ICU4XFixedDecimalFormatter>, ICU4XError> create_with_grouping_strategy(const ICU4XDataProvider& provider, const ICU4XLocale& locale, ICU4XFixedDecimalGroupingStrategy grouping_strategy);

  inline static diplomat::result<std::unique_ptr<ICU4XFixedDecimalFormatter>, ICU4XError> create_with_decimal_symbols_v1(const ICU4XDataStruct& data_struct, ICU4XFixedDecimalGroupingStrategy grouping_strategy);
