...
diplomat_result_box_ICU4XTimeZoneIdMapper_ICU4XError ICU4XTimeZoneIdMapperWithFastCanonicalization_create(const ICU4XDataProvider* provider);

diplomat_result_void_ICU4XError ICU4XTimeZoneIdMapperWithFastCanonicalization_iana_to_bcp47(const ICU4XTimeZoneIdMapperWithFastCanonicalization* self, const char* value_data, size_t value_len, DiplomatWriteable* write);
...
diplomat_result_void_ICU4XError ICU4XTimeZoneIdMapperWithFastCanonicalization_find_canonical_iana_from_bcp47(const ICU4XTimeZoneIdMapperWithFastCanonicalization* self, const char* value_data, size_t value_len, DiplomatWriteable* write);
