...
namespace capi {
    ...
    icu4x::capi::CodePointMapData8* icu4x_CodePointMapData8_create_planes_mv1(void);
...
inline std::unique_ptr<icu4x::CodePointMapData8> icu4x::CodePointMapData8::create_planes() {
    auto result = icu4x::capi::icu4x_CodePointMapData8_create_planes_mv1();
    return std::unique_ptr<icu4x::CodePointMapData8>(icu4x::CodePointMapData8::FromFFI(result));
}
