...
inline diplomat::result<std::unique_ptr<icu4x::CodePointMapData8>, icu4x::DataError> icu4x::CodePointMapData8::create_indic_conjunct_break_with_provider(const icu4x::DataProvider& provider) {
