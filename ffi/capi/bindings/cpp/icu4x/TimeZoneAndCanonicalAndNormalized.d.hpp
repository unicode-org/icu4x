...
namespace icu4x {
/**
 * See the [Rust documentation for `TimeZoneAndCanonicalAndNormalized`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.TimeZoneAndCanonicalAndNormalized.html) for more information.
 */
struct TimeZoneAndCanonicalAndNormalized {
