...
public:
   ...
   *
   * See the [Rust documentation for `fallback_for`](https://docs.rs/icu/2.0.0/icu/locale/fallback/struct.LocaleFallbacker.html#method.fallback_for) for more information.
   */
