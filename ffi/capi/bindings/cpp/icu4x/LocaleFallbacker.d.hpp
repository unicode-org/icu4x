 ...
 *
 * See the [Rust documentation for `LocaleFallbacker`](https://docs.rs/icu/2.3.0/icu/locale/fallback/struct.LocaleFallbacker.html) for more information.
 */
class LocaleFallbacker {
public:
   ...
   *
   * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/locale/fallback/struct.LocaleFallbacker.html#method.new) for more information.
   */
   ...
   *
   * See the [Rust documentation for `new_without_data`](https://docs.rs/icu/2.3.0/icu/locale/fallback/struct.LocaleFallbacker.html#method.new_without_data) for more information.
   */
   ...
   *
   * See the [Rust documentation for `for_config`](https://docs.rs/icu/2.3.0/icu/locale/fallback/struct.LocaleFallbacker.html#method.for_config) for more information.
   */
