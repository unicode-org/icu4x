...
template<typename W>
inline diplomat::result<std::monostate, icu4x::DateTimeWriteError> icu4x::ZonedDateFormatter::format_iso_write(const icu4x::IsoDate& iso_date, const icu4x::TimeZoneInfo& zone, W& writeable) const {
