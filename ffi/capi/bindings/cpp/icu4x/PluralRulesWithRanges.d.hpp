...
namespace icu4x {
/**
 * See the [Rust documentation for `PluralRulesWithRanges`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRulesWithRanges.html) for more information.
 */
class PluralRulesWithRanges {
public:
   ...
   *
   * See the [Rust documentation for `try_new_cardinal`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRulesWithRanges.html#method.try_new_cardinal) for more information.
   */
   ...
   *
   * See the [Rust documentation for `try_new_ordinal`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRulesWithRanges.html#method.try_new_ordinal) for more information.
   */
   ...
   *
   * See the [Rust documentation for `category_for_range`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRulesWithRanges.html#method.category_for_range) for more information.
   */
