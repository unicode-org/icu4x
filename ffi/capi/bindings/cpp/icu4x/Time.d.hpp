 ...
 *
 * See the [Rust documentation for `Time`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html) for more information.
 */
class Time {
public:
   ...
   *
   * See the [Rust documentation for `try_new`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#method.try_new) for more information.
   */
   ...
   *
   * See the [Rust documentation for `try_from_str`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#method.try_from_str) for more information.
   */
   ...
   *
   * See the [Rust documentation for `start_of_day`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#method.start_of_day) for more information.
   */
   ...
   *
   * See the [Rust documentation for `noon`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#method.noon) for more information.
   */
   ...
   *
   * See the [Rust documentation for `hour`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#structfield.hour) for more information.
   */
   ...
   *
   * See the [Rust documentation for `minute`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#structfield.minute) for more information.
   */
   ...
   *
   * See the [Rust documentation for `second`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#structfield.second) for more information.
   */
   ...
   *
   * See the [Rust documentation for `subsecond`](https://docs.rs/icu/2.1.0/icu/time/struct.Time.html#structfield.subsecond) for more information.
   */
