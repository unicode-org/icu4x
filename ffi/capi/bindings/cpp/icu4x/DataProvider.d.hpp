...
public:
   ...
   *
   * See the [Rust documentation for `FsDataProvider`](https://docs.rs/icu_provider_fs/2.1.0/icu_provider_fs/struct.FsDataProvider.html) for more information.
   */
   ...
   *
   * See the [Rust documentation for `try_new_from_static_blob`](https://docs.rs/icu_provider_blob/2.1.0/icu_provider_blob/struct.BlobDataProvider.html#method.try_new_from_static_blob) for more information.
   */
