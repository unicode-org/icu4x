...
namespace capi {
    ...
    typedef struct icu4x_ZonedIsoDateTime_try_from_str_mv1_result {union {icu4x::capi::ZonedIsoDateTime ok; icu4x::capi::CalendarParseError err;}; bool is_ok;} icu4x_ZonedIsoDateTime_try_from_str_mv1_result;
    icu4x_ZonedIsoDateTime_try_from_str_mv1_result icu4x_ZonedIsoDateTime_try_from_str_mv1(diplomat::capi::DiplomatStringView v, const icu4x::capi::IanaParser* iana_parser, const icu4x::capi::UtcOffsetCalculator* offset_calculator);
...
inline diplomat::result<icu4x::ZonedIsoDateTime, icu4x::CalendarParseError> icu4x::ZonedIsoDateTime::try_from_str(std::string_view v, const icu4x::IanaParser& iana_parser, const icu4x::UtcOffsetCalculator& offset_calculator) {
  auto result = icu4x::capi::icu4x_ZonedIsoDateTime_try_from_str_mv1({v.data(), v.size()},
    iana_parser.AsFFI(),
