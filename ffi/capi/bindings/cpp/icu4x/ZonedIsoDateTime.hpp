...
namespace capi {
    ...
    typedef struct icu4x_ZonedIsoDateTime_from_string_mv1_result {union {icu4x::capi::ZonedIsoDateTime ok; icu4x::capi::Rfc9557ParseError err;}; bool is_ok;} icu4x_ZonedIsoDateTime_from_string_mv1_result;
    icu4x_ZonedIsoDateTime_from_string_mv1_result icu4x_ZonedIsoDateTime_from_string_mv1(diplomat::capi::DiplomatStringView v, const icu4x::capi::IanaParser* iana_parser);
    ...
    icu4x_ZonedIsoDateTime_full_from_string_mv1_result icu4x_ZonedIsoDateTime_full_from_string_mv1(diplomat::capi::DiplomatStringView v, const icu4x::capi::IanaParser* iana_parser, const icu4x::capi::VariantOffsetsCalculator* _offset_calculator);
...
inline diplomat::result<icu4x::ZonedIsoDateTime, icu4x::Rfc9557ParseError> icu4x::ZonedIsoDateTime::from_string(std::string_view v, const icu4x::IanaParser& iana_parser) {
...
inline diplomat::result<icu4x::ZonedIsoDateTime, icu4x::Rfc9557ParseError> icu4x::ZonedIsoDateTime::full_from_string(std::string_view v, const icu4x::IanaParser& iana_parser, const icu4x::VariantOffsetsCalculator& _offset_calculator) {
