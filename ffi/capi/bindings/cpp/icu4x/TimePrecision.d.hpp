...
namespace icu4x {
/**
 * See the [Rust documentation for `TimePrecision`](https://docs.rs/icu/2.3.0/icu/datetime/options/enum.TimePrecision.html) for more information.
 *
 * See the [Rust documentation for `SubsecondDigits`](https://docs.rs/icu/2.3.0/icu/datetime/options/enum.SubsecondDigits.html) for more information.
 */
class TimePrecision {
public:
    enum Value {
  ...
  /**
   * See the [Rust documentation for `try_from_int`](https://docs.rs/icu/2.3.0/icu/datetime/options/enum.SubsecondDigits.html#method.try_from_int) for more information.
   */
