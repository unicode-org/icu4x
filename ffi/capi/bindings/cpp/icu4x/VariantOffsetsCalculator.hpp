...
namespace capi {
    ...
    typedef struct icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result {union {icu4x::capi::VariantOffsets ok; }; bool is_ok;} icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result;
    icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1_result icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(const icu4x::capi::VariantOffsetsCalculator* self, const icu4x::capi::TimeZone* time_zone, const icu4x::capi::IsoDate* local_date, const icu4x::capi::Time* local_time);
...
inline std::optional<icu4x::VariantOffsets> icu4x::VariantOffsetsCalculator::compute_offsets_for_time_zone_and_local_datetime(const icu4x::TimeZone& time_zone, const icu4x::IsoDate& local_date, const icu4x::Time& local_time) const {
  auto result = icu4x::capi::icu4x_VariantOffsetsCalculator_compute_offsets_for_time_zone_and_local_datetime_mv1(this->AsFFI(),
    time_zone.AsFFI(),
    local_date.AsFFI(),
    local_time.AsFFI());
