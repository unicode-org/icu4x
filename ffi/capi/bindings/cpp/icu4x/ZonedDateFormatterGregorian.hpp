...
namespace capi {
    ...
    typedef struct icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1_result {union {icu4x::capi::ZonedDateFormatterGregorian* ok; icu4x::capi::DateTimeFormatterBuildOrLoadError err;}; bool is_ok;} icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1_result;
    icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1_result icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1(const icu4x::capi::Locale* locale, icu4x::capi::DateTimeFieldSetBuilder builder);
    
    typedef struct icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1_result {union {icu4x::capi::ZonedDateFormatterGregorian* ok; icu4x::capi::DateTimeFormatterBuildOrLoadError err;}; bool is_ok;} icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1_result;
    icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1_result icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1(const icu4x::capi::DataProvider* provider, const icu4x::capi::Locale* locale, icu4x::capi::DateTimeFieldSetBuilder builder);
...
inline diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError> icu4x::ZonedDateFormatterGregorian::create_from_field_set_builder(const icu4x::Locale& locale, icu4x::DateTimeFieldSetBuilder builder) {
  auto result = icu4x::capi::icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_mv1(locale.AsFFI(),
    builder.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError>(diplomat::Ok<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>>(std::unique_ptr<icu4x::ZonedDateFormatterGregorian>(icu4x::ZonedDateFormatterGregorian::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError>(diplomat::Err<icu4x::DateTimeFormatterBuildOrLoadError>(icu4x::DateTimeFormatterBuildOrLoadError::FromFFI(result.err)));
}

inline diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError> icu4x::ZonedDateFormatterGregorian::create_from_field_set_builder_with_provider(const icu4x::DataProvider& provider, const icu4x::Locale& locale, icu4x::DateTimeFieldSetBuilder builder) {
  auto result = icu4x::capi::icu4x_ZonedDateFormatterGregorian_create_from_field_set_builder_with_provider_mv1(provider.AsFFI(),
    locale.AsFFI(),
    builder.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError>(diplomat::Ok<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>>(std::unique_ptr<icu4x::ZonedDateFormatterGregorian>(icu4x::ZonedDateFormatterGregorian::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<icu4x::ZonedDateFormatterGregorian>, icu4x::DateTimeFormatterBuildOrLoadError>(diplomat::Err<icu4x::DateTimeFormatterBuildOrLoadError>(icu4x::DateTimeFormatterBuildOrLoadError::FromFFI(result.err)));
}
