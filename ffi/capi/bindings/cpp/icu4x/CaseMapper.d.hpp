...
namespace icu4x {
/**
 * See the [Rust documentation for `CaseMapper`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapper.html) for more information.
 */
class CaseMapper {
public:
   ...
   *
   * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapper.html#method.new) for more information.
   */
   ...
   *
   * See the [Rust documentation for `lowercase`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.lowercase) for more information.
   */
   ...
   *
   * See the [Rust documentation for `uppercase`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.uppercase) for more information.
   */
   ...
   *
   * See the [Rust documentation for `titlecase_segment_with_only_case_data`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.titlecase_segment_with_only_case_data) for more information.
   */
   ...
   * The `v1` refers to the version of the options struct, which may change as we add more options
   *
   * See the [Rust documentation for `titlecase_segment_with_only_case_data_to_string`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.titlecase_segment_with_only_case_data_to_string) for more information.
   */
   ...
   *
   * See the [Rust documentation for `fold`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.fold) for more information.
   */
   ...
   *
   * See the [Rust documentation for `fold_turkic`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.fold_turkic) for more information.
   */
   ...
   *
   * See the [Rust documentation for `add_case_closure_to`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.add_case_closure_to) for more information.
   */
   ...
   *
   * See the [Rust documentation for `simple_lowercase`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.simple_lowercase) for more information.
   */
   ...
   *
   * See the [Rust documentation for `simple_uppercase`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.simple_uppercase) for more information.
   */
   ...
   *
   * See the [Rust documentation for `simple_titlecase`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.simple_titlecase) for more information.
   */
   ...
   *
   * See the [Rust documentation for `simple_fold`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.simple_fold) for more information.
   */
   ...
   *
   * See the [Rust documentation for `simple_fold_turkic`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapperBorrowed.html#method.simple_fold_turkic) for more information.
   */
