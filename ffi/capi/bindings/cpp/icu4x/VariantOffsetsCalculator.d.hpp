...
public:
  ...
  inline std::optional<icu4x::VariantOffsets> compute_offsets_from_time_zone_and_date_time_v1(const icu4x::TimeZone& time_zone, const icu4x::IsoDate& local_date, const icu4x::Time& local_time) const;
   ...
   */
  inline std::optional<icu4x::VariantOffsetsV2> compute_offsets_from_time_zone_and_date_time_v2(const icu4x::TimeZone& time_zone, const icu4x::IsoDate& local_date, const icu4x::Time& local_time) const;
