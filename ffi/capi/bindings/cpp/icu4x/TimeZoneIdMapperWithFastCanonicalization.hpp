...
namespace capi {
    ...
    icu4x::capi::TimeZoneIdMapperWithFastCanonicalization* icu4x_TimeZoneIdMapperWithFastCanonicalization_create_mv1(void);
    
    typedef struct icu4x_TimeZoneIdMapperWithFastCanonicalization_create_with_provider_mv1_result {union {icu4x::capi::TimeZoneIdMapperWithFastCanonicalization* ok; icu4x::capi::DataError err;}; bool is_ok;} icu4x_TimeZoneIdMapperWithFastCanonicalization_create_with_provider_mv1_result;
...
inline std::unique_ptr<icu4x::TimeZoneIdMapperWithFastCanonicalization> icu4x::TimeZoneIdMapperWithFastCanonicalization::create() {
  auto result = icu4x::capi::icu4x_TimeZoneIdMapperWithFastCanonicalization_create_mv1();
  return std::unique_ptr<icu4x::TimeZoneIdMapperWithFastCanonicalization>(icu4x::TimeZoneIdMapperWithFastCanonicalization::FromFFI(result));
}

inline diplomat::result<std::unique_ptr<icu4x::TimeZoneIdMapperWithFastCanonicalization>, icu4x::DataError> icu4x::TimeZoneIdMapperWithFastCanonicalization::create_with_provider(const icu4x::DataProvider& provider) {
  auto result = icu4x::capi::icu4x_TimeZoneIdMapperWithFastCanonicalization_create_with_provider_mv1(provider.AsFFI());
