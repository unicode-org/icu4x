...
namespace capi {
    ...
    void icu4x_GregorianDateTimeFormatter_format_iso_datetime_mv1(const icu4x::capi::GregorianDateTimeFormatter* self, const icu4x::capi::IsoDate* date, const icu4x::capi::Time* time, diplomat::capi::DiplomatWrite* write);
...
inline std::string icu4x::GregorianDateTimeFormatter::format_iso_datetime(const icu4x::IsoDate& date, const icu4x::Time& time) const {
  std::string output;
