...
namespace icu4x {
/**
 * See the [Rust documentation for `WordBreakIterator`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.WordBreakIterator.html) for more information.
 */
...
public:
   ...
   *
   * See the [Rust documentation for `next`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.WordBreakIterator.html#method.next) for more information.
   */
  inline int32_t next();
   ...
   *
   * See the [Rust documentation for `word_type`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.WordBreakIterator.html#method.word_type) for more information.
   */
   ...
   *
   * See the [Rust documentation for `is_word_like`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.WordBreakIterator.html#method.is_word_like) for more information.
   */
