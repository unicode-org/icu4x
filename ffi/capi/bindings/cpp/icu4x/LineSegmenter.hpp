...
namespace capi {
    ...
    icu4x::capi::LineSegmenter* icu4x_LineSegmenter_create_non_complex_mv1(void);
    ...
    icu4x::capi::LineSegmenter* icu4x_LineSegmenter_create_non_complex_with_options_v2_mv1(const icu4x::capi::Locale* content_locale, icu4x::capi::LineBreakOptionsV2 options);

    typedef struct icu4x_LineSegmenter_create_non_complex_with_options_v2_and_provider_mv1_result {union {icu4x::capi::LineSegmenter* ok; icu4x::capi::DataError err;}; bool is_ok;} icu4x_LineSegmenter_create_non_complex_with_options_v2_and_provider_mv1_result;
    icu4x_LineSegmenter_create_non_complex_with_options_v2_and_provider_mv1_result icu4x_LineSegmenter_create_non_complex_with_options_v2_and_provider_mv1(const icu4x::capi::DataProvider* provider, const icu4x::capi::Locale* content_locale, icu4x::capi::LineBreakOptionsV2 options);
...
inline std::unique_ptr<icu4x::LineSegmenter> icu4x::LineSegmenter::create_non_complex() {
    auto result = icu4x::capi::icu4x_LineSegmenter_create_non_complex_mv1();
    return std::unique_ptr<icu4x::LineSegmenter>(icu4x::LineSegmenter::FromFFI(result));
}
...
inline std::unique_ptr<icu4x::LineSegmenter> icu4x::LineSegmenter::create_non_complex_with_options_v2(const icu4x::Locale* content_locale, icu4x::LineBreakOptionsV2 options) {
    auto result = icu4x::capi::icu4x_LineSegmenter_create_non_complex_with_options_v2_mv1(content_locale ? content_locale->AsFFI() : nullptr,
        options.AsFFI());
    return std::unique_ptr<icu4x::LineSegmenter>(icu4x::LineSegmenter::FromFFI(result));
}

inline icu4x::diplomat::result<std::unique_ptr<icu4x::LineSegmenter>, icu4x::DataError> icu4x::LineSegmenter::create_non_complex_with_options_v2_and_provider(const icu4x::DataProvider& provider, const icu4x::Locale* content_locale, icu4x::LineBreakOptionsV2 options) {
    auto result = icu4x::capi::icu4x_LineSegmenter_create_non_complex_with_options_v2_and_provider_mv1(provider.AsFFI(),
        content_locale ? content_locale->AsFFI() : nullptr,
        options.AsFFI());
    return result.is_ok ? icu4x::diplomat::result<std::unique_ptr<icu4x::LineSegmenter>, icu4x::DataError>(icu4x::diplomat::Ok<std::unique_ptr<icu4x::LineSegmenter>>(std::unique_ptr<icu4x::LineSegmenter>(icu4x::LineSegmenter::FromFFI(result.ok)))) : icu4x::diplomat::result<std::unique_ptr<icu4x::LineSegmenter>, icu4x::DataError>(icu4x::diplomat::Err<icu4x::DataError>(icu4x::DataError::FromFFI(result.err)));
}
