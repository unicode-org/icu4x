...
namespace capi {
    ...
    typedef struct icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result {union { icu4x::capi::DataError err;}; bool is_ok;} icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result;
    icu4x_LineSegmenter_load_lstm_models_with_provider_mv1_result icu4x_LineSegmenter_load_lstm_models_with_provider_mv1(icu4x::capi::LineSegmenter* self, const icu4x::capi::DataProvider* provider);

    typedef struct icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result {union { icu4x::capi::DataError err;}; bool is_ok;} icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result;
    icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1_result icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1(icu4x::capi::LineSegmenter* self, const icu4x::capi::DataProvider* provider);
...
inline icu4x::diplomat::result<std::monostate, icu4x::DataError> icu4x::LineSegmenter::load_lstm_models_with_provider(const icu4x::DataProvider& provider) {
    auto result = icu4x::capi::icu4x_LineSegmenter_load_lstm_models_with_provider_mv1(this->AsFFI(),
        provider.AsFFI());
...
inline icu4x::diplomat::result<std::monostate, icu4x::DataError> icu4x::LineSegmenter::load_dictinoary_models_with_provider(const icu4x::DataProvider& provider) {
    auto result = icu4x::capi::icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1(this->AsFFI(),
        provider.AsFFI());
    return result.is_ok ? icu4x::diplomat::result<std::monostate, icu4x::DataError>(icu4x::diplomat::Ok<std::monostate>()) : icu4x::diplomat::result<std::monostate, icu4x::DataError>(icu4x::diplomat::Err<icu4x::DataError>(icu4x::DataError::FromFFI(result.err)));
}
