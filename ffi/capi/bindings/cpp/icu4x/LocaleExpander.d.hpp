 ...
 * A locale expander.
 *
 * See the [Rust documentation for `LocaleExpander`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html) for more information.
 */
class LocaleExpander {
public:
   ...
   *
   * See the [Rust documentation for `new_common`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html#method.new_common) for more information.
   */
   ...
   *
   * See the [Rust documentation for `new_extended`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html#method.new_extended) for more information.
   */
  ...
  /**
   * See the [Rust documentation for `maximize`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html#method.maximize) for more information.
   */
  inline icu4x::TransformResult maximize(icu4x::Locale& locale) const;

  /**
   * See the [Rust documentation for `minimize`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html#method.minimize) for more information.
   */
  inline icu4x::TransformResult minimize(icu4x::Locale& locale) const;

  /**
   * See the [Rust documentation for `minimize_favor_script`](https://docs.rs/icu/2.3.0/icu/locale/struct.LocaleExpander.html#method.minimize_favor_script) for more information.
   */
