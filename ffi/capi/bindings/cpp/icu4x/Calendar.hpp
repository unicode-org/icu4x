...
namespace capi {
    ...
    icu4x::capi::Calendar* icu4x_Calendar_create_for_kind_mv1(icu4x::capi::AnyCalendarKind kind);
...
inline std::unique_ptr<icu4x::Calendar> icu4x::Calendar::create_for_kind(icu4x::AnyCalendarKind kind) {
