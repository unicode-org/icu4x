...
namespace capi {
    ...
    icu4x::capi::Calendar* icu4x_Calendar_create_mv1(icu4x::capi::AnyCalendarKind kind);
    ...
    icu4x_Calendar_create_with_provider_mv1_result icu4x_Calendar_create_with_provider_mv1(const icu4x::capi::DataProvider* provider, icu4x::capi::AnyCalendarKind kind);
...
inline std::unique_ptr<icu4x::Calendar> icu4x::Calendar::create(icu4x::AnyCalendarKind kind) {
...
inline diplomat::result<std::unique_ptr<icu4x::Calendar>, icu4x::DataError> icu4x::Calendar::create_with_provider(const icu4x::DataProvider& provider, icu4x::AnyCalendarKind kind) {
