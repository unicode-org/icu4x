...
public:
   ...
   *
   * See the [Rust documentation for `segment_utf8`](https://docs.rs/icu/2.3.1/icu/segmenter/struct.WordSegmenterBorrowed.html#method.segment_utf8) for more information.
   */
   ...
   *
   * See the [Rust documentation for `segment_latin1`](https://docs.rs/icu/2.3.1/icu/segmenter/struct.WordSegmenterBorrowed.html#method.segment_latin1) for more information.
   */
