...
public:
   ...
   *
   * See the [Rust documentation for `compare_utf8`](https://docs.rs/icu/2.3.1/icu/collator/struct.CollatorBorrowed.html#method.compare_utf8) for more information.
   */
