#ifndef ICU4X_DateRangeFormatterGregorian_D_HPP
#define ICU4X_DateRangeFormatterGregorian_D_HPP
...
class DataProvider;
namespace capi { struct DateRangeFormatterGregorian; }
...
namespace icu4x {
namespace capi {
    struct DateRangeFormatterGregorian;
} // namespace capi
} // namespace
...
public:
  ...
  inline void format_iso_write(const icu4x::IsoDate& start_iso_date, const icu4x::IsoDate& end_iso_date, W& writeable_output) const;
    ...
    inline const icu4x::capi::DateRangeFormatterGregorian* AsFFI() const;
    inline icu4x::capi::DateRangeFormatterGregorian* AsFFI();
    inline static const icu4x::DateRangeFormatterGregorian* FromFFI(const icu4x::capi::DateRangeFormatterGregorian* ptr);
    inline static icu4x::DateRangeFormatterGregorian* FromFFI(icu4x::capi::DateRangeFormatterGregorian* ptr);
    inline static void operator delete(void* ptr);
private:
    DateRangeFormatterGregorian() = delete;
    DateRangeFormatterGregorian(const icu4x::DateRangeFormatterGregorian&) = delete;
    DateRangeFormatterGregorian(icu4x::DateRangeFormatterGregorian&&) noexcept = delete;
    DateRangeFormatterGregorian operator=(const icu4x::DateRangeFormatterGregorian&) = delete;
    DateRangeFormatterGregorian operator=(icu4x::DateRangeFormatterGregorian&&) noexcept = delete;
    static void operator delete[](void*, size_t) = delete;
};

} // namespace
#endif // ICU4X_DateRangeFormatterGregorian_D_HPP
