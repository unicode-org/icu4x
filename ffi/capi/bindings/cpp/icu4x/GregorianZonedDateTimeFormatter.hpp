...
namespace capi {
    ...
    typedef struct icu4x_GregorianZonedDateTimeFormatter_format_iso_mv1_result {union { icu4x::capi::DateTimeWriteError err;}; bool is_ok;} icu4x_GregorianZonedDateTimeFormatter_format_iso_mv1_result;
...
inline diplomat::result<std::string, icu4x::DateTimeWriteError> icu4x::GregorianZonedDateTimeFormatter::format_iso(const icu4x::IsoDate& date, const icu4x::Time& time, const icu4x::TimeZoneInfo& zone) const {
  std::string output;
