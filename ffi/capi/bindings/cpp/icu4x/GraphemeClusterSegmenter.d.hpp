 ...
 * in strings.
 *
 * See the [Rust documentation for `GraphemeClusterSegmenter`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.GraphemeClusterSegmenter.html) for more information.
 */
class GraphemeClusterSegmenter {
public:
   ...
   *
   * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.GraphemeClusterSegmenter.html#method.new) for more information.
   */
   ...
   *
   * See the [Rust documentation for `segment_utf8`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.GraphemeClusterSegmenterBorrowed.html#method.segment_utf8) for more information.
   */
   ...
   * to the WHATWG Encoding Standard.
   *
   * See the [Rust documentation for `segment_utf16`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.GraphemeClusterSegmenterBorrowed.html#method.segment_utf16) for more information.
   */
   ...
   *
   * See the [Rust documentation for `segment_latin1`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.GraphemeClusterSegmenterBorrowed.html#method.segment_latin1) for more information.
   */
