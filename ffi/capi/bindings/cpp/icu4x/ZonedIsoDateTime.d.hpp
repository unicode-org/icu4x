...
struct ZonedIsoDateTime {
  ...
  inline static diplomat::result<icu4x::ZonedIsoDateTime, icu4x::CalendarParseError> try_from_str(std::string_view v, const icu4x::IanaParser& iana_parser, const icu4x::UtcOffsetCalculator& offset_calculator);
