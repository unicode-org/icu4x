...
namespace icu4x {
/**
 * See the [Rust documentation for `MissingFieldsStrategy`](https://docs.rs/icu/2.3.0/icu/calendar/options/enum.MissingFieldsStrategy.html) for more information.
 */
