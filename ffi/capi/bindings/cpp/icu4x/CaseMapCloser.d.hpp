...
namespace icu4x {
/**
 * See the [Rust documentation for `CaseMapCloser`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapCloser.html) for more information.
 */
class CaseMapCloser {
public:
   ...
   *
   * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapCloser.html#method.new) for more information.
   */
   ...
   *
   * See the [Rust documentation for `add_case_closure_to`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapCloserBorrowed.html#method.add_case_closure_to) for more information.
   */
   ...
   *
   * See the [Rust documentation for `add_string_case_closure_to`](https://docs.rs/icu/2.3.0/icu/casemap/struct.CaseMapCloserBorrowed.html#method.add_string_case_closure_to) for more information.
   */
