...
public:
   ...
   * to the WHATWG Encoding Standard.
   *
   * See the [Rust documentation for `is_normalized_utf8`](https://docs.rs/icu/2.3.1/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.is_normalized_utf8) for more information.
   */
   ...
   *
   * See the [Rust documentation for `split_normalized_utf8`](https://docs.rs/icu/2.3.1/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.split_normalized_utf8) for more information.
   *
   * See the [Rust documentation for `split_normalized`](https://docs.rs/icu/2.3.1/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.split_normalized) for more information.
   */
