...
namespace capi {
    ...
    typedef struct icu4x_Locale_add_variant_mv1_result {union { icu4x::capi::LocaleParseError err;}; bool is_ok;} icu4x_Locale_add_variant_mv1_result;
    ...
    typedef struct icu4x_Locale_remove_variant_mv1_result {union { icu4x::capi::LocaleParseError err;}; bool is_ok;} icu4x_Locale_remove_variant_mv1_result;
    icu4x_Locale_remove_variant_mv1_result icu4x_Locale_remove_variant_mv1(icu4x::capi::Locale* self, icu4x::diplomat::capi::DiplomatStringView s);
...
inline icu4x::diplomat::result<std::monostate, icu4x::LocaleParseError> icu4x::Locale::add_variant(std::string_view s) {
    auto result = icu4x::capi::icu4x_Locale_add_variant_mv1(this->AsFFI(),
        {s.data(), s.size()});
    return result.is_ok ? icu4x::diplomat::result<std::monostate, icu4x::LocaleParseError>(icu4x::diplomat::Ok<std::monostate>()) : icu4x::diplomat::result<std::monostate, icu4x::LocaleParseError>(icu4x::diplomat::Err<icu4x::LocaleParseError>(icu4x::LocaleParseError::FromFFI(result.err)));
}

inline icu4x::diplomat::result<std::monostate, icu4x::LocaleParseError> icu4x::Locale::remove_variant(std::string_view s) {
