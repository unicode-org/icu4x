...
namespace capi {
    ...
    icu4x::capi::MeasureUnit* icu4x_MeasureUnitParser_parse_mv1(diplomat::capi::DiplomatStringView unit_id);
...
inline std::unique_ptr<icu4x::MeasureUnit> icu4x::MeasureUnitParser::parse(std::string_view unit_id) {
  auto result = icu4x::capi::icu4x_MeasureUnitParser_parse_mv1({unit_id.data(), unit_id.size()});
