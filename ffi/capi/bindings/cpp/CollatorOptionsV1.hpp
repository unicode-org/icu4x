...
inline capi::CollatorOptionsV1 CollatorOptionsV1::AsFFI() const {
  return capi::CollatorOptionsV1 {
...
inline CollatorOptionsV1 CollatorOptionsV1::FromFFI(capi::CollatorOptionsV1 c_struct) {
