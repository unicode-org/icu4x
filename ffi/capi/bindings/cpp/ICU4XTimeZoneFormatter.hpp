...
class ICU4XTimeZoneFormatter {
 public:
   ...
   */
  template<typename W> void format_custom_time_zone_to_write(const ICU4XCustomTimeZone& value, W& write) const;
   ...
   * See the [Rust documentation for `format_to_string`](https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.format_to_string) for more information.
   */
  std::string format_custom_time_zone(const ICU4XCustomTimeZone& value) const;
   ...
   */
  template<typename W> diplomat::result<std::monostate, ICU4XError> format_custom_time_zone_no_fallback_to_write(const ICU4XCustomTimeZone& value, W& write) const;
...
template<typename W> inline void ICU4XTimeZoneFormatter::format_custom_time_zone_to_write(const ICU4XCustomTimeZone& value, W& write) const {
  capi::DiplomatWrite write_writer = diplomat::WriteTrait<W>::Construct(write);
  capi::ICU4XTimeZoneFormatter_format_custom_time_zone(this->inner.get(), value.AsFFI(), &write_writer);
}
inline std::string ICU4XTimeZoneFormatter::format_custom_time_zone(const ICU4XCustomTimeZone& value) const {
  ...
  capi::ICU4XTimeZoneFormatter_format_custom_time_zone(this->inner.get(), value.AsFFI(), &diplomat_write_out);
  return diplomat_write_string;
}
template<typename W> inline diplomat::result<std::monostate, ICU4XError> ICU4XTimeZoneFormatter::format_custom_time_zone_no_fallback_to_write(const ICU4XCustomTimeZone& value, W& write) const {
  capi::DiplomatWrite write_writer = diplomat::WriteTrait<W>::Construct(write);
...
inline diplomat::result<std::string, ICU4XError> ICU4XTimeZoneFormatter::format_custom_time_zone_no_fallback(const ICU4XCustomTimeZone& value) const {
  std::string diplomat_write_string;
  capi::DiplomatWrite diplomat_write_out = diplomat::WriteFromString(diplomat_write_string);
  auto diplomat_result_raw_out_value = capi::ICU4XTimeZoneFormatter_format_custom_time_zone_no_fallback(this->inner.get(), value.AsFFI(), &diplomat_write_out);
  diplomat::result<std::monostate, ICU4XError> diplomat_result_out_value;
  if (diplomat_result_raw_out_value.is_ok) {
    diplomat_result_out_value = diplomat::Ok<std::monostate>(std::monostate());
  } else {
