...
inline diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError> ICU4XWordSegmenter::create_auto(const ICU4XDataProvider& provider) {
  auto result = capi::ICU4XWordSegmenter_create_auto(provider.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError>(diplomat::Ok<std::unique_ptr<ICU4XWordSegmenter>>(std::unique_ptr<ICU4XWordSegmenter>(ICU4XWordSegmenter::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError>(diplomat::Err<ICU4XError>(ICU4XError::FromFFI(result.err)));
}

inline diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError> ICU4XWordSegmenter::create_lstm(const ICU4XDataProvider& provider) {
  auto result = capi::ICU4XWordSegmenter_create_lstm(provider.AsFFI());
  return result.is_ok ? diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError>(diplomat::Ok<std::unique_ptr<ICU4XWordSegmenter>>(std::unique_ptr<ICU4XWordSegmenter>(ICU4XWordSegmenter::FromFFI(result.ok)))) : diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError>(diplomat::Err<ICU4XError>(ICU4XError::FromFFI(result.err)));
}

inline diplomat::result<std::unique_ptr<ICU4XWordSegmenter>, ICU4XError> ICU4XWordSegmenter::create_dictionary(const ICU4XDataProvider& provider) {
