...
#include "../../include/pluralrules_ffi_ICU4XPluralRules.h"
#include <string.h>
#include <stdio.h>
...
int main() {
    ...
    ICU4XCreatePluralRulesResult plural_result = ICU4XPluralRules_create(locale, provider, ICU4XPluralRuleType_Cardinal);
