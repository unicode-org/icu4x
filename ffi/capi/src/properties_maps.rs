...
pub mod ffi {
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_bidi_class_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::BidiClass>::try_new_unstable(
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_numeric_type_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::NumericType>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData16 {
        ...
        pub fn create_script_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::Script>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_hangul_syllable_type_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::HangulSyllableType>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_east_asian_width_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::EastAsianWidth>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_line_break_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::LineBreak>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_grapheme_cluster_break_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::GraphemeClusterBreak>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_word_break_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::WordBreak>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_sentence_break_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::SentenceBreak>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_indic_syllabic_category_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::IndicSyllabicCategory>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_indic_conjunct_break_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::IndicConjunctBreak>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_joining_group_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::JoiningGroup>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_joining_type_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data = icu_properties::CodePointMapData::<props::JoiningType>::try_new_unstable(
                &provider.get_unstable()?,
            )?
            .try_into_converted()
            .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_general_category_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::GeneralCategory>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
    ...
    impl CodePointMapData8 {
        ...
        pub fn create_vertical_orientation_with_provider(
            ...
            #[expect(clippy::unwrap_used)]
            let data =
                icu_properties::CodePointMapData::<props::VerticalOrientation>::try_new_unstable(
                    &provider.get_unstable()?,
                )?
                .try_into_converted()
                .map_err(|_| ())
