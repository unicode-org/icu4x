...
pub mod ffi {
    ...
    impl IsoDate {
        ...
        pub fn create_from_string(v: &DiplomatStr) -> Result<Box<IsoDate>, CalendarFromStrError> {
    ...
    impl Date {
        ...
        pub fn create_from_string(v: &DiplomatStr) -> Result<Box<Date>, CalendarFromStrError> {
            Ok(Box::new(Date(
