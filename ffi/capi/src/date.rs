...
pub mod ffi {
    ...
    impl Date {
        ...
        ///
        /// For calendars without an era, returns the extended year
        #[diplomat::rust_link(icu::calendar::types::YearInfo::era_year_or_extended, FnInEnum)]
        #[diplomat::rust_link(icu::calendar::types::YearInfo::era_year, FnInEnum, hidden)]
        ...
        #[diplomat::rust_link(icu::calendar::types::YearInfo::standard_era, FnInEnum, hidden)]
        #[diplomat::rust_link(icu::calendar::Date::year, FnInStruct, compact)]
        #[diplomat::rust_link(icu::calendar::types::EraYear, Struct, hidden)]
        ...
        #[diplomat::rust_link(icu::calendar::types::YearInfo::formatting_era, FnInEnum, hidden)]
        #[diplomat::attr(auto, getter)]
