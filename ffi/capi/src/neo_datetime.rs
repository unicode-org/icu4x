...
impl From<ffi::TimePrecision> for icu_datetime::options::TimePrecision {
    fn from(time_precision: ffi::TimePrecision) -> Self {
        ...
        match time_precision {
            ...
            ffi::TimePrecision::SecondS1 => TimePrecision::Subsecond(SubsecondDigits::S1),
            ffi::TimePrecision::SecondS2 => TimePrecision::Subsecond(SubsecondDigits::S2),
            ffi::TimePrecision::SecondS3 => TimePrecision::Subsecond(SubsecondDigits::S3),
            ffi::TimePrecision::SecondS4 => TimePrecision::Subsecond(SubsecondDigits::S4),
            ffi::TimePrecision::SecondS5 => TimePrecision::Subsecond(SubsecondDigits::S5),
            ffi::TimePrecision::SecondS6 => TimePrecision::Subsecond(SubsecondDigits::S6),
            ffi::TimePrecision::SecondS7 => TimePrecision::Subsecond(SubsecondDigits::S7),
            ffi::TimePrecision::SecondS8 => TimePrecision::Subsecond(SubsecondDigits::S8),
            ffi::TimePrecision::SecondS9 => TimePrecision::Subsecond(SubsecondDigits::S9),
        }
    }
}
