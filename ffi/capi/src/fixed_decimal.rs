...
pub mod ffi {
    ...
    impl SignedFixedDecimal {
        ...
        #[diplomat::rust_link(fixed_decimal::FixedDecimal::trim_end_if_integer, FnInStruct)]
        #[diplomat::rust_link(fixed_decimal::FixedDecimal::trimmed_end_if_integer, FnInStruct, hidden)]
