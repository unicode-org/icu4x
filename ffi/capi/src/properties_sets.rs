...
pub mod ffi {
    ...
    impl CodePointSetData {
        ...
        pub fn create_full_composition_exclusion() -> Box<CodePointSetData> {
            Box::new(CodePointSetData(
                icu_properties::CodePointSetData::new::<FullCompositionExclusion>().static_to_owned(),
            ))
        }
        ...
        pub fn create_changes_when_nfkc_casefolded() -> Box<CodePointSetData> {
            Box::new(CodePointSetData(
                icu_properties::CodePointSetData::new::<ChangesWhenNfkcCasefolded>().static_to_owned(),
            ))
        }
        ...
        pub fn create_default_ignorable_code_point() -> Box<CodePointSetData> {
            Box::new(CodePointSetData(
                icu_properties::CodePointSetData::new::<DefaultIgnorableCodePoint>().static_to_owned(),
            ))
        }
        ...
        pub fn create_prepended_concatenation_mark() -> Box<CodePointSetData> {
            Box::new(CodePointSetData(
                icu_properties::CodePointSetData::new::<PrependedConcatenationMark>().static_to_owned(),
            ))
        }
        ...
        #[diplomat::attr(all(supports = constructors, supports = named_constructors), named_constructor = "for_ecma262")]
        #[cfg(feature = "compiled_data")]
        pub fn create_for_ecma262(property_name: &DiplomatStr) -> Result<Box<CodePointSetData>, DataError> {
            let data = icu_properties::CodePointSetData::new_for_ecma262(property_name)
                .map_err(|_| DataError::Custom)?;
            Ok(Box::new(CodePointSetData(data.static_to_owned())))
        }
        ...
        pub fn create_for_ecma262_with_provider(
            ...
            let data = icu_properties::CodePointSetData::try_new_for_ecma262_unstable(
                &provider.get_unstable()?,
                property_name,
            )
            .map_err(|_e| DataError::Custom)?;
