...
pub mod ffi {
    ...
    pub struct ICU4XScriptWithExtensions(pub icu_properties::script::ScriptWithExtensions);
    ...
    pub struct ICU4XScriptWithExtensionsBorrowed<'a>(
    ...
    pub struct ICU4XScriptExtensionsSet<'a>(pub icu_properties::script::ScriptExtensionsSet<'a>);
