...
pub mod ffi {
    ...
    impl HangulSyllableType {
        ...
        /// Get the "long" name of this property value (returns empty if property value is unknown)
        pub fn long_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesLongBorrowed::<props::HangulSyllableType>::new()
                .get(self.into())
        }
        ...
        /// Get the "short" name of this property value (returns empty if property value is unknown)
        pub fn short_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesShortBorrowed::<props::HangulSyllableType>::new()
                .get(self.into())
        }
        #[diplomat::rust_link(
    ...
    impl GraphemeClusterBreak {
        ...
        /// Get the "long" name of this property value (returns empty if property value is unknown)
        pub fn long_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesLongBorrowed::<props::GraphemeClusterBreak>::new()
                .get(self.into())
        }
        ...
        /// Get the "short" name of this property value (returns empty if property value is unknown)
        pub fn short_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesShortBorrowed::<props::GraphemeClusterBreak>::new()
                .get(self.into())
        }
        #[diplomat::rust_link(
    ...
    impl CanonicalCombiningClass {
        ...
        /// Get the "long" name of this property value (returns empty if property value is unknown)
        pub fn long_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesLongBorrowed::<props::CanonicalCombiningClass>::new()
                .get(self.into())
        }
        ...
        /// Get the "short" name of this property value (returns empty if property value is unknown)
        pub fn short_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesShortBorrowed::<props::CanonicalCombiningClass>::new()
                .get(self.into())
        }
        #[diplomat::rust_link(
    ...
    impl IndicSyllabicCategory {
        ...
        /// Get the "long" name of this property value (returns empty if property value is unknown)
        pub fn long_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesLongBorrowed::<props::IndicSyllabicCategory>::new()
                .get(self.into())
        }
        ...
        /// Get the "short" name of this property value (returns empty if property value is unknown)
        pub fn short_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesShortBorrowed::<props::IndicSyllabicCategory>::new()
                .get(self.into())
        }
        #[diplomat::rust_link(
    ...
    impl IndicConjunctBreak {
        ...
        /// Get the "long" name of this property value (returns empty if property value is unknown)
        pub fn long_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesLongBorrowed::<props::IndicConjunctBreak>::new()
                .get(self.into())
        }
        ...
        /// Get the "short" name of this property value (returns empty if property value is unknown)
        pub fn short_name(self) -> Option<&'static str> {
            icu_properties::PropertyNamesShortBorrowed::<props::IndicConjunctBreak>::new()
                .get(self.into())
        }
        #[diplomat::rust_link(
    ...
    pub enum JoiningGroup {
        ...
        DalathRish = 7,
        #[diplomat::rust_link(icu::properties::props::JoiningGroup::E, AssociatedConstantInStruct)]
        E = 8,
        #[diplomat::rust_link(
