...
import { ICU4XCollatorResolvedOptionsV1 } from "./ICU4XCollatorResolvedOptionsV1.js"
...
export class ICU4XCollator {
  ...
  compare_utf16(arg_left, arg_right) {
    const buf_arg_left = diplomatRuntime.DiplomatBuf.str16(wasm, arg_left, 2);
    const buf_arg_right = diplomatRuntime.DiplomatBuf.str16(wasm, arg_right, 2);
