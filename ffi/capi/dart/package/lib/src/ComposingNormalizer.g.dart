...
final class ComposingNormalizer implements ffi.Finalizable {
  ...
  static final _ICU4XComposingNormalizer_normalize =
    _capi<ffi.NativeFunction<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi2.Utf8>, ffi.Size, ffi.Pointer<ffi.Opaque>)>>('ICU4XComposingNormalizer_normalize')
  ...
  bool isNormalized(String s) {
    final alloc = ffi2.Arena();
    final sSlice = _SliceFfi2Utf8._fromDart(s, alloc);
    final result = _ICU4XComposingNormalizer_is_normalized(_underlying, sSlice._bytes, sSlice._length);
    alloc.releaseAll();
    return result;
  }
  ...
  static final _ICU4XComposingNormalizer_is_normalized =
    _capi<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi2.Utf8>, ffi.Size)>>('ICU4XComposingNormalizer_is_normalized')
