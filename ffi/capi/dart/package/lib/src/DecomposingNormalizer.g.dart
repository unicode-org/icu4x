...
class DecomposingNormalizer implements ffi.Finalizable {
  ...
  int isNormalizedUpTo(String s) {
    ...
    final result = _ICU4XDecomposingNormalizer_is_normalized_up_to(
        _underlying, sSlice._bytes, sSlice._length);
    alloc.releaseAll();
    return result;
  }
  ...
  // ignore: non_constant_identifier_names
  static final _ICU4XDecomposingNormalizer_is_normalized_up_to = _capi<
          ffi.NativeFunction<
              ffi.Size Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi2.Utf8>,
                  ffi.Size)>>('ICU4XDecomposingNormalizer_is_normalized_up_to')
      .asFunction<
