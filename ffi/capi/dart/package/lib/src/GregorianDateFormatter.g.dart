...
final class GregorianDateFormatter implements ffi.Finalizable {
  ...
  static final _ICU4XGregorianDateFormatter_create_with_length =
    _capi<ffi.NativeFunction<_ResultOpaqueInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Int32)>>('ICU4XGregorianDateFormatter_create_with_length')
  ...
  // ignore: non_constant_identifier_names
  static final _ICU4XGregorianDateFormatter_format_iso_date =
    _capi<ffi.NativeFunction<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>>('ICU4XGregorianDateFormatter_format_iso_date')
  ...
  static final _ICU4XGregorianDateFormatter_format_iso_datetime =
    _capi<ffi.NativeFunction<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>>('ICU4XGregorianDateFormatter_format_iso_datetime')
      .asFunction<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>(isLeaf: true);
}
