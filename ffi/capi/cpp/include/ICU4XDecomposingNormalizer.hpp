...
inline size_t ICU4XDecomposingNormalizer::is_normalized_up_to(const std::string_view s) const {
  return capi::ICU4XDecomposingNormalizer_is_normalized_up_to(this->inner.get(), s.data(), s.size());
}
#endif
