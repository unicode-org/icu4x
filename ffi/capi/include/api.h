...
bool ICU4XFixedDecimalFormat_format_write(const ICU4XFixedDecimalFormat* self, const ICU4XFixedDecimal* value, DiplomatWriteable* write);
...
ssize_t ICU4XLocale_basename(const ICU4XLocale* self, DiplomatWriteable* write);

ssize_t ICU4XLocale_get_unicode_extension(const ICU4XLocale* self, const char* bytes_data, size_t bytes_len, DiplomatWriteable* write);

ssize_t ICU4XLocale_language(const ICU4XLocale* self, DiplomatWriteable* write);

ssize_t ICU4XLocale_region(const ICU4XLocale* self, DiplomatWriteable* write);

ssize_t ICU4XLocale_script(const ICU4XLocale* self, DiplomatWriteable* write);

ssize_t ICU4XLocale_tostring(const ICU4XLocale* self, DiplomatWriteable* write);
