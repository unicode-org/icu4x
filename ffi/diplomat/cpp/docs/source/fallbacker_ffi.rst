...
.. cpp:struct:: ICU4XLocaleFallbackConfig
    ...
    See the `Rust documentation for LocaleFallbackConfig <https://docs.rs/icu_locid_transform/latest/icu_locid_transform/fallback/struct.LocaleFallbackConfig.html>`__ for more information.
...
.. cpp:enum-struct:: ICU4XLocaleFallbackPriority
    ...
    See the `Rust documentation for FallbackPriority <https://docs.rs/icu_locid_transform/latest/icu_locid_transform/fallback/enum.FallbackPriority.html>`__ for more information.
