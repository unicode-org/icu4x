...
.. cpp:class:: ICU4XGraphemeClusterBreakSegmenter
    ...
    .. cpp:function:: static diplomat::result<ICU4XGraphemeClusterBreakSegmenter, ICU4XError> create(const ICU4XDataProvider& provider)

        Construct an :cpp:class:`ICU4XGraphemeClusterBreakSegmenter`.

        See the `Rust documentation for try_new_unstable <https://unicode-org.github.io/icu4x-docs/doc/icu/segmenter/struct.GraphemeClusterBreakSegmenter.html#method.try_new_unstable>`__ for more information.
    ...
    .. cpp:function:: ICU4XGraphemeClusterBreakIteratorUtf8 segment_utf8(const std::string_view input) const
        ...
        See the `Rust documentation for segment_utf8 <https://unicode-org.github.io/icu4x-docs/doc/icu/segmenter/struct.GraphemeClusterBreakSegmenter.html#method.segment_utf8>`__ for more information.
