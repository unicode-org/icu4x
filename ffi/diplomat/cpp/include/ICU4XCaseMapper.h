...
diplomat_result_void_ICU4XError ICU4XCaseMapper_titlecase_segment_legacy(const ICU4XCaseMapper* self, const char* s_data, size_t s_len, const ICU4XLocale* locale, ICU4XTitlecaseOptions options, DiplomatWriteable* write);
