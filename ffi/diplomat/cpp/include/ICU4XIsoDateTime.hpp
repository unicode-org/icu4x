...
class ICU4XIsoDateTime {
 public:
   ...
   * 
   * See the [Rust documentation for `new_iso_datetime`](https://unicode-org.github.io/icu4x-docs/doc/icu/struct.DateTime.html#method.new_iso_datetime) for more information.
   */
