 ...
 * 
 * 
 * See the [Rust documentation for `BackwardSecondLevel`](https://unicode-org.github.io/icu4x-docs/doc/icu_collator/enum.BackwardSecondLevel.html) for more information.
 */
