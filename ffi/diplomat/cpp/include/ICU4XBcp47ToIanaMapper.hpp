 ...
 * 
 * See the [Rust documentation for `Bcp47ToIanaMapper`](https://docs.rs/icu/latest/icu/timezone/struct.Bcp47ToIanaMapper.html) for more information.
 */
class ICU4XBcp47ToIanaMapper {
 public:
   ...
   * 
   * 
   * See the [Rust documentation for `try_new_unstable`](https://docs.rs/icu/latest/icu/timezone/struct.Bcp47ToIanaMapper.html#method.try_new_unstable) for more information.
   */
   ...
   * 
   * See the [Rust documentation for `get`](https://docs.rs/icu/latest/icu/datetime/time_zone/struct.Bcp47ToIanaMapper.html#method.get) for more information.
   */
