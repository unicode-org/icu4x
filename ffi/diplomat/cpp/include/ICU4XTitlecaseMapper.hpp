...
class ICU4XTitlecaseMapper {
 public:
   ...
   */
  template<typename W> diplomat::result<std::monostate, ICU4XError> titlecase_segment_to_writeable(const std::string_view s, const ICU4XLocale& locale, ICU4XTitlecaseOptions options, W& write) const;
   ...
   * See the [Rust documentation for `titlecase_segment`](https://docs.rs/icu/latest/icu/casemap/struct.TitlecaseMapper.html#method.titlecase_segment) for more information.
   */
  diplomat::result<std::string, ICU4XError> titlecase_segment(const std::string_view s, const ICU4XLocale& locale, ICU4XTitlecaseOptions options) const;
...
#include "ICU4XTitlecaseOptions.hpp"
...
template<typename W> inline diplomat::result<std::monostate, ICU4XError> ICU4XTitlecaseMapper::titlecase_segment_to_writeable(const std::string_view s, const ICU4XLocale& locale, ICU4XTitlecaseOptions options, W& write) const {
  ICU4XTitlecaseOptions diplomat_wrapped_struct_options = options;
  capi::DiplomatWriteable write_writer = diplomat::WriteableTrait<W>::Construct(write);
  auto diplomat_result_raw_out_value = capi::ICU4XTitlecaseMapper_titlecase_segment(this->inner.get(), s.data(), s.size(), locale.AsFFI(), capi::ICU4XTitlecaseOptions{ .head_adjustment = static_cast<capi::ICU4XHeadAdjustment>(diplomat_wrapped_struct_options.head_adjustment), .tail_casing = static_cast<capi::ICU4XTailCasing>(diplomat_wrapped_struct_options.tail_casing) }, &write_writer);
...
inline diplomat::result<std::string, ICU4XError> ICU4XTitlecaseMapper::titlecase_segment(const std::string_view s, const ICU4XLocale& locale, ICU4XTitlecaseOptions options) const {
  ICU4XTitlecaseOptions diplomat_wrapped_struct_options = options;
