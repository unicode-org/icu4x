 ...
 * 
 * See the [Rust documentation for `LocaleFallbackConfig`](https://docs.rs/icu_locid_transform/latest/icu_locid_transform/fallback/struct.LocaleFallbackConfig.html) for more information.
 */
