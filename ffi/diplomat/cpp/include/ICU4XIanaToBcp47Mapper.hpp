 ...
 * 
 * This can be used via `try_set_iana_time_zone_id_strict()` on [`ICU4XCustomTimeZone`].
 * 
...
class ICU4XIanaToBcp47Mapper {
 public:
   ...
   * 
   * 
   * See the [Rust documentation for `try_new_unstable`](https://docs.rs/icu/latest/icu/timezone/struct.IanaToBcp47Mapper.html#method.try_new_unstable) for more information.
   */
...
inline diplomat::result<ICU4XIanaToBcp47Mapper, ICU4XError> ICU4XIanaToBcp47Mapper::create(const ICU4XDataProvider& provider) {
  ...
  if (diplomat_result_raw_out_value.is_ok) {
    diplomat_result_out_value = diplomat::Ok<ICU4XIanaToBcp47Mapper>(std::move(ICU4XIanaToBcp47Mapper(diplomat_result_raw_out_value.ok)));
  } else {
