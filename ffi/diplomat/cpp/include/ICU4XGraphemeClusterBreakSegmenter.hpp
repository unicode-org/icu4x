...
class ICU4XGraphemeClusterBreakSegmenter {
 public:
   ...
   * 
   * See the [Rust documentation for `segment_invalid_utf8`](https://unicode-org.github.io/icu4x-docs/doc/icu_segmenter/struct.GraphemeClusterBreakSegmenter.html#method.segment_invalid_utf8) for more information.
   */
