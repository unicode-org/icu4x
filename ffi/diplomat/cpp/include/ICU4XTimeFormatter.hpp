...
class ICU4XTimeFormatter {
 public:
   ...
   * 
   * See the [Rust documentation for `try_new_unstable`](https://unicode-org.github.io/icu4x-docs/doc/icu/decimal/struct.TimeFormatter.html#method.try_new_unstable) for more information.
   */
