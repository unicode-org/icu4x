 ...
 * 
 * See the [Rust documentation for `PropertyValueNameToEnumMapperBorrowed`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/names/struct.PropertyValueNameToEnumMapperBorrowed.html) for more information.
 */
class ICU4XPropertyValueNameToEnumMapper {
 public:
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.GeneralCategory.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.BidiClass.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.EastAsianWidth.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.LineBreak.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.GraphemeClusterBreak.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.WordBreak.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.SentenceBreak.html#method.get_name_to_enum_mapper) for more information.
   */
   ...
   * 
   * 
   * See the [Rust documentation for `get_name_to_enum_mapper`](https://unicode-org.github.io/icu4x-docs/doc/icu/properties/struct.Script.html#method.get_name_to_enum_mapper) for more information.
   */
