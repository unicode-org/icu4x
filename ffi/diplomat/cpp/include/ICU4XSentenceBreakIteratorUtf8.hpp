 ...
 * 
 * 
 * See the [Rust documentation for `SentenceBreakIteratorPotentiallyIllFormedUtf8`](https://docs.rs/icu/latest/icu/segmenter/type.SentenceBreakIteratorPotentiallyIllFormedUtf8.html) for more information.
 */
