...
class ICU4XCodePointSetData {
 public:
   ...
   * 
   * See the [Rust documentation](https://unicode-org.github.io/icu4x-docs/doc/icu_collections/uniset/struct.CodePointSet.html#method.contains) for more information.
   */
