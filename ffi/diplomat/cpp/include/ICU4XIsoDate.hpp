...
class ICU4XIsoDate {
 public:
   ...
   * 
   * See the [Rust documentation for `try_new_iso_date`](https://unicode-org.github.io/icu4x-docs/doc/icu/calendar/struct.Date.html#method.try_new_iso_date) for more information.
   */
   ...
   * 
   * `first_weekday` can be obtained via `first_weekday()` on
   * [`ICU4XWeekCalculator`](crate::week::ffi::ICU4XWeekCalculator)
   * 
