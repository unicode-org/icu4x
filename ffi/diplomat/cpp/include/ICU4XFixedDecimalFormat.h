...
diplomat_result_box_ICU4XFixedDecimalFormat_ICU4XError ICU4XFixedDecimalFormat_try_new(const ICU4XLocale* locale, const ICU4XDataProvider* provider, ICU4XFixedDecimalFormatOptions options);

diplomat_result_box_ICU4XFixedDecimalFormat_ICU4XError ICU4XFixedDecimalFormat_try_new_from_decimal_symbols_v1(const ICU4XDataStruct* data_struct, ICU4XFixedDecimalFormatOptions options);
