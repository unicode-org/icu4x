...
class ICU4XDataProvider {
 public:
   ...
   */
  static ICU4XCreateDataProviderResult create_from_byte_slice(const std::span<uint8_t> blob);
...
inline ICU4XCreateDataProviderResult ICU4XDataProvider::create_from_byte_slice(const std::span<uint8_t> blob) {
