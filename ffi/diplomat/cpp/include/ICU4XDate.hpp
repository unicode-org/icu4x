...
class ICU4XDate {
 public:
   ...
   * 
   * See the [Rust documentation for `to_iso`](https://unicode-org.github.io/icu4x-docs/doc/icu/calendar/struct.Date.html#method.to_iso) for more information.
   */
   ...
   * 
   * See the [Rust documentation for `calendar`](https://unicode-org.github.io/icu4x-docs/doc/icu/calendar/struct.Date.html#method.calendar) for more information.
   */
...
inline uint32_t ICU4XDate::days_in_year() const {
