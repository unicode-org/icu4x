...
```bash
$ rustup install nightly-2022-02-17
$ rustup component add --toolchain nightly-2022-02-17 rust-src
$ rustup target add x86_64-unknown-linux-gnu --toolchain nightly-2022-02-17
```
