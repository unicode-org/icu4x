...
.. js:class:: ICU4XCodePointMapData16
    ...
    .. js:staticfunction:: try_get_script(provider)
        ...
        Gets a map for Unicode property Script from a :js:class:`ICU4XDataProvider`. See `the Rust docs <https://unicode-org.github.io/icu4x-docs/doc/icu_properties/maps/fn.get_script.html>`__ for more information.

    .. js:staticfunction:: try_get_script_from_static(provider)

        Gets a map for Unicode property Script from a :js:class:`ICU4XStaticDataProvider`. See `the Rust docs <https://unicode-org.github.io/icu4x-docs/doc/icu_properties/maps/fn.get_script.html>`__ for more information.
