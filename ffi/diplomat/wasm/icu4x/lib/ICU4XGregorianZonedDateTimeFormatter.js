...
export class ICU4XGregorianZonedDateTimeFormatter {
  ...
  static try_new(arg_provider, arg_locale, arg_date_length, arg_time_length) {
    return (() => {
      ...
      wasm.ICU4XGregorianZonedDateTimeFormatter_try_new(diplomat_receive_buffer, arg_provider.underlying, arg_locale.underlying, ICU4XDateLength_js_to_rust[arg_date_length], ICU4XTimeLength_js_to_rust[arg_time_length]);
  ...
  static try_new_with_iso_8601_time_zone_fallback(arg_provider, arg_locale, arg_date_length, arg_time_length, arg_zone_options) {
