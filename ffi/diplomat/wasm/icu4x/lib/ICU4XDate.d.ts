...
export class ICU4XDate {
   ...
   */
  static try_new_from_iso_in_calendar(year: i32, month: u8, day: u8, calendar: ICU4XCalendar): ICU4XDate | never;
   ...
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
  static try_new_from_codes_in_calendar(era_code: string, year: i32, month_code: string, day: u8, calendar: ICU4XCalendar): ICU4XDate | never;
