...
.. js:class:: ICU4XCodePointSetData
    ...
    .. js:staticfunction:: try_get_alnum(provider)

        Gets a set for Unicode property alnum from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_alphabetic(provider)

        Gets a set for Unicode property alphabetic from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_bidi_control(provider)

        Gets a set for Unicode property bidi_control from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_bidi_mirrored(provider)

        Gets a set for Unicode property bidi_mirrored from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_blank(provider)

        Gets a set for Unicode property blank from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_cased(provider)

        Gets a set for Unicode property cased from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_case_ignorable(provider)

        Gets a set for Unicode property case_ignorable from a :js:class:`ICU4XDataProvider`.
    ...
    .. js:staticfunction:: try_get_full_composition_exclusion(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_casefolded(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_casemapped(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_nfkc_casefolded(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_lowercased(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_titlecased(provider)
    ...
    .. js:staticfunction:: try_get_changes_when_uppercased(provider)
    ...
    .. js:staticfunction:: try_get_dash(provider)
    ...
    .. js:staticfunction:: try_get_deprecated(provider)
    ...
    .. js:staticfunction:: try_get_default_ignorable_code_point(provider)
    ...
    .. js:staticfunction:: try_get_diacritic(provider)
    ...
    .. js:staticfunction:: try_get_emoji_modifier_base(provider)
    ...
    .. js:staticfunction:: try_get_emoji_component(provider)
    ...
    .. js:staticfunction:: try_get_emoji_modifier(provider)
    ...
    .. js:staticfunction:: try_get_emoji(provider)
    ...
    .. js:staticfunction:: try_get_emoji_presentation(provider)
    ...
    .. js:staticfunction:: try_get_extender(provider)
    ...
    .. js:staticfunction:: try_get_extended_pictographic(provider)
    ...
    .. js:staticfunction:: try_get_graph(provider)
    ...
    .. js:staticfunction:: try_get_grapheme_base(provider)
    ...
    .. js:staticfunction:: try_get_grapheme_extend(provider)
    ...
    .. js:staticfunction:: try_get_grapheme_link(provider)
    ...
    .. js:staticfunction:: try_get_hex_digit(provider)
    ...
    .. js:staticfunction:: try_get_hyphen(provider)
    ...
    .. js:staticfunction:: try_get_id_continue(provider)
    ...
    .. js:staticfunction:: try_get_ideographic(provider)
    ...
    .. js:staticfunction:: try_get_id_start(provider)
    ...
    .. js:staticfunction:: try_get_ids_binary_operator(provider)
    ...
    .. js:staticfunction:: try_get_ids_trinary_operator(provider)
    ...
    .. js:staticfunction:: try_get_join_control(provider)
    ...
    .. js:staticfunction:: try_get_logical_order_exception(provider)
    ...
    .. js:staticfunction:: try_get_lowercase(provider)
    ...
    .. js:staticfunction:: try_get_math(provider)
    ...
    .. js:staticfunction:: try_get_noncharacter_code_point(provider)
    ...
    .. js:staticfunction:: try_get_nfc_inert(provider)
    ...
    .. js:staticfunction:: try_get_nfd_inert(provider)
    ...
    .. js:staticfunction:: try_get_nfkc_inert(provider)
    ...
    .. js:staticfunction:: try_get_nfkd_inert(provider)
    ...
    .. js:staticfunction:: try_get_pattern_syntax(provider)
    ...
    .. js:staticfunction:: try_get_pattern_white_space(provider)
    ...
    .. js:staticfunction:: try_get_prepended_concatenation_mark(provider)
    ...
    .. js:staticfunction:: try_get_print(provider)
    ...
    .. js:staticfunction:: try_get_quotation_mark(provider)
    ...
    .. js:staticfunction:: try_get_radical(provider)
    ...
    .. js:staticfunction:: try_get_regional_indicator(provider)
    ...
    .. js:staticfunction:: try_get_soft_dotted(provider)
    ...
    .. js:staticfunction:: try_get_segment_starter(provider)
    ...
    .. js:staticfunction:: try_get_case_sensitive(provider)
    ...
    .. js:staticfunction:: try_get_sentence_terminal(provider)
    ...
    .. js:staticfunction:: try_get_terminal_punctuation(provider)
    ...
    .. js:staticfunction:: try_get_unified_ideograph(provider)
    ...
    .. js:staticfunction:: try_get_uppercase(provider)
    ...
    .. js:staticfunction:: try_get_variation_selector(provider)
    ...
    .. js:staticfunction:: try_get_white_space(provider)
    ...
    .. js:staticfunction:: try_get_xdigit(provider)
    ...
    .. js:staticfunction:: try_get_xid_continue(provider)
    ...
    .. js:staticfunction:: try_get_xid_start(provider)
