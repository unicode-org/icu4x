...
export class ICU4XLineBreakSegmenter {
  ...
  constructor(underlying, owned, edges) {
    ...
    if (owned) {
      ICU4XLineBreakSegmenter_box_destroy_registry.register(this, underlying);
    }
  }
  ...
  segment_utf8(arg_input) {
    ...
    return new ICU4XLineBreakIteratorUtf8(wasm.ICU4XLineBreakSegmenter_segment_utf8(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
  }

  segment_utf16(arg_input) {
    const buf_arg_input = diplomatRuntime.DiplomatBuf.slice(wasm, arg_input, 2);
    return new ICU4XLineBreakIteratorUtf16(wasm.ICU4XLineBreakSegmenter_segment_utf16(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
  }

  segment_latin1(arg_input) {
    const buf_arg_input = diplomatRuntime.DiplomatBuf.slice(wasm, arg_input, 1);
    return new ICU4XLineBreakIteratorLatin1(wasm.ICU4XLineBreakSegmenter_segment_latin1(this.underlying, buf_arg_input.ptr, buf_arg_input.size), true, [this, buf_arg_input]);
  }
}
