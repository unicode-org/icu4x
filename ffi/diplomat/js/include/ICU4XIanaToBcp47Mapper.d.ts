 ...
 * This can be used via `try_set_iana_time_zone_id_strict()` on {@link crate::timezone::ffi::ICU4XCustomTimeZone; `ICU4XCustomTimeZone`}.
...
export class ICU4XIanaToBcp47Mapper {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/timezone/struct.IanaToBcp47Mapper.html#method.try_new_unstable Rust documentation for `try_new_unstable`} for more information.
