...
export class ICU4XCustomTimeZone {
  ...
  try_set_iana_time_zone_id_strict(arg_mapper, arg_id) {
    const buf_arg_id = diplomatRuntime.DiplomatBuf.str(wasm, arg_id);
    const diplomat_out = (() => {
      const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
      wasm.ICU4XCustomTimeZone_try_set_iana_time_zone_id_strict(diplomat_receive_buffer, this.underlying, arg_mapper.underlying, buf_arg_id.ptr, buf_arg_id.size);
      const is_ok = diplomatRuntime.resultFlag(wasm, diplomat_receive_buffer, 4);
      if (is_ok) {
        const ok_value = {};
        wasm.diplomat_free(diplomat_receive_buffer, 5, 4);
  ...
  try_set_iana_time_zone_id_loose(arg_mapper, arg_id) {
    const buf_arg_id = diplomatRuntime.DiplomatBuf.str(wasm, arg_id);
    const diplomat_out = (() => {
      const diplomat_receive_buffer = wasm.diplomat_alloc(5, 4);
      wasm.ICU4XCustomTimeZone_try_set_iana_time_zone_id_loose(diplomat_receive_buffer, this.underlying, arg_mapper.underlying, buf_arg_id.ptr, buf_arg_id.size);
      const is_ok = diplomatRuntime.resultFlag(wasm, diplomat_receive_buffer, 4);
      if (is_ok) {
        const ok_value = {};
        wasm.diplomat_free(diplomat_receive_buffer, 5, 4);
