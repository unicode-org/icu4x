...
export class ICU4XTimeZoneFormatter {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.with_generic_non_location_long Rust documentation for `with_generic_non_location_long`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.with_generic_non_location_short Rust documentation for `with_generic_non_location_short`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.with_specific_non_location_long Rust documentation for `with_specific_non_location_long`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.with_specific_non_location_short Rust documentation for `with_specific_non_location_short`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
   ...
   * See the {@link https://docs.rs/icu/latest/icu/datetime/time_zone/struct.TimeZoneFormatter.html#method.with_generic_location_format Rust documentation for `with_generic_location_format`} for more information.
   * @throws {@link FFIError}<{@link ICU4XError}>
   */
