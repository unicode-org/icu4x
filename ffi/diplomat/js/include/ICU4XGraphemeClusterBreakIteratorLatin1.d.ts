...
export class ICU4XGraphemeClusterBreakIteratorLatin1 {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/segmenter/struct.GraphemeClusterBreakIteratorLatin1.html#method.next Rust documentation for `next`} for more information.
   */
  next(): i32;
}
