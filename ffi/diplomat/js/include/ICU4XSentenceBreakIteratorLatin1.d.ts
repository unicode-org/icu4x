...
export class ICU4XSentenceBreakIteratorLatin1 {
   ...
   * See the {@link https://docs.rs/icu/latest/icu/segmenter/struct.SentenceBreakIteratorLatin1.html#method.next Rust documentation for `next`} for more information.
   */
  next(): i32;
}
