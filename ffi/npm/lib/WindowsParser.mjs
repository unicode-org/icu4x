 ...
 *
 * See the [Rust documentation for `WindowsParser`](https://docs.rs/icu/2.3.0/icu/time/zone/windows/struct.WindowsParser.html) for more information.
 */
export class WindowsParser {
     ...
     *
     * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/time/zone/windows/struct.WindowsParser.html#method.new) for more information.
     */
    #defaultConstructor() {
    ...
    static createWithProvider(provider) {
        ...
        const result = wasm.icu4x_WindowsParser_create_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
    ...
    /**
     * See the [Rust documentation for `parse`](https://docs.rs/icu/2.3.0/icu/time/zone/windows/struct.WindowsParserBorrowed.html#method.parse) for more information.
     */
    parse(value, region) {
