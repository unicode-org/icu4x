...
export class DateAddOptions {
    ...
    static fromFields(structObj) {
        return new DateAddOptions(structObj);
    }

    #internalConstructor(structObj) {
        if (typeof structObj !== "object") {
            throw new Error("DateAddOptions's constructor takes an object of DateAddOptions's fields.");
        }
    ...
    static _fromSuppliedValue(internalConstructor, obj) {
        ...
        if (obj instanceof DateAddOptions) {
            return obj;
        }

        return DateAddOptions.fromFields(obj);
    }
    ...
    static _fromFFI(internalConstructor, ptr) {
        if (internalConstructor !== diplomatRuntime.internalConstructor) {
            throw new Error("DateAddOptions._fromFFI is not meant to be called externally. Please use the default constructor.");
        }
        let structObj = {};
