...
import { CalendarDateDifferenceError } from "./CalendarDateDifferenceError.mjs"
...
export class Date {
    ...
    tryUntilWithOptions(other, options) {
        ...
        try {
            if (!diplomatReceive.resultFlag) {
                const cause = new CalendarDateDifferenceError(diplomatRuntime.internalConstructor, diplomatRuntime.enumDiscriminant(wasm, diplomatReceive.buffer));
                throw new globalThis.Error('CalendarDateDifferenceError.' + cause.value, { cause });
            }
