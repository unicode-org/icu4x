...
export class PropertyValueNameToEnumMapper {
    ...
    static createBlock() {
        ...
        const result = wasm.icu4x_PropertyValueNameToEnumMapper_create_block_mv1();
    ...
    static createBlockWithProvider(provider) {
        ...
        const result = wasm.icu4x_PropertyValueNameToEnumMapper_create_block_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
