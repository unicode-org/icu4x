 ...
 *
 * See the [Rust documentation for `CanonicalDecomposition`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalDecomposition.html) for more information.
 */
export class CanonicalDecomposition {
     ...
     *
     * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalDecomposition.html#method.new) for more information.
     */
    #defaultConstructor() {
    ...
    static createWithProvider(provider) {
        ...
        const result = wasm.icu4x_CanonicalDecomposition_create_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
     ...
     *
     * See the [Rust documentation for `decompose`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalDecompositionBorrowed.html#method.decompose) for more information.
     */
    decompose(c) {
