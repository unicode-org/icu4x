 ...
 *
 * See the [Rust documentation for `IanaParser`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParser.html) for more information.
 */
export class IanaParser {
     ...
     *
     * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParser.html#method.new) for more information.
     */
    #defaultConstructor() {
    ...
    static createWithProvider(provider) {
        ...
        const result = wasm.icu4x_IanaParser_create_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
    ...
    /**
     * See the [Rust documentation for `parse`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserBorrowed.html#method.parse) for more information.
     */
    parse(value) {
    ...
    /**
     * See the [Rust documentation for `iter`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserBorrowed.html#method.iter) for more information.
     */
    iter() {
