...
/**
 * See the [Rust documentation for `DecomposingNormalizer`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizer.html) for more information.
 */
export class DecomposingNormalizer {
     ...
     *
     * See the [Rust documentation for `new_nfd`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizer.html#method.new_nfd) for more information.
     */
    static createNfd() {
     ...
     *
     * See the [Rust documentation for `new_nfkd`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizer.html#method.new_nfkd) for more information.
     */
    static createNfkd() {
     ...
     *
     * See the [Rust documentation for `normalize_utf8`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizerBorrowed.html#method.normalize_utf8) for more information.
     */
    normalize(s) {
    ...
    wasm.icu4x_DecomposingNormalizer_normalize_mv1(this.ffiValue, sSlice.ptr, write.buffer);
     ...
     * to the WHATWG Encoding Standard.
     *
     * See the [Rust documentation for `is_normalized_utf16`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizerBorrowed.html#method.is_normalized_utf16) for more information.
     */
    isNormalized(s) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
        ...
        const result = wasm.icu4x_DecomposingNormalizer_is_normalized_utf16_mv1(this.ffiValue, sSlice.ptr);
     ...
     *
     * See the [Rust documentation for `split_normalized_utf16`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.DecomposingNormalizerBorrowed.html#method.split_normalized_utf16) for more information.
     */
    isNormalizedUpTo(s) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
        ...
        const result = wasm.icu4x_DecomposingNormalizer_is_normalized_utf16_up_to_mv1(this.ffiValue, sSlice.ptr);
