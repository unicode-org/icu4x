...
export class LineSegmenter {
    ...
    loadLstmModelsWithProvider(provider) {
        ...
        const result = wasm.icu4x_LineSegmenter_load_lstm_models_with_provider_mv1(diplomatReceive.buffer, this.ffiValue, provider.ffiValue);
    ...
    loadDictinoaryModelsWithProvider(provider) {
        ...
        const result = wasm.icu4x_LineSegmenter_load_dictinoary_models_with_provider_mv1(diplomatReceive.buffer, this.ffiValue, provider.ffiValue);
