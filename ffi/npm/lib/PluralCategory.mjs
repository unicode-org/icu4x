...
/**
 * See the [Rust documentation for `PluralCategory`](https://docs.rs/icu/2.3.0/icu/plurals/enum.PluralCategory.html) for more information.
 */
export class PluralCategory {
     ...
     *
     * See the [Rust documentation for `get_for_cldr_string`](https://docs.rs/icu/2.3.0/icu/plurals/enum.PluralCategory.html#method.get_for_cldr_string) for more information.
     *
     * See the [Rust documentation for `get_for_cldr_bytes`](https://docs.rs/icu/2.3.0/icu/plurals/enum.PluralCategory.html#method.get_for_cldr_bytes) for more information.
     */
