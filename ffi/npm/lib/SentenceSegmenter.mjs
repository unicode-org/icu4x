 ...
 *
 * See the [Rust documentation for `SentenceSegmenter`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.SentenceSegmenter.html) for more information.
 */
export class SentenceSegmenter {
     ...
     *
     * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.SentenceSegmenter.html#method.new) for more information.
     */
    #defaultConstructor() {
    ...
    static createWithContentLocale(locale) {
        ...
        const result = wasm.icu4x_SentenceSegmenter_create_with_content_locale_mv1(diplomatReceive.buffer, locale instanceof Locale ? locale.ffiValue : typeError('locale', 'Locale'));
    ...
    static createWithContentLocaleAndProvider(provider, locale) {
        ...
        const result = wasm.icu4x_SentenceSegmenter_create_with_content_locale_and_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'), locale instanceof Locale ? locale.ffiValue : typeError('locale', 'Locale'));
     ...
     *
     * See the [Rust documentation for `segment_utf16`](https://docs.rs/icu/2.3.0/icu/segmenter/struct.SentenceSegmenterBorrowed.html#method.segment_utf16) for more information.
     */
    segment(input) {
