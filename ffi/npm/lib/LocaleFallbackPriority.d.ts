 ...
 *
 * See the [Rust documentation for `LocaleFallbackPriority`](https://docs.rs/icu/2.3.0/icu/locale/fallback/enum.LocaleFallbackPriority.html) for more information.
 */
