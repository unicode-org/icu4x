...
export class EmojiSetData {
    ...
    static createBasicWithProvider(provider) {
        ...
        const result = wasm.icu4x_EmojiSetData_create_basic_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
