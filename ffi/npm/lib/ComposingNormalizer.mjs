...
/**
 * See the [Rust documentation for `ComposingNormalizer`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizer.html) for more information.
 */
export class ComposingNormalizer {
     ...
     *
     * See the [Rust documentation for `new_nfc`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizer.html#method.new_nfc) for more information.
     */
    static createNfc() {
    ...
    static createNfcWithProvider(provider) {
        ...
        const result = wasm.icu4x_ComposingNormalizer_create_nfc_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
     ...
     *
     * See the [Rust documentation for `new_nfkc`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizer.html#method.new_nfkc) for more information.
     */
    static createNfkc() {
    ...
    static createNfkcWithProvider(provider) {
        ...
        const result = wasm.icu4x_ComposingNormalizer_create_nfkc_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
     ...
     *
     * See the [Rust documentation for `normalize_utf8`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.normalize_utf8) for more information.
     */
    normalize(s) {
     ...
     * to the WHATWG Encoding Standard.
     *
     * See the [Rust documentation for `is_normalized_utf16`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.is_normalized_utf16) for more information.
     */
    isNormalized(s) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
     ...
     *
     * See the [Rust documentation for `split_normalized_utf16`](https://docs.rs/icu/2.3.0/icu/normalizer/struct.ComposingNormalizerBorrowed.html#method.split_normalized_utf16) for more information.
     */
    isNormalizedUpTo(s) {
        let functionCleanupArena = new diplomatRuntime.CleanupArena();
