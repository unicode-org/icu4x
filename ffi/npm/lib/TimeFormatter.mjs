...
export class TimeFormatter {
    ...
    wasm.icu4x_TimeFormatter_format_mv1(this.ffiValue, time instanceof Time ? time.ffiValue : typeError('time', 'Time'), write.buffer);
