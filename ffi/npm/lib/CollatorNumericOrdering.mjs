...
/**
 * See the [Rust documentation for `CollationNumericOrdering`](https://docs.rs/icu/2.3.0/icu/collator/preferences/enum.CollationNumericOrdering.html) for more information.
 */
