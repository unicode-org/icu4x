...
/**
 * See the [Rust documentation for `WordType`](https://docs.rs/icu/2.3.0/icu/segmenter/options/enum.WordType.html) for more information.
 */
export class SegmenterWordType {
    ...
    /**
     * See the [Rust documentation for `is_word_like`](https://docs.rs/icu/2.3.0/icu/segmenter/options/enum.WordType.html#method.is_word_like) for more information.
     */
    get isWordLike() {
