...
export class LocaleFallbackerWithConfig {
    ...
    config() {
        ...
        const result = wasm.icu4x_LocaleFallbackerWithConfig_config_mv1(diplomatReceive.buffer, this.ffiValue);

        try {
            return LocaleFallbackConfig._fromFFI(diplomatRuntime.internalConstructor, diplomatReceive.buffer);
        }
