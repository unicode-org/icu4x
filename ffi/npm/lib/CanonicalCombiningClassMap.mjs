 ...
 *
 * See the [Rust documentation for `CanonicalCombiningClassMap`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalCombiningClassMap.html) for more information.
 */
export class CanonicalCombiningClassMap {
     ...
     *
     * See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalCombiningClassMap.html#method.new) for more information.
     */
    #defaultConstructor() {
    ...
    static createWithProvider(provider) {
        ...
        const result = wasm.icu4x_CanonicalCombiningClassMap_create_with_provider_mv1(diplomatReceive.buffer, provider instanceof DataProvider ? provider.ffiValue : typeError('provider', 'DataProvider'));
    ...
    /**
     * See the [Rust documentation for `get`](https://docs.rs/icu/2.3.0/icu/normalizer/properties/struct.CanonicalCombiningClassMapBorrowed.html#method.get) for more information.
     *
     * Additional information: [1](https://docs.rs/icu/2.3.0/icu/properties/props/struct.CanonicalCombiningClass.html)
     */
    get(ch) {
