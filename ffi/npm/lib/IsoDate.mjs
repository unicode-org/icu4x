 ...
 *
 * See the [Rust documentation for `Date`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html) for more information.
 */
export class IsoDate {
     ...
     *
     * See the [Rust documentation for `try_new_iso`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_new_iso) for more information.
     */
     ...
     *
     * See the [Rust documentation for `from_rata_die`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.from_rata_die) for more information.
     */
     ...
     *
     * See the [Rust documentation for `try_from_str`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_from_str) for more information.
     */
    static fromString(v) {
     ...
     *
     * See the [Rust documentation for `to_calendar`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.to_calendar) for more information.
     */
    toCalendar(calendar) {
    ...
    /**
     * See the [Rust documentation for `to_any`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.to_any) for more information.
     */
    toAny() {
     ...
     *
     * See the [Rust documentation for `to_rata_die`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.to_rata_die) for more information.
     */
    get rataDie() {
     ...
     *
     * See the [Rust documentation for `day_of_year`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.day_of_year) for more information.
     */
    get dayOfYear() {
     ...
     *
     * See the [Rust documentation for `day_of_month`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.day_of_month) for more information.
     */
    get dayOfMonth() {
     ...
     * dependent.
     *
     * See the [Rust documentation for `day_of_week`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.day_of_week) for more information.
     *
     ...
     * Returns the day in the week for this day
     *
     * See the [Rust documentation for `weekday`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.weekday) for more information.
     */
    get weekday() {
     ...
     *
     * See the [Rust documentation for `week_of_year`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.week_of_year) for more information.
     */
    weekOfYear() {
     ...
     *
     * See the [Rust documentation for `ordinal`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.MonthInfo.html#structfield.ordinal) for more information.
     *
     * Additional information: [1](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.month)
     */
    get month() {
     ...
     *
     * See the [Rust documentation for `extended_year`](https://docs.rs/icu/2.3.0/icu/calendar/types/enum.YearInfo.html#method.extended_year) for more information.
     */
    get year() {
     ...
     *
     * See the [Rust documentation for `is_in_leap_year`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.is_in_leap_year) for more information.
     */
    get isInLeapYear() {
     ...
     *
     * See the [Rust documentation for `months_in_year`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.months_in_year) for more information.
     */
    get monthsInYear() {
     ...
     *
     * See the [Rust documentation for `days_in_month`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.days_in_month) for more information.
     */
    get daysInMonth() {
     ...
     *
     * See the [Rust documentation for `days_in_year`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.days_in_year) for more information.
     */
    get daysInYear() {
     ...
     *
     * See the [Rust documentation for `try_added_with_options`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_added_with_options) for more information.
     */
     ...
     *
     * See the [Rust documentation for `try_until_with_options`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_until_with_options) for more information.
     */
