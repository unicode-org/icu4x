...
/** See the [Rust documentation for `AnyCalendar`](https://docs.rs/icu/2.3.0/icu/calendar/enum.AnyCalendar.html) for more information.
*/
class Calendar internal constructor (
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/calendar/enum.AnyCalendar.html#method.new) for more information.
        */
    ...
    *
    *See the [Rust documentation for `kind`](https://docs.rs/icu/2.3.0/icu/calendar/enum.AnyCalendar.html#method.kind) for more information.
    */
