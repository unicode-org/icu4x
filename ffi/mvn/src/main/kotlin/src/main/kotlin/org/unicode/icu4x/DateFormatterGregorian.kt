...
internal interface DateFormatterGregorianLib: Library {
    fun icu4x_DateFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_DateFormatterGregorian_create_d_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_d_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_md_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_md_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ymd_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ymd_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_de_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_de_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_mde_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_mde_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ymde_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ymde_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_e_mv1(locale: Pointer, length: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_e_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_m_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_m_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ym_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_ym_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateFormatterGregorian_create_y_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
...
class DateFormatterGregorian internal constructor (
    ...
    private class DateFormatterGregorianCleaner(val handle: Pointer, val lib: DateFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_DateFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, DateFormatterGregorian.DateFormatterGregorianCleaner(handle, DateFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<DateFormatterGregorianLib> = DateFormatterGregorianLib::class.java
        ...
        */
        fun createD(locale: Locale, length: DateTimeLength?, alignment: DateTimeAlignment?): Result<DateFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = DateFormatterGregorian(handle, selfEdges, true)
