...
/** See the [Rust documentation for `DateDuration`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html) for more information.
*/
class DateDuration (var isNegative: Boolean, var years: UInt, var months: UInt, var weeks: UInt, var days: UInt) {
    companion object {
        ...
        *
        *See the [Rust documentation for `try_from_str`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html#method.try_from_str) for more information.
        */
        ...
        *
        *See the [Rust documentation for `for_years`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html#method.for_years) for more information.
        */
        ...
        *
        *See the [Rust documentation for `for_months`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html#method.for_months) for more information.
        */
        ...
        *
        *See the [Rust documentation for `for_weeks`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html#method.for_weeks) for more information.
        */
        ...
        *
        *See the [Rust documentation for `for_days`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.DateDuration.html#method.for_days) for more information.
        */
