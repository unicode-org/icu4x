...
internal interface DateTimeFormatterGregorianLib: Library {
    fun icu4x_DateTimeFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_DateTimeFormatterGregorian_create_dt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_dt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_mdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_mdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_ymdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_ymdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_det_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_det_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_mdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_mdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_ymdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_ymdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeFormatterGregorian_create_et_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
...
class DateTimeFormatterGregorian internal constructor (
    ...
    private class DateTimeFormatterGregorianCleaner(val handle: Pointer, val lib: DateTimeFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_DateTimeFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, DateTimeFormatterGregorian.DateTimeFormatterGregorianCleaner(handle, DateTimeFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<DateTimeFormatterGregorianLib> = DateTimeFormatterGregorianLib::class.java
        ...
        */
        fun createDt(locale: Locale, length: DateTimeLength?, timePrecision: TimePrecision?, alignment: DateTimeAlignment?): Result<DateTimeFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = DateTimeFormatterGregorian(handle, selfEdges, true)
