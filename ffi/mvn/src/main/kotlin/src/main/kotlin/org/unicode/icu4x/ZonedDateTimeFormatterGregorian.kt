...
internal interface ZonedDateTimeFormatterGregorianLib: Library {
    fun icu4x_ZonedDateTimeFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_ZonedDateTimeFormatterGregorian_create_specific_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_specific_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_specific_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_specific_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_localized_offset_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_localized_offset_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_localized_offset_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_localized_offset_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_generic_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_generic_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_generic_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_generic_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_location_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_location_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_exemplar_city_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateTimeFormatterGregorian_create_exemplar_city_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
...
class ZonedDateTimeFormatterGregorian internal constructor (
    ...
    private class ZonedDateTimeFormatterGregorianCleaner(val handle: Pointer, val lib: ZonedDateTimeFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_ZonedDateTimeFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, ZonedDateTimeFormatterGregorian.ZonedDateTimeFormatterGregorianCleaner(handle, ZonedDateTimeFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<ZonedDateTimeFormatterGregorianLib> = ZonedDateTimeFormatterGregorianLib::class.java
        ...
        */
        fun createSpecificLong(locale: Locale, formatter: DateTimeFormatterGregorian): Result<ZonedDateTimeFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = ZonedDateTimeFormatterGregorian(handle, selfEdges, true)
