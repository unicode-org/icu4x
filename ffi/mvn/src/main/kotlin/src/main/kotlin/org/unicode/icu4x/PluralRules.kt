...
/** See the [Rust documentation for `PluralRules`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRules.html) for more information.
*/
class PluralRules internal constructor (
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `try_new_cardinal`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRules.html#method.try_new_cardinal) for more information.
        */
        ...
        *
        *See the [Rust documentation for `try_new_ordinal`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRules.html#method.try_new_ordinal) for more information.
        */
    ...
    *
    *See the [Rust documentation for `category_for`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRules.html#method.category_for) for more information.
    */
    ...
    *
    *See the [Rust documentation for `categories`](https://docs.rs/icu/2.3.0/icu/plurals/struct.PluralRules.html#method.categories) for more information.
    */
