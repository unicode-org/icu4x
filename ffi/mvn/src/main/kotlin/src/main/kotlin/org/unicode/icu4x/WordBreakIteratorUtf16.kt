...
internal interface WordBreakIteratorUtf16Lib: Library {
    fun icu4x_WordBreakIteratorUtf16_destroy_mv1(handle: Pointer)
    fun icu4x_WordBreakIteratorUtf16_next_mv1(handle: Pointer): Int
...
class WordBreakIteratorUtf16 internal constructor (
    ...
    private class WordBreakIteratorUtf16Cleaner(val handle: Pointer, val lib: WordBreakIteratorUtf16Lib) : Runnable {
        override fun run() {
            lib.icu4x_WordBreakIteratorUtf16_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, WordBreakIteratorUtf16.WordBreakIteratorUtf16Cleaner(handle, WordBreakIteratorUtf16.lib));
    }

    companion object {
        internal val libClass: Class<WordBreakIteratorUtf16Lib> = WordBreakIteratorUtf16Lib::class.java
