...
/** See the [Rust documentation for `TitlecaseMapper`](https://docs.rs/icu/2.3.0/icu/casemap/struct.TitlecaseMapper.html) for more information.
*/
class TitlecaseMapper internal constructor (
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/casemap/struct.TitlecaseMapper.html#method.new) for more information.
        */
        ...
        *
        *See the [Rust documentation for `titlecase_segment`](https://docs.rs/icu/2.3.0/icu/casemap/struct.TitlecaseMapperBorrowed.html#method.titlecase_segment) for more information.
        */
