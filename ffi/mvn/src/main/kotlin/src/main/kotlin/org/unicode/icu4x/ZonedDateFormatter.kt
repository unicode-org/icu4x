...
internal interface ZonedDateFormatterLib: Library {
    fun icu4x_ZonedDateFormatter_destroy_mv1(handle: Pointer)
    fun icu4x_ZonedDateFormatter_create_specific_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_specific_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_specific_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_specific_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_localized_offset_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_localized_offset_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_localized_offset_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_localized_offset_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_generic_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_generic_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_generic_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_generic_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_location_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_location_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_exemplar_city_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatter_create_exemplar_city_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
...
class ZonedDateFormatter internal constructor (
    ...
    private class ZonedDateFormatterCleaner(val handle: Pointer, val lib: ZonedDateFormatterLib) : Runnable {
        override fun run() {
            lib.icu4x_ZonedDateFormatter_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, ZonedDateFormatter.ZonedDateFormatterCleaner(handle, ZonedDateFormatter.lib));
    }

    companion object {
        internal val libClass: Class<ZonedDateFormatterLib> = ZonedDateFormatterLib::class.java
        ...
        */
        fun createSpecificLong(locale: Locale, formatter: DateFormatter): Result<ZonedDateFormatter> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = ZonedDateFormatter(handle, selfEdges, true)
