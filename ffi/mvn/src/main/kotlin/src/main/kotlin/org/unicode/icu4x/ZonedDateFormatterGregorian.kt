...
internal interface ZonedDateFormatterGregorianLib: Library {
    fun icu4x_ZonedDateFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_ZonedDateFormatterGregorian_create_specific_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_specific_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_specific_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_specific_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_localized_offset_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_localized_offset_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_localized_offset_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_localized_offset_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_generic_long_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_generic_long_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_generic_short_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_generic_short_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_location_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_location_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_exemplar_city_mv1(locale: Pointer, formatter: Pointer): ResultPointerInt
    fun icu4x_ZonedDateFormatterGregorian_create_exemplar_city_with_provider_mv1(provider: Pointer, locale: Pointer, formatter: Pointer): ResultPointerInt
...
class ZonedDateFormatterGregorian internal constructor (
    ...
    private class ZonedDateFormatterGregorianCleaner(val handle: Pointer, val lib: ZonedDateFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_ZonedDateFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, ZonedDateFormatterGregorian.ZonedDateFormatterGregorianCleaner(handle, ZonedDateFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<ZonedDateFormatterGregorianLib> = ZonedDateFormatterGregorianLib::class.java
        ...
        */
        fun createSpecificLong(locale: Locale, formatter: DateFormatterGregorian): Result<ZonedDateFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = ZonedDateFormatterGregorian(handle, selfEdges, true)
