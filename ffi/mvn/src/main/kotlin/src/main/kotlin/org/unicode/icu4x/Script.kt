...
enum class Script(val inner: Int) {
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `from_icu4c_value`](https://docs.rs/icu/2.3.0/icu/properties/props/struct.Script.html#method.from_icu4c_value) for more information.
        */
    ...
    *
    *See the [Rust documentation for `to_icu4c_value`](https://docs.rs/icu/2.3.0/icu/properties/props/struct.Script.html#method.to_icu4c_value) for more information.
    */
