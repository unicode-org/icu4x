...
internal interface DateRangeFormatterGregorianLib: Library {
    fun icu4x_DateRangeFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_DateRangeFormatterGregorian_create_d_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_d_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_md_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_md_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ymd_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ymd_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_de_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_de_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_mde_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_mde_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ymde_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ymde_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_e_mv1(locale: Pointer, length: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_e_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_m_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_m_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ym_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_ym_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateRangeFormatterGregorian_create_y_mv1(locale: Pointer, length: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
...
class DateRangeFormatterGregorian internal constructor (
    ...
    private class DateRangeFormatterGregorianCleaner(val handle: Pointer, val lib: DateRangeFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_DateRangeFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, DateRangeFormatterGregorian.DateRangeFormatterGregorianCleaner(handle, DateRangeFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<DateRangeFormatterGregorianLib> = DateRangeFormatterGregorianLib::class.java
        ...
        */
        fun createD(locale: Locale, length: DateTimeLength?, alignment: DateTimeAlignment?): Result<DateRangeFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = DateRangeFormatterGregorian(handle, selfEdges, true)
