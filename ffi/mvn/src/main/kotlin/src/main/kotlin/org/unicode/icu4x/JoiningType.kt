...
internal interface JoiningTypeLib: Library {
    fun icu4x_JoiningType_for_char_mv1(ch: Int): Int
    fun icu4x_JoiningType_long_name_mv1(inner: Int): OptionSlice
...
enum class JoiningType {
    ...
    companion object {
        internal val libClass: Class<JoiningTypeLib> = JoiningTypeLib::class.java
        internal val lib: JoiningTypeLib = Native.load("icu4x", libClass) 
        fun fromNative(native: Int): JoiningType {
            return JoiningType.entries[native]
        }

        fun default(): JoiningType {
            return NonJoining
        }
        @JvmStatic
        ...
        */
        fun forChar(ch: Int): JoiningType {
            ...
            return (JoiningType.fromNative(returnVal))
        }
        @JvmStatic
        ...
        */
        ...
        fun tryFromStr(s: String): JoiningType? {
            ...
            val returnVal = lib.icu4x_JoiningType_try_from_str_mv1(sSliceMemory.slice);
