...
/** See the [Rust documentation for `BidiPairedBracketType`](https://docs.rs/icu/2.3.0/icu/properties/props/enum.BidiPairedBracketType.html) for more information.
*/
