...
/** See the [Rust documentation for `TimeZoneVariant`](https://docs.rs/icu/2.3.0/icu/time/zone/enum.TimeZoneVariant.html) for more information.
*/
enum class TimeZoneVariant {
    ...
    companion object {
        ...
        /** See the [Rust documentation for `from_rearguard_isdst`](https://docs.rs/icu/2.3.0/icu/time/zone/enum.TimeZoneVariant.html#method.from_rearguard_isdst) for more information.
        *
