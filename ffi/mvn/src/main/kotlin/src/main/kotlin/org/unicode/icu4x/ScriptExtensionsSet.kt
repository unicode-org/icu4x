...
*
*See the [Rust documentation for `ScriptExtensionsSet`](https://docs.rs/icu/2.3.0/icu/properties/script/struct.ScriptExtensionsSet.html) for more information.
*/
class ScriptExtensionsSet internal constructor (
    ...
    *
    *See the [Rust documentation for `contains`](https://docs.rs/icu/2.3.0/icu/properties/script/struct.ScriptExtensionsSet.html#method.contains) for more information.
    */
    ...
    *
    *See the [Rust documentation for `iter`](https://docs.rs/icu/2.3.0/icu/properties/script/struct.ScriptExtensionsSet.html#method.iter) for more information.
    */
    fun count(): ULong {
