...
enum class JoiningGroup {
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `from_icu4c_value`](https://docs.rs/icu/2.3.0/icu/properties/props/struct.JoiningGroup.html#method.from_icu4c_value) for more information.
        */
        ...
        */
        fun tryFromStr(s: String): JoiningGroup? {
            ...
            val returnVal = lib.icu4x_JoiningGroup_try_from_str_mv1(sSliceMemory.slice);
            try {
    ...
    *
    *See the [Rust documentation for `to_icu4c_value`](https://docs.rs/icu/2.3.0/icu/properties/props/struct.JoiningGroup.html#method.to_icu4c_value) for more information.
    */
