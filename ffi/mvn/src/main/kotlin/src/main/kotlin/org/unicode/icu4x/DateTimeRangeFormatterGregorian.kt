...
internal interface DateTimeRangeFormatterGregorianLib: Library {
    fun icu4x_DateTimeRangeFormatterGregorian_destroy_mv1(handle: Pointer)
    fun icu4x_DateTimeRangeFormatterGregorian_create_dt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_dt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_mdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_mdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_ymdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_ymdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_det_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_det_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_mdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_mdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_ymdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_ymdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatterGregorian_create_et_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
...
/** See the [Rust documentation for `FixedCalendarDateRangeFormatter`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html) for more information.
*/
class DateTimeRangeFormatterGregorian internal constructor (
    ...
    private class DateTimeRangeFormatterGregorianCleaner(val handle: Pointer, val lib: DateTimeRangeFormatterGregorianLib) : Runnable {
        override fun run() {
            lib.icu4x_DateTimeRangeFormatterGregorian_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, DateTimeRangeFormatterGregorian.DateTimeRangeFormatterGregorianCleaner(handle, DateTimeRangeFormatterGregorian.lib));
    }

    companion object {
        internal val libClass: Class<DateTimeRangeFormatterGregorianLib> = DateTimeRangeFormatterGregorianLib::class.java
        internal val lib: DateTimeRangeFormatterGregorianLib = Native.load("icu4x", libClass)
        @JvmStatic
        
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `DT`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DT.html) for more information.
        *
        *Additional information: [1](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DT.html#method.with_time_precision), [2](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DT.html#method.with_alignment), [3](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DT.html#method.for_length)
        */
        fun createDt(locale: Locale, length: DateTimeLength?, timePrecision: TimePrecision?, alignment: DateTimeAlignment?): Result<DateTimeRangeFormatterGregorian> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = DateTimeRangeFormatterGregorian(handle, selfEdges, true)
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `MDT`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDT.html) for more information.
        *
        *Additional information: [1](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDT.html#method.with_time_precision), [2](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDT.html#method.with_alignment), [3](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDT.html#method.for_length)
        */
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `YMDT`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.YMDT.html) for more information.
        *
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `DET`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DET.html) for more information.
        *
        *Additional information: [1](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DET.html#method.with_time_precision), [2](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DET.html#method.with_alignment), [3](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.DET.html#method.for_length)
        */
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `MDET`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDET.html) for more information.
        *
        *Additional information: [1](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDET.html#method.with_time_precision), [2](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDET.html#method.with_alignment), [3](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.MDET.html#method.for_length)
        */
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `YMDET`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.YMDET.html) for more information.
        *
        ...
        */
        ...
        /** See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.try_new) for more information.
        *
        *See the [Rust documentation for `ET`](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.ET.html) for more information.
        *
        *Additional information: [1](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.ET.html#method.with_time_precision), [2](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.ET.html#method.with_alignment), [3](https://docs.rs/icu/2.3.0/icu/datetime/fieldsets/struct.ET.html#method.for_length)
        */
    ...
    /** See the [Rust documentation for `format`](https://docs.rs/icu/2.3.0/icu/datetime/range/struct.FixedCalendarDateRangeFormatter.html#method.format) for more information.
    */
