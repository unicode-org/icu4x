...
*
*See the [Rust documentation for `IanaParserExtended`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserExtended.html) for more information.
*/
class IanaParserExtended internal constructor (
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `new`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserExtended.html#method.new) for more information.
        */
    ...
    /** See the [Rust documentation for `parse`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserExtendedBorrowed.html#method.parse) for more information.
    */
    ...
    /** See the [Rust documentation for `iter`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserExtendedBorrowed.html#method.iter) for more information.
    */
    ...
    /** See the [Rust documentation for `iter_all`](https://docs.rs/icu/2.3.0/icu/time/zone/iana/struct.IanaParserExtendedBorrowed.html#method.iter_all) for more information.
    */
