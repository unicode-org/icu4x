...
*
*See the [Rust documentation for `AnyCalendarKind`](https://docs.rs/icu/2.3.0/icu/calendar/enum.AnyCalendarKind.html) for more information.
*/
enum class CalendarKind(val inner: Int) {
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/calendar/enum.AnyCalendarKind.html#method.try_new) for more information.
        */
