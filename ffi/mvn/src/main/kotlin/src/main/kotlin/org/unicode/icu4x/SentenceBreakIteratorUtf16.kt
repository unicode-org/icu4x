...
internal interface SentenceBreakIteratorUtf16Lib: Library {
...
/** See the [Rust documentation for `SentenceBreakIterator`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.SentenceBreakIterator.html) for more information.
*/
class SentenceBreakIteratorUtf16 internal constructor (
    ...
    companion object {
        internal val libClass: Class<SentenceBreakIteratorUtf16Lib> = SentenceBreakIteratorUtf16Lib::class.java
    ...
    *
    *See the [Rust documentation for `next`](https://docs.rs/icu/2.3.0/icu/segmenter/iterators/struct.SentenceBreakIterator.html#method.next) for more information.
    */
    fun next(): Int {
