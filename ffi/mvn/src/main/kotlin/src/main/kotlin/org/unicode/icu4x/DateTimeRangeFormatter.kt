...
internal interface DateTimeRangeFormatterLib: Library {
    fun icu4x_DateTimeRangeFormatter_destroy_mv1(handle: Pointer)
    fun icu4x_DateTimeRangeFormatter_create_dt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_dt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_mdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_mdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_ymdt_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_ymdt_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_det_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_det_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_mdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_mdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_ymdet_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_ymdet_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt, yearStyle: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_et_mv1(locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
    fun icu4x_DateTimeRangeFormatter_create_et_with_provider_mv1(provider: Pointer, locale: Pointer, length: OptionInt, timePrecision: OptionInt, alignment: OptionInt): ResultPointerInt
...
class DateTimeRangeFormatter internal constructor (
    ...
    private class DateTimeRangeFormatterCleaner(val handle: Pointer, val lib: DateTimeRangeFormatterLib) : Runnable {
        override fun run() {
            lib.icu4x_DateTimeRangeFormatter_destroy_mv1(handle)
        }
    }
    private fun registerCleaner() {
        CLEANER.register(this, DateTimeRangeFormatter.DateTimeRangeFormatterCleaner(handle, DateTimeRangeFormatter.lib));
    }

    companion object {
        internal val libClass: Class<DateTimeRangeFormatterLib> = DateTimeRangeFormatterLib::class.java
        ...
        */
        fun createDt(locale: Locale, length: DateTimeLength?, timePrecision: TimePrecision?, alignment: DateTimeAlignment?): Result<DateTimeRangeFormatter> {
            ...
            if (nativeOkVal != null) {
                ...
                val returnOpaque = DateTimeRangeFormatter(handle, selfEdges, true)
