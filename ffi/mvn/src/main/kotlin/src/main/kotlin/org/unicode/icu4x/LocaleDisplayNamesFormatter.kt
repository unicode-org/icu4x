...
*
*See the [Rust documentation for `LocaleDisplayNamesFormatter`](https://docs.rs/icu/2.3.0/icu/experimental/displaynames/multi/struct.LocaleDisplayNamesFormatter.html) for more information.
*/
class LocaleDisplayNamesFormatter internal constructor (
    ...
    companion object {
        ...
        *
        *See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/experimental/displaynames/multi/struct.LocaleDisplayNamesFormatter.html#method.try_new) for more information.
        */
        ...
        *
        *See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/experimental/displaynames/struct.LocaleDisplayNamesFormatter.html#method.try_new) for more information.
        */
    ...
    *🚧 This API is unstable and may experience breaking changes outside major releases.
    *
    *See the [Rust documentation for `of`](https://docs.rs/icu/2.3.0/icu/experimental/displaynames/multi/struct.LocaleDisplayNamesFormatter.html#method.of) for more information.
    */
