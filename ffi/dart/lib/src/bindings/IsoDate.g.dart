...
final class IsoDate implements ffi.Finalizable {
  ...
  IsoDate tryAddedWithOptions(DateDuration duration, DateAddOptions options) {
    final temp = _FinalizedArena();
    final result = _icu4x_IsoDate_try_added_with_options_mv1(_ffi, duration._toFfi(temp.arena), options._toFfi(temp.arena));
    if (!result.isOk) {
...
@_DiplomatFfiUse('icu4x_IsoDate_try_added_with_options_mv1')
