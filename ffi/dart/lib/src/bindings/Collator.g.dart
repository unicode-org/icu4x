...
/// See the [Rust documentation for `Collator`](https://docs.rs/icu/2.3.0/icu/collator/struct.Collator.html) for more information.
final class Collator implements ffi.Finalizable {
  ...
  ///
  /// See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/collator/struct.Collator.html#method.try_new) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `compare_utf16`](https://docs.rs/icu/2.3.0/icu/collator/struct.CollatorBorrowed.html#method.compare_utf16) for more information.
  ...
  ///
  /// See the [Rust documentation for `resolved_options`](https://docs.rs/icu/2.3.0/icu/collator/struct.CollatorBorrowed.html#method.resolved_options) for more information.
