...
final class ZonedDateTimeFormatterGregorian implements ffi.Finalizable {
  ...
  /// See the [Rust documentation for `format_same_calendar`](https://docs.rs/icu/2.3.0/icu/datetime/struct.FixedCalendarDateTimeFormatter.html#method.format_same_calendar) for more information.
  ///
  /// Throws [DateTimeMismatchedCalendarError] on failure.
  String formatSameCalendar(Date date, Time time, TimeZoneInfo zone) {
    final write = _Write();
    final result = _icu4x_ZonedDateTimeFormatterGregorian_format_same_calendar_mv1(_ffi, date._ffi, time._ffi, zone._ffi, write._ffi);
    if (!result.isOk) {
