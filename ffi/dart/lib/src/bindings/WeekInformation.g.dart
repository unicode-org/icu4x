...
///
/// See the [Rust documentation for `WeekInformation`](https://docs.rs/icu/2.3.0/icu/calendar/week/struct.WeekInformation.html) for more information.
final class WeekInformation implements ffi.Finalizable {
  ...
  ///
  /// See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/calendar/week/struct.WeekInformation.html#method.try_new) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `first_weekday`](https://docs.rs/icu/2.3.0/icu/calendar/week/struct.WeekInformation.html#structfield.first_weekday) for more information.
  ...
  /// See the [Rust documentation for `weekend`](https://docs.rs/icu/2.3.0/icu/calendar/week/struct.WeekInformation.html#structfield.weekend) for more information.
  ///
  /// See the [Rust documentation for `contains`](https://docs.rs/icu/2.3.0/icu/calendar/provider/struct.WeekdaySet.html#method.contains) for more information.
  bool isWeekend(Weekday day) {
    final result = _icu4x_WeekInformation_is_weekend_mv1(_ffi, day._ffi);
    return result;
  }

  /// See the [Rust documentation for `weekend`](https://docs.rs/icu/2.3.0/icu/calendar/week/struct.WeekInformation.html#method.weekend) for more information.
