...
/// See the [Rust documentation for `ListFormatter`](https://docs.rs/icu/2.3.0/icu/list/struct.ListFormatter.html) for more information.
final class ListFormatter implements ffi.Finalizable {
  ...
  ///
  /// See the [Rust documentation for `try_new_and`](https://docs.rs/icu/2.3.0/icu/list/struct.ListFormatter.html#method.try_new_and) for more information.
  ///
  ...
  /// Construct a new `ListFormatter` instance for And patterns from compiled data.
  ///
  /// See the [Rust documentation for `try_new_or`](https://docs.rs/icu/2.3.0/icu/list/struct.ListFormatter.html#method.try_new_or) for more information.
  ///
  /// Throws [DataError] on failure.
  ...
  /// Construct a new `ListFormatter` instance for And patterns from compiled data.
  ///
  /// See the [Rust documentation for `try_new_unit`](https://docs.rs/icu/2.3.0/icu/list/struct.ListFormatter.html#method.try_new_unit) for more information.
  ///
  /// Throws [DataError] on failure.
  ...
  /// See the [Rust documentation for `format`](https://docs.rs/icu/2.3.0/icu/list/struct.ListFormatter.html#method.format) for more information.
