...
/// See the [Rust documentation for `FixedCalendarDateTimeFormatter`](https://docs.rs/icu/2.3.0/icu/datetime/struct.FixedCalendarDateTimeFormatter.html) for more information.
final class DateTimeFormatterGregorian implements ffi.Finalizable {
  ...
  /// See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/datetime/struct.FixedCalendarDateTimeFormatter.html#method.try_new) for more information.
  ///
  ...
  /// See the [Rust documentation for `format`](https://docs.rs/icu/2.3.0/icu/datetime/struct.FixedCalendarDateTimeFormatter.html#method.format) for more information.
