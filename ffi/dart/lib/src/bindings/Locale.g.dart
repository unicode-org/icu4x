...
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, _SliceUtf8)>(isLeaf: true, symbol: 'icu4x_Locale_add_variant_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_Locale_add_variant_mv1(ffi.Pointer<ffi.Opaque> self, _SliceUtf8 s);

@_DiplomatFfiUse('icu4x_Locale_remove_variant_mv1')
@ffi.Native<_ResultVoidInt32 Function(ffi.Pointer<ffi.Opaque>, _SliceUtf8)>(isLeaf: true, symbol: 'icu4x_Locale_remove_variant_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidInt32 _icu4x_Locale_remove_variant_mv1(ffi.Pointer<ffi.Opaque> self, _SliceUtf8 s);
