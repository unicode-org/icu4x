...
final class Date implements ffi.Finalizable {
  ...
  ///
  /// See the [Rust documentation for `new_from_iso`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.new_from_iso) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `try_from_fields`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_from_fields) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `try_new`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.try_new) for more information.
  ///
  /// See the [Rust documentation for `try_from_str`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.Month.html#method.try_from_str) for more information.
  ///
  /// Throws [CalendarError] on failure.
  ...
  ///
  /// See the [Rust documentation for `to_iso`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.to_iso) for more information.
  IsoDate toIso() {
  ...
  ///
  /// See the [Rust documentation for `month`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.month) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `code`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.Month.html#method.code) for more information.
  ///
  /// See the [Rust documentation for `standard_code`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.MonthInfo.html#structfield.standard_code) for more information.
  ///
  ...
  ///
  /// See the [Rust documentation for `number`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.Month.html#method.number) for more information.
  int get monthNumber {
  ...
  ///
  /// See the [Rust documentation for `is_leap`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.Month.html#method.is_leap) for more information.
  ...
  ///
  /// See the [Rust documentation for `era_year_or_related_iso`](https://docs.rs/icu/2.3.0/icu/calendar/types/enum.YearInfo.html#method.era_year_or_related_iso) for more information.
  ///
  /// Additional information: [1](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.EraYear.html#structfield.year), [2](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.CyclicYear.html#structfield.related_iso), [3](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.year)
  ...
  ///
  /// See the [Rust documentation for `era`](https://docs.rs/icu/2.3.0/icu/calendar/types/struct.EraYear.html#structfield.era) for more information.
  ///
  /// Additional information: [1](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.year)
  String get era {
    final write = _Write();
  ...
  ///
  /// See the [Rust documentation for `calendar`](https://docs.rs/icu/2.3.0/icu/calendar/struct.Date.html#method.calendar) for more information.
  ...
  Date tryAddWithOptions(DateDuration duration, DateAddOptions options) {
    final temp = _FinalizedArena();
    final result = _icu4x_Date_try_add_with_options_mv1(_ffi, duration._toFfi(temp.arena), options._toFfi(temp.arena));
    if (!result.isOk) {
  ...
  ///
  /// Throws [CalendarMismatchedCalendarError] on failure.
  DateDuration tryUntilWithOptions(Date other, DateDifferenceOptions options) {
    ...
    if (!result.isOk) {
      throw CalendarMismatchedCalendarError();
    }
