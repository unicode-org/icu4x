...
.. cpp:class:: ICU4XPluralRules
    ...
    .. cpp:function:: static ICU4XCreatePluralRulesResult create(const ICU4XLocale& locale, const ICU4XDataProvider& provider, ICU4XPluralRuleType ty)
    ...
    .. cpp:function:: ICU4XPluralCategory select(const ICU4XPluralOperands& op)
    ...
    .. cpp:function:: ICU4XPluralCategories categories()
