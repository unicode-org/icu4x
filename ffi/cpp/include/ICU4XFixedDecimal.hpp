...
class ICU4XFixedDecimal {
 public:
  ...
  void negate();
  template<typename W> void to_string_to_writeable(W& to);
...
template<typename W> inline void ICU4XFixedDecimal::to_string_to_writeable(W& to) {
...
inline std::string ICU4XFixedDecimal::to_string() {
