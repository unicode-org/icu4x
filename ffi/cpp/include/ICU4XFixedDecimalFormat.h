...
ICU4XFixedDecimalFormatResult ICU4XFixedDecimalFormat_try_new_specific(const ICU4XLocale* locale, const ICU4XFixedDecimalFormatDataProvider* provider, ICU4XFixedDecimalFormatOptions options);
