...
class ICU4XFixedDecimalFormat {
 public:
  ...
  static ICU4XFixedDecimalFormatResult try_new_specific(const ICU4XLocale& locale, const ICU4XFixedDecimalFormatDataProvider& provider, ICU4XFixedDecimalFormatOptions options);
...
#include "ICU4XFixedDecimalFormatDataProvider.hpp"
...
inline ICU4XFixedDecimalFormatResult ICU4XFixedDecimalFormat::try_new_specific(const ICU4XLocale& locale, const ICU4XFixedDecimalFormatDataProvider& provider, ICU4XFixedDecimalFormatOptions options) {
  ICU4XFixedDecimalFormatOptions diplomat_wrapped_struct_options = options;
  capi::ICU4XFixedDecimalFormatResult diplomat_raw_struct_out_value = capi::ICU4XFixedDecimalFormat_try_new_specific(locale.AsFFI(), provider.AsFFI(), capi::ICU4XFixedDecimalFormatOptions{ .grouping_strategy = static_cast<capi::ICU4XFixedDecimalGroupingStrategy>(diplomat_wrapped_struct_options.grouping_strategy), .sign_display = static_cast<capi::ICU4XFixedDecimalSignDisplay>(diplomat_wrapped_struct_options.sign_display) });
  auto diplomat_optional_raw_out_value_fdf = diplomat_raw_struct_out_value.fdf;
  std::optional<ICU4XFixedDecimalFormat> diplomat_optional_out_value_fdf;
  if (diplomat_optional_raw_out_value_fdf != nullptr) {
    diplomat_optional_out_value_fdf = ICU4XFixedDecimalFormat(diplomat_optional_raw_out_value_fdf);
