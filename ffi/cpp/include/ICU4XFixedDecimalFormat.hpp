...
class ICU4XFixedDecimalFormat {
 public:
  ...
  template<typename W> diplomat::result<std::monostate, std::monostate> format_write_to_writeable(const ICU4XFixedDecimal& value, W& write);
...
template<typename W> inline diplomat::result<std::monostate, std::monostate> ICU4XFixedDecimalFormat::format_write_to_writeable(const ICU4XFixedDecimal& value, W& write) {
  capi::DiplomatWriteable write_writer = diplomat::WriteableTrait<W>::Construct(write);
  auto diplomat_result_raw_out_value = capi::ICU4XFixedDecimalFormat_format_write(this->inner.get(), value.AsFFI(), &write_writer);
...
inline diplomat::result<std::string, std::monostate> ICU4XFixedDecimalFormat::format_write(const ICU4XFixedDecimal& value) {
