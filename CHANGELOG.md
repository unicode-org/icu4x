...
- Data model and providers
    ...
    - `icu_provider_source`
        ...
        - `CurrencyEssentials` datagen: `currency_pattern_selection` now classifies optional negative `;` subpatterns alongside positive ones, with a merge heuristic when they disagree (unicode-org#6064).
        - Short compact currency datagen: warn on optional negative subpatterns only when they disagree from positive after the same parse rules, or fail to parse (unicode-org#6064).
