...
- Data model and providers
  - `icu_provider`:
    ...
    - (experimental) Add `AuxiliaryKey` to `LanguageIdentifier` (https://github.com/unicode-org/icu4x/pull/3872)
  - `icu_datagen`:
...
- Data model and providers
  ...
  - Passing `LanguageIdentifier` by reference (#2224)
  ...
  - Renaming `DataOptions` to `LanguageIdentifier` (#2223)
