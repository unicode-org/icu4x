...
If more than one of these strategies is useful, we could consider making multiple variant fields on LanguageIdentifier with different fallback behavior.
