...
* [ ] Upload FFI artifacts to the release
  * Monitor the [Artifacts Build GitHub Action](https://github.com/unicode-org/icu4x/actions/workflows/artifacts-build.yml) for the release tag. Verify that `ffi-libs` completed successfully.
...
* [ ] Announce the release to public
  ...
  * [ ] (All releases) Email icu4x-announce@unicode.org (see https://groups.google.com/a/unicode.org/g/icu4x-announce)
