// @generated
/// Implement `DataProvider<CaseMapUnfoldV1Marker>` on the given struct using the data
...
macro_rules! __impl_props_casemap_unfold_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_PROPS_CASEMAP_UNFOLD_V1: &'static <icu::casemap::provider::unfold::CaseMapUnfoldV1Marker as icu_provider::DataMarker>::Yokeable = &icu::casemap::provider::unfold::CaseMapUnfoldV1 {
                map: unsafe {
                    #[allow(unused_unsafe)]
        ...
        #[clippy::msrv = "1.65"]
        impl icu_provider::DataProvider<icu::casemap::provider::unfold::CaseMapUnfoldV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu::casemap::provider::unfold::CaseMapUnfoldV1Marker>, icu_provider::DataError> {
                if req.locale.is_empty() {
                    Ok(icu_provider::DataResponse { payload: Some(icu_provider::DataPayload::from_static_ref(Self::SINGLETON_PROPS_CASEMAP_UNFOLD_V1)), metadata: Default::default() })
                } else {
                    Err(icu_provider::DataErrorKind::ExtraneousLocale.with_req(<icu::casemap::provider::unfold::CaseMapUnfoldV1Marker as icu_provider::KeyedDataMarker>::KEY, req))
                }
            }
        }
    };
