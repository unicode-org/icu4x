...
#[icu_provider::data_struct(marker(LikelySubtagsV1Marker, "locid_transform/likelysubtags@1", singleton))]
...
#[icu_provider::data_struct(marker(LikelySubtagsForLanguageV1Marker, "locid_transform/likelysubtags_l@1", singleton))]
#[derive(Debug, PartialEq, Clone)]
#[cfg_attr(
    feature = "datagen",
    derive(serde::Serialize, databake::Bake),
...
#[icu_provider::data_struct(
    marker(LikelySubtagsForScriptRegionV1Marker, "locid_transform/likelysubtags_sr@1",
    singleton),
)]
#[derive(Debug, PartialEq, Clone)]
#[cfg_attr(
...
#[icu_provider::data_struct(marker(LikelySubtagsExtendedV1Marker, "locid_transform/likelysubtags_ext@1", singleton))]
#[derive(Debug, PartialEq, Clone)]
#[cfg_attr(
    feature = "datagen",
    derive(serde::Serialize, databake::Bake),
