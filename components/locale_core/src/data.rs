...
impl From<Language> for DataLocale {
...
impl From<Option<Script>> for DataLocale {
...
impl From<Option<Region>> for DataLocale {
...
/// Convert from an LSR tuple to a [`DataLocale`].
///
/// # Examples
///
/// ```
...
/// assert_eq!(
///     DataLocale::from((lang, Some(script), Some(region))),
///     locale!("en-Latn-US").into(),
/// );
/// ```
...
impl From<&DataLocale> for (Language, Option<Script>, Option<Region>) {
    fn from(locale: &DataLocale) -> Self {
