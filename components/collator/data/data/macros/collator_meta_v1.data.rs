    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_collator::provider::CollationMetadataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_collator::provider::CollationMetadataV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu_collator::provider::CollationMetadataV1Marker as icu_provider::DataMarker>::Yokeable; 94usize] = [&AF, &AM, &AR, &AR, &AR, &AR, &AM, &AR, &AR, &AF, &AR, &AR, &AF, &AM, &AF, &AF, &DA, &AF, &AF, &AM, &AF, &AF, &AF, &AF, &AR, &AR, &AF, &AF, &AF, &AF, &FR_CA, &AF, &AR, &AF, &AM, &AR, &AR, &AF, &AF, &AR, &AF, &AF, &AR, &AM, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AM, &LT, &AF, &AR, &AR, &AM, &AR, &AR, &AM, &AF, &AR, &AR, &AF, &AR, &AF, &AM, &AR, &AR, &AF, &AF, &AF, &AR, &AR, &AF, &AR, &AR, &TH, &AF, &AF, &AF, &AR, &UND, &AR, &AF, &VI, &VI, &AF, &AF, &AR, &AR, &AR, &AR];
                static KEYS: [&str; 94usize] = ["af", "am", "ar", "as", "az", "be", "bg", "bn", "bn-u-co-trad", "br", "bs", "bs-Cyrl", "ceb", "chr", "cs", "cy", "da", "de-u-co-phonebk", "dsb", "el", "en-US-posix", "es", "es-u-co-trad", "et", "fa", "fa-AF", "ff-Adlm", "fi", "fil", "fo", "fr-CA", "gl", "gu", "ha", "he", "hi", "hr", "hsb", "hu", "hy", "ig", "is", "ja", "ka", "kk", "km", "kn", "kn-u-co-trad", "ko", "ko-u-co-unihan", "kok", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "my", "ne", "no", "or", "pa", "pl", "ps", "ro", "ru", "si", "si-u-co-dict", "sk", "sl", "sq", "sr", "sr-Latn", "sv", "ta", "te", "th", "tk", "to", "tr", "uk", "und", "ur", "uz", "vi", "vi-u-co-trad", "wo", "yo", "zh", "zh-u-co-stroke", "zh-u-co-unihan", "zh-u-co-zhuyin"];
