    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_collator::provider::CollationMetadataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_collator::provider::CollationMetadataV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu_collator::provider::CollationMetadataV1Marker as icu_provider::DataMarker>::Yokeable; 84usize] = [&AF, &AM, &AR, &AR, &AR, &AR, &AR, &AM, &AR, &AR, &AR, &AF, &AF, &DA, &AF, &AM, &AF, &AF, &AF, &AR, &AF, &AF, &AF, &AF, &AR, &AF, &AM, &AR, &AR, &AF, &AR, &AF, &AF, &AR, &AR, &AM, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AM, &LT, &AF, &AR, &AR, &AM, &AR, &AR, &AM, &AF, &AR, &AR, &AF, &AR, &AF, &AM, &AR, &AR, &AF, &AF, &AF, &AR, &AR, &AF, &AF, &AR, &AR, &TH, &AF, &AF, &AR, &AR, &AF, &VI, &VI, &AF, &AR, &AR, &AR, &AR];
                static KEYS: [&str; 84usize] = ["af", "am", "ar", "ar-u-co-compat", "as", "az", "be", "bg", "bn", "bn-u-co-trad", "bs", "cs", "cy", "da", "de-u-co-phonebk", "el", "es", "es-u-co-trad", "et", "fa", "fi", "fi-u-co-trad", "fil", "gl", "gu", "ha", "he", "hi", "hr", "hu", "hy", "ig", "is", "ja", "ja-u-co-unihan", "ka", "kk", "km", "kn", "kn-u-co-trad", "ko", "ko-u-co-unihan", "kok", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "my", "ne", "no", "or", "pa", "pl", "ps", "ro", "ru", "si", "si-u-co-dict", "sk", "sl", "sq", "sr", "sr-Latn", "sv", "sv-u-co-trad", "ta", "te", "th", "tk", "tr", "uk", "ur", "uz", "vi", "vi-u-co-trad", "yo", "zh", "zh-u-co-stroke", "zh-u-co-unihan", "zh-u-co-zhuyin"];
                ...
                match KEYS.binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                    ...
                    Err(_) => Err(icu_provider::DataErrorKind::MissingLocale.with_req(<icu_collator::provider::CollationMetadataV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
