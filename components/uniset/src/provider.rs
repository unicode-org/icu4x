...
pub mod key {
    ...
    pub const BIDI_CLASS_LEFT_TO_RIGHT_EMBEDDING_V1: ResourceKey = resource_key!(uniset, "bc=LRE", 1);
    pub const BIDI_CLASS_LEFT_TO_RIGHT_ISOLATE_V1: ResourceKey = resource_key!(uniset, "bc=LRI", 1);
    pub const BIDI_CLASS_LEFT_TO_RIGHT_OVERRIDE_V1: ResourceKey = resource_key!(uniset, "bc=LRO", 1);
    ...
    pub const BIDI_CLASS_POP_DIRECTIONAL_FORMAT_V1: ResourceKey = resource_key!(uniset, "bc=PDF", 1);
    pub const BIDI_CLASS_POP_DIRECTIONAL_ISOLATE_V1: ResourceKey = resource_key!(uniset, "bc=PDI", 1);
    pub const BIDI_CLASS_RIGHT_TO_LEFT_V1: ResourceKey = resource_key!(uniset, "bc=R", 1);
    pub const BIDI_CLASS_RIGHT_TO_LEFT_EMBEDDING_V1: ResourceKey = resource_key!(uniset, "bc=RLE", 1);
    pub const BIDI_CLASS_RIGHT_TO_LEFT_ISOLATE_V1: ResourceKey = resource_key!(uniset, "bc=RLI", 1);
    pub const BIDI_CLASS_RIGHT_TO_LEFT_OVERRIDE_V1: ResourceKey = resource_key!(uniset, "bc=RLO", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_NOT_REORDERED_V1: ResourceKey = resource_key!(uniset, "ccc=0", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_CCC103_V1: ResourceKey = resource_key!(uniset, "ccc=103", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC107_V1: ResourceKey = resource_key!(uniset, "ccc=107", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC11_V1: ResourceKey = resource_key!(uniset, "ccc=11", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC118_V1: ResourceKey = resource_key!(uniset, "ccc=118", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC12_V1: ResourceKey = resource_key!(uniset, "ccc=12", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC122_V1: ResourceKey = resource_key!(uniset, "ccc=122", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC129_V1: ResourceKey = resource_key!(uniset, "ccc=129", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC13_V1: ResourceKey = resource_key!(uniset, "ccc=13", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC130_V1: ResourceKey = resource_key!(uniset, "ccc=130", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC132_V1: ResourceKey = resource_key!(uniset, "ccc=132", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC133_V1: ResourceKey = resource_key!(uniset, "ccc=133", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "ccc=200", 1);
    pub const CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_V1: ResourceKey = resource_key!(uniset, "ccc=202", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC21_V1: ResourceKey = resource_key!(uniset, "ccc=21", 1);
    pub const CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_V1: ResourceKey = resource_key!(uniset, "ccc=214", 1);
    pub const CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "ccc=216", 1);
    pub const CANONICAL_COMBINING_CLASS_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "ccc=218", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_BELOW_RIGHT_V1: ResourceKey = resource_key!(uniset, "ccc=222", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_ABOVE_LEFT_V1: ResourceKey = resource_key!(uniset, "ccc=228", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "ccc=232", 1);
    pub const CANONICAL_COMBINING_CLASS_DOUBLE_BELOW_V1: ResourceKey = resource_key!(uniset, "ccc=233", 1);
    pub const CANONICAL_COMBINING_CLASS_DOUBLE_ABOVE_V1: ResourceKey = resource_key!(uniset, "ccc=234", 1);
    pub const CANONICAL_COMBINING_CLASS_CCC24_V1: ResourceKey = resource_key!(uniset, "ccc=24", 1);
    pub const CANONICAL_COMBINING_CLASS_IOTA_SUBSCRIPT_V1: ResourceKey = resource_key!(uniset, "ccc=240", 1);
    ...
    pub const CANONICAL_COMBINING_CLASS_HAN_READING_V1: ResourceKey = resource_key!(uniset, "ccc=6", 1);
    pub const CANONICAL_COMBINING_CLASS_NUKTA_V1: ResourceKey = resource_key!(uniset, "ccc=7", 1);
    pub const CANONICAL_COMBINING_CLASS_KANA_VOICING_V1: ResourceKey = resource_key!(uniset, "ccc=8", 1);
    ...
    pub const GENERAL_CATEGORY_CONNECTOR_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Pc", 1);
    pub const GENERAL_CATEGORY_DASH_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Pd", 1);
    pub const GENERAL_CATEGORY_CLOSE_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Pe", 1);
    pub const GENERAL_CATEGORY_FINAL_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Pf", 1);
    pub const GENERAL_CATEGORY_INITIAL_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Pi", 1);
    pub const GENERAL_CATEGORY_OTHER_PUNCTUATION_V1: ResourceKey = resource_key!(uniset, "gc=Po", 1);
    ...
    pub const GENERAL_CATEGORY_PARAGRAPH_SEPARATOR_V1: ResourceKey = resource_key!(uniset, "gc=Zp", 1);
    ...
    pub const GRAPHEME_CLUSTER_BREAK_E_BASE_GAZ_V1: ResourceKey = resource_key!(uniset, "GCB=EBG", 1);
    pub const GRAPHEME_CLUSTER_BREAK_E_MODIFIER_V1: ResourceKey = resource_key!(uniset, "GCB=EM", 1);
    pub const GRAPHEME_CLUSTER_BREAK_EXTEND_V1: ResourceKey = resource_key!(uniset, "GCB=EX", 1);
    pub const GRAPHEME_CLUSTER_BREAK_GLUE_AFTER_ZWJ_V1: ResourceKey = resource_key!(uniset, "GCB=GAZ", 1);
    ...
    pub const GRAPHEME_CLUSTER_BREAK_REGIONAL_INDICATOR_V1: ResourceKey = resource_key!(uniset, "GCB=RI", 1);
    pub const GRAPHEME_CLUSTER_BREAK_SPACINGMARK_V1: ResourceKey = resource_key!(uniset, "GCB=SM", 1);
    ...
    pub const HANGUL_SYLLABLE_TYPE_LVT_SYLLABLE_V1: ResourceKey = resource_key!(uniset, "hst=LVT", 1);
    pub const HANGUL_SYLLABLE_TYPE_NOT_APPLICABLE_V1: ResourceKey = resource_key!(uniset, "hst=NA", 1);
    pub const HANGUL_SYLLABLE_TYPE_TRAILING_JAMO_V1: ResourceKey = resource_key!(uniset, "hst=T", 1);
    pub const HANGUL_SYLLABLE_TYPE_VOWEL_JAMO_V1: ResourceKey = resource_key!(uniset, "hst=V", 1);
    pub const INDIC_POSITIONAL_CATEGORY_BOTTOM_V1: ResourceKey = resource_key!(uniset, "InPC=Bottom", 1);
    pub const INDIC_POSITIONAL_CATEGORY_BOTTOM_AND_LEFT_V1: ResourceKey = resource_key!(uniset, "InPC=Bottom_And_Left", 1);
    pub const INDIC_POSITIONAL_CATEGORY_BOTTOM_AND_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Bottom_And_Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_LEFT_V1: ResourceKey = resource_key!(uniset, "InPC=Left", 1);
    pub const INDIC_POSITIONAL_CATEGORY_LEFT_AND_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Left_And_Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_NA_V1: ResourceKey = resource_key!(uniset, "InPC=NA", 1);
    pub const INDIC_POSITIONAL_CATEGORY_OVERSTRUCK_V1: ResourceKey = resource_key!(uniset, "InPC=Overstruck", 1);
    pub const INDIC_POSITIONAL_CATEGORY_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_V1: ResourceKey = resource_key!(uniset, "InPC=Top", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_BOTTOM_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Bottom", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_BOTTOM_AND_LEFT_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Bottom_And_Left", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_BOTTOM_AND_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Bottom_And_Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_LEFT_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Left", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_LEFT_AND_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Left_And_Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_TOP_AND_RIGHT_V1: ResourceKey = resource_key!(uniset, "InPC=Top_And_Right", 1);
    pub const INDIC_POSITIONAL_CATEGORY_VISUAL_ORDER_LEFT_V1: ResourceKey = resource_key!(uniset, "InPC=Visual_Order_Left", 1);
    pub const INDIC_SYLLABIC_CATEGORY_AVAGRAHA_V1: ResourceKey = resource_key!(uniset, "InSC=Avagraha", 1);
    pub const INDIC_SYLLABIC_CATEGORY_BINDU_V1: ResourceKey = resource_key!(uniset, "InSC=Bindu", 1);
    pub const INDIC_SYLLABIC_CATEGORY_BRAHMI_JOINING_NUMBER_V1: ResourceKey = resource_key!(uniset, "InSC=Brahmi_Joining_Number", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CANTILLATION_MARK_V1: ResourceKey = resource_key!(uniset, "InSC=Cantillation_Mark", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_DEAD_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Dead", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_FINAL_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Final", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_HEAD_LETTER_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Head_Letter", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_INITIAL_POSTFIXED_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Initial_Postfixed", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_KILLER_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Killer", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_MEDIAL_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Medial", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_PLACEHOLDER_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Placeholder", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_PRECEDING_REPHA_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Preceding_Repha", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_PREFIXED_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Prefixed", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_SUBJOINED_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Subjoined", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_SUCCEEDING_REPHA_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_Succeeding_Repha", 1);
    pub const INDIC_SYLLABIC_CATEGORY_CONSONANT_WITH_STACKER_V1: ResourceKey = resource_key!(uniset, "InSC=Consonant_With_Stacker", 1);
    pub const INDIC_SYLLABIC_CATEGORY_GEMINATION_MARK_V1: ResourceKey = resource_key!(uniset, "InSC=Gemination_Mark", 1);
    pub const INDIC_SYLLABIC_CATEGORY_INVISIBLE_STACKER_V1: ResourceKey = resource_key!(uniset, "InSC=Invisible_Stacker", 1);
    pub const INDIC_SYLLABIC_CATEGORY_JOINER_V1: ResourceKey = resource_key!(uniset, "InSC=Joiner", 1);
    pub const INDIC_SYLLABIC_CATEGORY_MODIFYING_LETTER_V1: ResourceKey = resource_key!(uniset, "InSC=Modifying_Letter", 1);
    pub const INDIC_SYLLABIC_CATEGORY_NON_JOINER_V1: ResourceKey = resource_key!(uniset, "InSC=Non_Joiner", 1);
    pub const INDIC_SYLLABIC_CATEGORY_NUKTA_V1: ResourceKey = resource_key!(uniset, "InSC=Nukta", 1);
    pub const INDIC_SYLLABIC_CATEGORY_NUMBER_V1: ResourceKey = resource_key!(uniset, "InSC=Number", 1);
    pub const INDIC_SYLLABIC_CATEGORY_NUMBER_JOINER_V1: ResourceKey = resource_key!(uniset, "InSC=Number_Joiner", 1);
    pub const INDIC_SYLLABIC_CATEGORY_OTHER_V1: ResourceKey = resource_key!(uniset, "InSC=Other", 1);
    pub const INDIC_SYLLABIC_CATEGORY_PURE_KILLER_V1: ResourceKey = resource_key!(uniset, "InSC=Pure_Killer", 1);
    pub const INDIC_SYLLABIC_CATEGORY_REGISTER_SHIFTER_V1: ResourceKey = resource_key!(uniset, "InSC=Register_Shifter", 1);
    pub const INDIC_SYLLABIC_CATEGORY_SYLLABLE_MODIFIER_V1: ResourceKey = resource_key!(uniset, "InSC=Syllable_Modifier", 1);
    pub const INDIC_SYLLABIC_CATEGORY_TONE_LETTER_V1: ResourceKey = resource_key!(uniset, "InSC=Tone_Letter", 1);
    pub const INDIC_SYLLABIC_CATEGORY_TONE_MARK_V1: ResourceKey = resource_key!(uniset, "InSC=Tone_Mark", 1);
    pub const INDIC_SYLLABIC_CATEGORY_VIRAMA_V1: ResourceKey = resource_key!(uniset, "InSC=Virama", 1);
    pub const INDIC_SYLLABIC_CATEGORY_VISARGA_V1: ResourceKey = resource_key!(uniset, "InSC=Visarga", 1);
    pub const INDIC_SYLLABIC_CATEGORY_VOWEL_V1: ResourceKey = resource_key!(uniset, "InSC=Vowel", 1);
    pub const INDIC_SYLLABIC_CATEGORY_VOWEL_DEPENDENT_V1: ResourceKey = resource_key!(uniset, "InSC=Vowel_Dependent", 1);
    pub const INDIC_SYLLABIC_CATEGORY_VOWEL_INDEPENDENT_V1: ResourceKey = resource_key!(uniset, "InSC=Vowel_Independent", 1);
    pub const JOINING_GROUP_AFRICAN_FEH_V1: ResourceKey = resource_key!(uniset, "jg=African_Feh", 1);
    pub const JOINING_GROUP_AFRICAN_NOON_V1: ResourceKey = resource_key!(uniset, "jg=African_Noon", 1);
    pub const JOINING_GROUP_AFRICAN_QAF_V1: ResourceKey = resource_key!(uniset, "jg=African_Qaf", 1);
    ...
    pub const JOINING_GROUP_BURUSHASKI_YEH_BARREE_V1: ResourceKey = resource_key!(uniset, "jg=Burushaski_Yeh_Barree", 1);
    pub const JOINING_GROUP_DAL_V1: ResourceKey = resource_key!(uniset, "jg=Dal", 1);
    pub const JOINING_GROUP_DALATH_RISH_V1: ResourceKey = resource_key!(uniset, "jg=Dalath_Rish", 1);
    ...
    pub const JOINING_GROUP_FINAL_SEMKATH_V1: ResourceKey = resource_key!(uniset, "jg=Final_Semkath", 1);
    ...
    pub const JOINING_GROUP_HANIFI_ROHINGYA_KINNA_YA_V1: ResourceKey = resource_key!(uniset, "jg=Hanifi_Rohingya_Kinna_Ya", 1);
    pub const JOINING_GROUP_HANIFI_ROHINGYA_PA_V1: ResourceKey = resource_key!(uniset, "jg=Hanifi_Rohingya_Pa", 1);
    ...
    pub const JOINING_GROUP_KNOTTED_HEH_V1: ResourceKey = resource_key!(uniset, "jg=Knotted_Heh", 1);
    ...
    pub const JOINING_GROUP_MALAYALAM_BHA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Bha", 1);
    pub const JOINING_GROUP_MALAYALAM_JA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Ja", 1);
    pub const JOINING_GROUP_MALAYALAM_LLA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Lla", 1);
    pub const JOINING_GROUP_MALAYALAM_LLLA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Llla", 1);
    pub const JOINING_GROUP_MALAYALAM_NGA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Nga", 1);
    pub const JOINING_GROUP_MALAYALAM_NNA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Nna", 1);
    pub const JOINING_GROUP_MALAYALAM_NNNA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Nnna", 1);
    pub const JOINING_GROUP_MALAYALAM_NYA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Nya", 1);
    pub const JOINING_GROUP_MALAYALAM_RA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Ra", 1);
    pub const JOINING_GROUP_MALAYALAM_SSA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Ssa", 1);
    pub const JOINING_GROUP_MALAYALAM_TTA_V1: ResourceKey = resource_key!(uniset, "jg=Malayalam_Tta", 1);
    pub const JOINING_GROUP_MANICHAEAN_ALEPH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Aleph", 1);
    pub const JOINING_GROUP_MANICHAEAN_AYIN_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Ayin", 1);
    pub const JOINING_GROUP_MANICHAEAN_BETH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Beth", 1);
    pub const JOINING_GROUP_MANICHAEAN_DALETH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Daleth", 1);
    pub const JOINING_GROUP_MANICHAEAN_DHAMEDH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Dhamedh", 1);
    pub const JOINING_GROUP_MANICHAEAN_FIVE_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Five", 1);
    pub const JOINING_GROUP_MANICHAEAN_GIMEL_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Gimel", 1);
    pub const JOINING_GROUP_MANICHAEAN_HETH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Heth", 1);
    pub const JOINING_GROUP_MANICHAEAN_HUNDRED_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Hundred", 1);
    pub const JOINING_GROUP_MANICHAEAN_KAPH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Kaph", 1);
    pub const JOINING_GROUP_MANICHAEAN_LAMEDH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Lamedh", 1);
    pub const JOINING_GROUP_MANICHAEAN_MEM_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Mem", 1);
    pub const JOINING_GROUP_MANICHAEAN_NUN_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Nun", 1);
    pub const JOINING_GROUP_MANICHAEAN_ONE_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_One", 1);
    pub const JOINING_GROUP_MANICHAEAN_PE_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Pe", 1);
    pub const JOINING_GROUP_MANICHAEAN_QOPH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Qoph", 1);
    pub const JOINING_GROUP_MANICHAEAN_RESH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Resh", 1);
    pub const JOINING_GROUP_MANICHAEAN_SADHE_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Sadhe", 1);
    pub const JOINING_GROUP_MANICHAEAN_SAMEKH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Samekh", 1);
    pub const JOINING_GROUP_MANICHAEAN_TAW_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Taw", 1);
    pub const JOINING_GROUP_MANICHAEAN_TEN_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Ten", 1);
    pub const JOINING_GROUP_MANICHAEAN_TETH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Teth", 1);
    pub const JOINING_GROUP_MANICHAEAN_THAMEDH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Thamedh", 1);
    pub const JOINING_GROUP_MANICHAEAN_TWENTY_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Twenty", 1);
    pub const JOINING_GROUP_MANICHAEAN_WAW_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Waw", 1);
    pub const JOINING_GROUP_MANICHAEAN_YODH_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Yodh", 1);
    pub const JOINING_GROUP_MANICHAEAN_ZAYIN_V1: ResourceKey = resource_key!(uniset, "jg=Manichaean_Zayin", 1);
    ...
    pub const JOINING_GROUP_NO_JOINING_GROUP_V1: ResourceKey = resource_key!(uniset, "jg=No_Joining_Group", 1);
    ...
    pub const JOINING_GROUP_REVERSED_PE_V1: ResourceKey = resource_key!(uniset, "jg=Reversed_Pe", 1);
    pub const JOINING_GROUP_ROHINGYA_YEH_V1: ResourceKey = resource_key!(uniset, "jg=Rohingya_Yeh", 1);
    ...
    pub const JOINING_GROUP_STRAIGHT_WAW_V1: ResourceKey = resource_key!(uniset, "jg=Straight_Waw", 1);
    ...
    pub const JOINING_GROUP_TEH_MARBUTA_V1: ResourceKey = resource_key!(uniset, "jg=Teh_Marbuta", 1);
    pub const JOINING_GROUP_HAMZA_ON_HEH_GOAL_V1: ResourceKey = resource_key!(uniset, "jg=Teh_Marbuta_Goal", 1);
    ...
    pub const JOINING_GROUP_YEH_WITH_TAIL_V1: ResourceKey = resource_key!(uniset, "jg=Yeh_With_Tail", 1);
    ...
    pub const LINE_BREAK_CONDITIONAL_JAPANESE_STARTER_V1: ResourceKey = resource_key!(uniset, "lb=CJ", 1);
    ...
    pub const LEAD_CANONICAL_COMBINING_CLASS_NOT_REORDERED_V1: ResourceKey = resource_key!(uniset, "lccc=0", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_OVERLAY_V1: ResourceKey = resource_key!(uniset, "lccc=1", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC10_V1: ResourceKey = resource_key!(uniset, "lccc=10", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC103_V1: ResourceKey = resource_key!(uniset, "lccc=103", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC107_V1: ResourceKey = resource_key!(uniset, "lccc=107", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC11_V1: ResourceKey = resource_key!(uniset, "lccc=11", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC118_V1: ResourceKey = resource_key!(uniset, "lccc=118", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC12_V1: ResourceKey = resource_key!(uniset, "lccc=12", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC122_V1: ResourceKey = resource_key!(uniset, "lccc=122", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC129_V1: ResourceKey = resource_key!(uniset, "lccc=129", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC13_V1: ResourceKey = resource_key!(uniset, "lccc=13", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC130_V1: ResourceKey = resource_key!(uniset, "lccc=130", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC132_V1: ResourceKey = resource_key!(uniset, "lccc=132", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC133_V1: ResourceKey = resource_key!(uniset, "lccc=133", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC14_V1: ResourceKey = resource_key!(uniset, "lccc=14", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC15_V1: ResourceKey = resource_key!(uniset, "lccc=15", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC16_V1: ResourceKey = resource_key!(uniset, "lccc=16", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC17_V1: ResourceKey = resource_key!(uniset, "lccc=17", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC18_V1: ResourceKey = resource_key!(uniset, "lccc=18", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC19_V1: ResourceKey = resource_key!(uniset, "lccc=19", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC20_V1: ResourceKey = resource_key!(uniset, "lccc=20", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "lccc=200", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_V1: ResourceKey = resource_key!(uniset, "lccc=202", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC21_V1: ResourceKey = resource_key!(uniset, "lccc=21", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_V1: ResourceKey = resource_key!(uniset, "lccc=214", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "lccc=216", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "lccc=218", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC22_V1: ResourceKey = resource_key!(uniset, "lccc=22", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_BELOW_V1: ResourceKey = resource_key!(uniset, "lccc=220", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_BELOW_RIGHT_V1: ResourceKey = resource_key!(uniset, "lccc=222", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_LEFT_V1: ResourceKey = resource_key!(uniset, "lccc=224", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_RIGHT_V1: ResourceKey = resource_key!(uniset, "lccc=226", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ABOVE_LEFT_V1: ResourceKey = resource_key!(uniset, "lccc=228", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC23_V1: ResourceKey = resource_key!(uniset, "lccc=23", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ABOVE_V1: ResourceKey = resource_key!(uniset, "lccc=230", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "lccc=232", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_DOUBLE_BELOW_V1: ResourceKey = resource_key!(uniset, "lccc=233", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_DOUBLE_ABOVE_V1: ResourceKey = resource_key!(uniset, "lccc=234", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC24_V1: ResourceKey = resource_key!(uniset, "lccc=24", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_IOTA_SUBSCRIPT_V1: ResourceKey = resource_key!(uniset, "lccc=240", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC25_V1: ResourceKey = resource_key!(uniset, "lccc=25", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC26_V1: ResourceKey = resource_key!(uniset, "lccc=26", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC27_V1: ResourceKey = resource_key!(uniset, "lccc=27", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC28_V1: ResourceKey = resource_key!(uniset, "lccc=28", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC29_V1: ResourceKey = resource_key!(uniset, "lccc=29", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC30_V1: ResourceKey = resource_key!(uniset, "lccc=30", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC31_V1: ResourceKey = resource_key!(uniset, "lccc=31", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC32_V1: ResourceKey = resource_key!(uniset, "lccc=32", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC33_V1: ResourceKey = resource_key!(uniset, "lccc=33", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC34_V1: ResourceKey = resource_key!(uniset, "lccc=34", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC35_V1: ResourceKey = resource_key!(uniset, "lccc=35", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC36_V1: ResourceKey = resource_key!(uniset, "lccc=36", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_HAN_READING_V1: ResourceKey = resource_key!(uniset, "lccc=6", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_NUKTA_V1: ResourceKey = resource_key!(uniset, "lccc=7", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_KANA_VOICING_V1: ResourceKey = resource_key!(uniset, "lccc=8", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC84_V1: ResourceKey = resource_key!(uniset, "lccc=84", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_VIRAMA_V1: ResourceKey = resource_key!(uniset, "lccc=9", 1);
    pub const LEAD_CANONICAL_COMBINING_CLASS_CCC91_V1: ResourceKey = resource_key!(uniset, "lccc=91", 1);
    ...
    pub const TRAIL_CANONICAL_COMBINING_CLASS_NOT_REORDERED_V1: ResourceKey = resource_key!(uniset, "tccc=0", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_OVERLAY_V1: ResourceKey = resource_key!(uniset, "tccc=1", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC10_V1: ResourceKey = resource_key!(uniset, "tccc=10", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC103_V1: ResourceKey = resource_key!(uniset, "tccc=103", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC107_V1: ResourceKey = resource_key!(uniset, "tccc=107", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC11_V1: ResourceKey = resource_key!(uniset, "tccc=11", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC118_V1: ResourceKey = resource_key!(uniset, "tccc=118", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC12_V1: ResourceKey = resource_key!(uniset, "tccc=12", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC122_V1: ResourceKey = resource_key!(uniset, "tccc=122", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC129_V1: ResourceKey = resource_key!(uniset, "tccc=129", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC13_V1: ResourceKey = resource_key!(uniset, "tccc=13", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC130_V1: ResourceKey = resource_key!(uniset, "tccc=130", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC132_V1: ResourceKey = resource_key!(uniset, "tccc=132", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC133_V1: ResourceKey = resource_key!(uniset, "tccc=133", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC14_V1: ResourceKey = resource_key!(uniset, "tccc=14", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC15_V1: ResourceKey = resource_key!(uniset, "tccc=15", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC16_V1: ResourceKey = resource_key!(uniset, "tccc=16", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC17_V1: ResourceKey = resource_key!(uniset, "tccc=17", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC18_V1: ResourceKey = resource_key!(uniset, "tccc=18", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC19_V1: ResourceKey = resource_key!(uniset, "tccc=19", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC20_V1: ResourceKey = resource_key!(uniset, "tccc=20", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "tccc=200", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ATTACHED_BELOW_V1: ResourceKey = resource_key!(uniset, "tccc=202", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC21_V1: ResourceKey = resource_key!(uniset, "tccc=21", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_V1: ResourceKey = resource_key!(uniset, "tccc=214", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ATTACHED_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "tccc=216", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_BELOW_LEFT_V1: ResourceKey = resource_key!(uniset, "tccc=218", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC22_V1: ResourceKey = resource_key!(uniset, "tccc=22", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_BELOW_V1: ResourceKey = resource_key!(uniset, "tccc=220", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_BELOW_RIGHT_V1: ResourceKey = resource_key!(uniset, "tccc=222", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_LEFT_V1: ResourceKey = resource_key!(uniset, "tccc=224", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_RIGHT_V1: ResourceKey = resource_key!(uniset, "tccc=226", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ABOVE_LEFT_V1: ResourceKey = resource_key!(uniset, "tccc=228", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC23_V1: ResourceKey = resource_key!(uniset, "tccc=23", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ABOVE_V1: ResourceKey = resource_key!(uniset, "tccc=230", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_ABOVE_RIGHT_V1: ResourceKey = resource_key!(uniset, "tccc=232", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_DOUBLE_BELOW_V1: ResourceKey = resource_key!(uniset, "tccc=233", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_DOUBLE_ABOVE_V1: ResourceKey = resource_key!(uniset, "tccc=234", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC24_V1: ResourceKey = resource_key!(uniset, "tccc=24", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_IOTA_SUBSCRIPT_V1: ResourceKey = resource_key!(uniset, "tccc=240", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC25_V1: ResourceKey = resource_key!(uniset, "tccc=25", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC26_V1: ResourceKey = resource_key!(uniset, "tccc=26", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC27_V1: ResourceKey = resource_key!(uniset, "tccc=27", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC28_V1: ResourceKey = resource_key!(uniset, "tccc=28", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC29_V1: ResourceKey = resource_key!(uniset, "tccc=29", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC30_V1: ResourceKey = resource_key!(uniset, "tccc=30", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC31_V1: ResourceKey = resource_key!(uniset, "tccc=31", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC32_V1: ResourceKey = resource_key!(uniset, "tccc=32", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC33_V1: ResourceKey = resource_key!(uniset, "tccc=33", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC34_V1: ResourceKey = resource_key!(uniset, "tccc=34", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC35_V1: ResourceKey = resource_key!(uniset, "tccc=35", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC36_V1: ResourceKey = resource_key!(uniset, "tccc=36", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_HAN_READING_V1: ResourceKey = resource_key!(uniset, "tccc=6", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_NUKTA_V1: ResourceKey = resource_key!(uniset, "tccc=7", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_KANA_VOICING_V1: ResourceKey = resource_key!(uniset, "tccc=8", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC84_V1: ResourceKey = resource_key!(uniset, "tccc=84", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_VIRAMA_V1: ResourceKey = resource_key!(uniset, "tccc=9", 1);
    pub const TRAIL_CANONICAL_COMBINING_CLASS_CCC91_V1: ResourceKey = resource_key!(uniset, "tccc=91", 1);
    pub const VERTICAL_ORIENTATION_ROTATED_V1: ResourceKey = resource_key!(uniset, "vo=R", 1);
    pub const VERTICAL_ORIENTATION_TRANSFORMED_ROTATED_V1: ResourceKey = resource_key!(uniset, "vo=Tr", 1);
    pub const VERTICAL_ORIENTATION_TRANSFORMED_UPRIGHT_V1: ResourceKey = resource_key!(uniset, "vo=Tu", 1);
