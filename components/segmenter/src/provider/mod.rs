...
icu_provider::data_marker!(
    ...
    ///
    /// This marker contains line break rules for Unicode 15.1. It is superseded by
    /// [`SegmenterBreakLineV3`], but retained so that data generated by older versions of ICU4X
    /// keeps working with the compatibility constructors (see [`icu_provider::constructors`]).
    SegmenterBreakLineV1,
