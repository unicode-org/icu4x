...
#[derive(Debug)]
pub struct WordBreakIterator<'l, 'data, 's, Y: RuleBreakType<'s> + ?Sized>(
    RuleBreakIterator<'l, 'data, 's, Y>,
);

derive_usize_iterator_with_type!(WordBreakIterator, 'l, 'data);
...
impl<'l, 'data, 's, Y: RuleBreakType<'s> + ?Sized> WordBreakIterator<'l, 'data, 's, Y> {
    ...
    pub fn iter_with_word_type(self) -> WordBreakIteratorWithWordType<'l, 'data, 's, Y> {
...
#[derive(Debug)]
pub struct WordBreakIteratorWithWordType<'l, 'data, 's, Y: RuleBreakType<'s> + ?Sized>(
    WordBreakIterator<'l, 'data, 's, Y>,
);

impl<'l, 'data, 's, Y: RuleBreakType<'s> + ?Sized> Iterator
    for WordBreakIteratorWithWordType<'l, 'data, 's, Y>
{
...
///
/// For examples of use, see [`WordSegmenter`].
pub type WordBreakIteratorUtf8<'l, 'data, 's> = WordBreakIterator<'l, 'data, 's, WordBreakTypeUtf8>;

/// Word break iterator for a potentially invalid UTF-8 string.
///
/// For examples of use, see [`WordSegmenter`].
pub type WordBreakIteratorPotentiallyIllFormedUtf8<'l, 'data, 's> =
    WordBreakIterator<'l, 'data, 's, WordBreakTypePotentiallyIllFormedUtf8>;

/// Word break iterator for a Latin-1 (8-bit) string.
///
/// For examples of use, see [`WordSegmenter`].
pub type WordBreakIteratorLatin1<'l, 'data, 's> =
    WordBreakIterator<'l, 'data, 's, RuleBreakTypeLatin1>;

/// Word break iterator for a UTF-16 string.
///
/// For examples of use, see [`WordSegmenter`].
pub type WordBreakIteratorUtf16<'l, 'data, 's> =
    WordBreakIterator<'l, 'data, 's, WordBreakTypeUtf16>;
...
impl<'data> WordSegmenterBorrowed<'data> {
    ...
    pub fn segment_str<'l, 's>(&'l self, input: &'s str) -> WordBreakIteratorUtf8<'l, 'data, 's> {
    ...
    pub fn segment_utf8<'l, 's>(
        &'l self,
        input: &'s [u8],
    ) -> WordBreakIteratorPotentiallyIllFormedUtf8<'l, 'data, 's> {
        WordBreakIterator(RuleBreakIterator {
    ...
    pub fn segment_latin1<'l, 's>(
        &'l self,
        input: &'s [u8],
    ) -> WordBreakIteratorLatin1<'l, 'data, 's> {
        WordBreakIterator(RuleBreakIterator {
    ...
    pub fn segment_utf16<'l, 's>(
        &'l self,
        input: &'s [u16],
    ) -> WordBreakIteratorUtf16<'l, 'data, 's> {
        WordBreakIterator(RuleBreakIterator {
