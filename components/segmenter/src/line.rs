...
impl<'l, 's, Y: LineBreakType<'l, 's>> Iterator for LineBreakIterator<'l, 's, Y> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        loop {
            ...
            let STATE_NAMES = ["Unknown", "AI", "AL", "B2", "BA", "BB", "BK", "CB", "CJ", "CL", "CM", "CP", "CR", "EB", "EM", "EX", "GL", "H2", "H3", "HL", "HY", "ID", "ID_CN", "IN", "IS", "JL", "JT", "JV", "LF", "NL", "NS", "NU", "OP_EA", "OP_OP30", "PO", "PO_EAW", "PR", "PR_EAW", "QU", "RI", "SA", "SG", "SP", "SY", "WJ", "XX", "ZW", "ZWJ", "X_ZWJ", "HL_ZWJ", "LB25_NU_CL", "OP_SP", "QU_SP", "CL_CP_SP", "B2_SP", "HL_HY", "LB25_OP", "LB25_NU_IS", "LB25_NU_SY", "LB25_NU_CP", "RI_RI", "sot", "eot"];
