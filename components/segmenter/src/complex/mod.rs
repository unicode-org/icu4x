...
/// dict/LSTM output and the outer line-break engine. Applying the
/// filter here rather than in `line.rs` means the per-line-break-
/// candidate hot path does not have to rescan the break list.
