...
fn word_break_th_wikipedia() {
    ...
    assert_eq!(
        breakpoints,
        [0, 9, 18, 27, 28, 29, 38, 47, 48, 49, 52, 53, 58, 59, 60, 67, 68, 71, 72, 73, 82, 83, 84, 90, 93, 94, 95, 104, 113, 114, 115, 120, 121, 131, 132, 133, 148, 166, 175, 187, 193, 205, 220, 221, 227, 239, 272, 281, 282, 289, 290, 297]
    );
}
