...
pub mod provider {
    ...
    const _: () = {
        ...
        impl_long_day_relative_time_format_data_v1!(Baked);
        impl_long_hour_relative_time_format_data_v1!(Baked);
        impl_long_minute_relative_time_format_data_v1!(Baked);
        impl_long_month_relative_time_format_data_v1!(Baked);
        impl_long_quarter_relative_time_format_data_v1!(Baked);
        impl_long_second_relative_time_format_data_v1!(Baked);
        impl_long_week_relative_time_format_data_v1!(Baked);
        impl_long_year_relative_time_format_data_v1!(Baked);
        impl_narrow_day_relative_time_format_data_v1!(Baked);
        impl_narrow_hour_relative_time_format_data_v1!(Baked);
        impl_narrow_minute_relative_time_format_data_v1!(Baked);
        impl_narrow_month_relative_time_format_data_v1!(Baked);
        impl_narrow_quarter_relative_time_format_data_v1!(Baked);
        impl_narrow_second_relative_time_format_data_v1!(Baked);
        impl_narrow_week_relative_time_format_data_v1!(Baked);
        impl_narrow_year_relative_time_format_data_v1!(Baked);
        impl_short_day_relative_time_format_data_v1!(Baked);
        impl_short_hour_relative_time_format_data_v1!(Baked);
        impl_short_minute_relative_time_format_data_v1!(Baked);
        impl_short_month_relative_time_format_data_v1!(Baked);
        impl_short_quarter_relative_time_format_data_v1!(Baked);
        impl_short_second_relative_time_format_data_v1!(Baked);
        impl_short_week_relative_time_format_data_v1!(Baked);
        impl_short_year_relative_time_format_data_v1!(Baked);
