...
mod tests {
    ...
    pub fn test_en_us_cad() {
        let prefs = locale!("en-US").into();
        let currency_code = "CAD".try_into().unwrap();
        let value = "12345.67".parse().unwrap();
    ...
    pub fn test_code() {
        ...
        let currency_eur = "EUR".try_into().unwrap();
        let fmt_code_fr =
    ...
    pub fn test_name_fallback_to_iso_name() {
        ...
        let currency_xyz = "XYZ".try_into().unwrap();
        let value = "12345.67".parse().unwrap();
    ...
    pub fn test_jpy() {
        ...
        let currency_code = "JPY".try_into().unwrap();
        let value = "12345.67".parse().unwrap();
    ...
    pub fn test_no_currency() {
        ...
        let jpy = "JPY".try_into().unwrap();
        let bhd = "BHD".try_into().unwrap();
