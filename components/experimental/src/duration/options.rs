...
pub struct DurationFormatterOptions {
    ...
    year: (YearStyle, UnitVisibility),
    month: (MonthStyle, UnitVisibility),
    week: (WeekStyle, UnitVisibility),
    day: (DayStyle, UnitVisibility),
    hour: (HourStyle, UnitVisibility),
    minute: (MinuteStyle, UnitVisibility),
    second: (SecondStyle, UnitVisibility),
    millisecond: (MilliSecondStyle, UnitVisibility),
    microsecond: (MicroSecondStyle, UnitVisibility),
    nanosecond: (NanoSecondStyle, UnitVisibility),
