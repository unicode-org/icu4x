...
use crate::fieldsets::dynamic::CompositeDateTimeFieldSet;
use crate::input;
...
///
/// [`CompositeFieldSet`]: crate::fieldsets::dynamic::CompositeFieldSet
/// [`CompositeDateTimeFieldSet`]: crate::fieldsets::dynamic::CompositeDateTimeFieldSet
///
/// # Examples
///
/// ```
...
impl<C: CldrCalendar, R: DateTimeNamesMarker> TypedDateTimeNames<C, R> {
    ...
    /// use icu::calendar::Gregorian;
    /// use icu::datetime::pattern::DateTimePattern;
    /// use icu::datetime::fieldsets::dynamic::ZoneFieldSet;
    /// use icu::datetime::pattern::TypedDateTimeNames;
    /// use icu::locale::locale;
    ...
    /// use icu::datetime::pattern::DateTimePattern;
    /// use icu::datetime::fieldsets::dynamic::TimeFieldSet;
    /// use icu::datetime::pattern::TypedDateTimeNames;
    /// use icu::locale::locale;
    /// use writeable::assert_try_writeable_eq;
    ///
