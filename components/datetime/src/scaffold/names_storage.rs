...
pub trait DateTimeNamesMarker: UnstableSealed {
    ...
    type ZoneLocationsRoot: NamesContainer<tz::LocationsRootV1Marker, ()>;
    type ZoneExemplars: NamesContainer<tz::ExemplarCitiesV1Marker, ()>;
    type ZoneExemplarsRoot: NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>;
...
impl_holder_trait!(tz::LocationsRootV1Marker);
impl_holder_trait!(tz::ExemplarCitiesV1Marker);
impl_holder_trait!(tz::ExemplarCitiesRootV1Marker);
...
pub trait DateTimeNamesFrom<M: DateTimeNamesMarker>: DateTimeNamesMarker {
    ...
    fn map_zone_locations_root(
        other: <M::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container,
    ) -> <Self::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container;
    ...
    fn map_zone_exemplars_root(
        other: <M::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container,
    ) -> <Self::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container;
...
where
    ...
    <Self::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container: From<<M::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container>,
    ...
    <Self::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container: From<<M::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container>,
    ...
    <Self::MetazoneLookup as NamesContainer<tz::MzPeriodV1Marker, ()>>::Container: From<<M::MetazoneLookup as NamesContainer<tz::MzPeriodV1Marker, ()>>::Container>,
{
    ...
    #[inline]
    fn map_zone_locations_root(other: <M::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container) -> <Self::ZoneLocationsRoot as NamesContainer<tz::LocationsRootV1Marker, ()>>::Container {
        other.into()
    }
    #[inline]
    ...
    #[inline]
    fn map_zone_exemplars_root(other: <M::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container) -> <Self::ZoneExemplarsRoot as NamesContainer<tz::ExemplarCitiesRootV1Marker, ()>>::Container {
        other.into()
    }
    #[inline]
