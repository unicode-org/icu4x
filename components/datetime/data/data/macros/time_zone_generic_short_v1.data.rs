            ...
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker>, icu_provider::DataError> {
                ...
                match {
                    ...
                    match ["af", "am", "ar", "as", "az", "be", "bg", "bn", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu", "fa", "fi", "fil", "fr", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hi-Latn", "hr", "hu", "hy", "id", "ig", "is", "it", "ja", "jv", "ka", "kk", "km", "kn", "ko", "kok", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "nn", "no", "or", "pa", "pcm", "pl", "ps", "pt", "ro", "ru", "sd", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta", "te", "th", "tk", "tr", "uk", "ur", "uz", "vi", "yo", "yue", "yue-Hans", "zh", "zh-Hant", "zu"].binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                        Ok(i) => Ok(*unsafe { [&AF, &AM, &AR, &AS, &AM, &AM, &AM, &BN, &BS, &BS, &CS, &BS, &DA, &DE, &DA, &EN, &BS, &AM, &EU, &AM, &AM, &AM, &AM, &GA, &EU, &BS, &BN, &AM, &AM, &HI, &HI_LATN, &BS, &BS, &AM, &ID, &AM, &AM, &DA, &JA, &AM, &AM, &KK, &AM, &BN, &AM, &BN, &AM, &AM, &AM, &DA, &DA, &BN, &AM, &BN, &MS, &AM, &AM, &EU, &NN, &NN, &OR, &BN, &AM, &DA, &AM, &PT, &BS, &AM, &SD, &AM, &SK, &AM, &SO, &AM, &BS, &BS, &SV, &AM, &BN, &BN, &AM, &AM, &AM, &AM, &AM, &AM, &VI, &AM, &AM, &AM, &AM, &ZH_HANT, &AM].get_unchecked(i) }),
