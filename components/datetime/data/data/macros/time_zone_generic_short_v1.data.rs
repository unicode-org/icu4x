    ...
    ($ provider : ty) => {
        ...
        impl icu_provider::DataProvider<icu::datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu::datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker>, icu_provider::DataError> {
                ...
                static ES_419: <icu::datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker as icu_provider::DataMarker>::Yokeable = icu::datetime::provider::time_zones::MetazoneGenericNamesShortV1 {
                    defaults: unsafe {
                        #[allow(unused_unsafe)]
                        zerovec::ZeroMap::from_parts_unchecked(zerovec::ZeroVec::new(), zerovec::VarZeroVec::new())
                    },
                ...
                static VALUES: [&<icu::datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker as icu_provider::DataMarker>::Yokeable; 127usize] = [&AF, &AR, &AS, &AST, &BN, &BN, &BS, &BS, &CHR, &CS, &BS, &DA, &DE, &DE, &DA, &AST, &EN_001, &BS, &EN_AE, &EN_AU, &EN_BW, &EN_CA, &EN_BW, &EN_BW, &EN_GB, &EN_BW, &EN_BW, &EN_GU, &EN_GY, &EN_HK, &EN_IN, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &EN_001, &EN_MO, &EN_001, &EN_BW, &EN_BW, &EN_MY, &EN_BW, &EN_BW, &EN_NZ, &EN_BW, &EN_BW, &EN_SG, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &EN_BW, &BS, &ES_419, &ES_AR, &ES_BO, &ES_CL, &ES_CO, &ES_EC, &ES_PE, &CHR, &ES_UY, &ES_VE, &EU, &FF_ADLM, &FR_CA, &FR_GF, &GA, &EU, &BS, &BN, &HI, &HI_LATN, &BS, &DE, &BS, &ID, &DA, &JA, &KGP, &KK, &BN, &BN, &DA, &DA, &BN, &BN, &EN_SG, &BN, &EU, &NL_SR, &NO, &OR, &BN, &DA, &KGP, &ES_419, &PT_CV, &ES_419, &ES_419, &ES_419, &PT_PT, &ES_419, &ES_419, &ES_PE, &ES_BO, &ES_EC, &BS, &SC, &SD, &SK, &SO, &BS, &BS, &SV, &BN, &TA_MY, &TA_MY, &BN, &ES_419, &VI, &KGP, &ZH_HANT, &TA_MY];
                static KEYS: [&str; 127usize] = ["af", "ar", "as", "ast", "bn", "brx", "bs", "ca", "chr", "cs", "cy", "da", "de", "dsb", "el", "en", "en-001", "en-150", "en-AE", "en-AU", "en-BW", "en-CA", "en-CM", "en-ER", "en-GB", "en-GH", "en-GM", "en-GU", "en-GY", "en-HK", "en-IN", "en-KE", "en-LR", "en-LS", "en-MG", "en-MH", "en-MO", "en-MP", "en-MU", "en-MW", "en-MY", "en-NA", "en-NG", "en-NZ", "en-RW", "en-SD", "en-SG", "en-SL", "en-SS", "en-SZ", "en-TZ", "en-UG", "en-ZA", "en-ZM", "en-ZW", "es", "es-419", "es-AR", "es-BO", "es-CL", "es-CO", "es-EC", "es-PE", "es-US", "es-UY", "es-VE", "eu", "ff-Adlm", "fr-CA", "fr-GF", "ga", "gd", "gl", "gu", "hi", "hi-Latn", "hr", "hsb", "hu", "id", "it", "ja", "kgp", "kk", "kn", "kok", "lv", "mk", "ml", "mr", "ms", "ne-IN", "nl", "nl-SR", "no", "or", "pa", "pl", "pt", "pt-AO", "pt-CV", "pt-GW", "pt-MO", "pt-MZ", "pt-PT", "pt-ST", "pt-TL", "qu", "qu-BO", "qu-EC", "ro", "sc", "sd", "sk", "so", "sr", "sr-Latn", "sv", "ta", "ta-MY", "ta-SG", "te", "und", "vi", "yrl", "zh-Hant", "zh-SG"];
