...
impl IxdtfParser {
    ...
    /// Create a [`ZonedDateTime`] in ISO-8601 calendar from IXDTF syntax UTF-8 bytes.
    ///
    /// See [`Self::try_location_only_iso_from_str`].
    ...
    /// Create a [`ZonedDateTime`] in ISO-8601 calendar from IXDTF syntax UTF-8 bytes.
    ///
    /// See [`Self::try_loose_iso_from_str`].
