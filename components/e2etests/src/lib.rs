...
"#;
    ...
    let act_test_output: LocaleTestOutput = serde_json::from_str(data).expect("cannot parse sample LocaleTestOutput");
...
"#;
    ...
    let act_test_data: LocaleTestData = serde_json::from_str(data).expect("cannot parse sample LocaleTestData");
