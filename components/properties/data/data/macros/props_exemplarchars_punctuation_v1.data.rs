    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::ExemplarCharactersPunctuationV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersPunctuationV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu_properties::provider::ExemplarCharactersPunctuationV1Marker as icu_provider::DataMarker>::Yokeable; 132usize] = [&AF, &AM, &AR, &AS, &AST, &AF, &AF, &BE, &BG, &BGC, &AF, &AF, &AF, &BS, &BS, &AST, &CEB, &AF, &CS, &CV, &AF, &DA, &CV, &DOI, &DSB, &EL, &AF, &AST, &ET, &AF, &FA, &FF_ADLM, &FI, &FIL, &DA, &FR, &AF, &GD, &AST, &AF, &HA, &HE, &HI, &HR, &DSB, &HU, &HY, &AF, &AF, &IG, &IS, &IT, &JA, &KA, &KEA, &AF, &KK, &KM, &KN, &KO, &AF, &AF, &AF, &AF, &CV, &AF, &LT, &LV, &MAI, &MK, &AF, &AF, &AF, &KN, &AF, &MY, &NE, &AF, &NO, &AF, &PA, &AF, &PL, &PS, &AF, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &AF, &RAJ, &RO, &CV, &MAI, &SC, &SD, &SD, &AF, &AF, &CS, &SL, &AF, &SQ, &SR, &SR, &SR, &AF, &AF, &SW, &AF, &TE, &AF, &TH, &TK, &AF, &AF, &TT, &UK, &UND, &UR, &AF, &AF, &AF, &AF, &YO, &AST, &YUE, &YUE_HANS, &YUE, &YUE_HANS, &YUE_HANS, &YUE];
                static KEYS: [&str; 132usize] = ["af", "am", "ar", "as", "ast", "az", "az-Latn", "be", "bg", "bgc", "bho", "bn", "brx", "bs", "bs-Latn", "ca", "ceb", "chr", "cs", "cv", "cy", "da", "de", "doi", "dsb", "el", "en", "es", "et", "eu", "fa", "ff-Adlm", "fi", "fil", "fo", "fr", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hr", "hsb", "hu", "hy", "ia", "id", "ig", "is", "it", "ja", "ka", "kea", "kgp", "kk", "km", "kn", "ko", "kok", "ks", "ks-Arab", "ks-Deva", "ky", "lo", "lt", "lv", "mai", "mk", "ml", "mn", "mni", "mr", "ms", "my", "ne", "nl", "no", "or", "pa", "pcm", "pl", "ps", "pt", "pt-AO", "pt-LU", "pt-PT", "pt-ST", "qu", "raj", "ro", "ru", "sa", "sc", "sd", "sd-Arab", "sd-Deva", "si", "sk", "sl", "so", "sq", "sr", "sr-Cyrl", "sr-Latn", "su", "sv", "sw", "ta", "te", "tg", "th", "tk", "to", "tr", "tt", "uk", "und", "ur", "uz", "uz-Latn", "vi", "xh", "yo", "yrl", "yue", "yue-Hans", "yue-Hant", "zh", "zh-Hans", "zh-Hant"];
