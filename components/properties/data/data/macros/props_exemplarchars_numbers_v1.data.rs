    ...
    ($ provider : ty) => {
        ...
        impl icu_provider::DataProvider<icu::properties::provider::ExemplarCharactersNumbersV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu::properties::provider::ExemplarCharactersNumbersV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu::properties::provider::ExemplarCharactersNumbersV1Marker as icu_provider::DataMarker>::Yokeable; 82usize] = [&AF, &AR, &AR_DZ, &AR_DZ, &AR_DZ, &AR_DZ, &AR_DZ, &AR_SA, &AR_SA, &AR_DZ, &AS, &AF, &AF, &BGC, &BGC, &AS, &AF, &AF, &AF, &AF, &DE_CH, &DE_CH, &AF, &AF, &AF, &AF, &ET, &EU, &FA, &FF_ADLM, &ET, &EU, &FR, &FR_LU, &FR_LU, &GU, &AR_DZ, &BGC, &AF, &AF, &DE_CH, &AF, &AF, &AF, &KN, &BGC, &KS, &AF, &ET, &AF, &ML, &AS, &BGC, &MY, &BGC, &ET, &OR, &PA, &AF, &PS, &AF, &BGC, &RM, &AF, &BGC, &SAT, &AF, &EU, &AF, &ET, &TA, &TE, &AF, &AF, &FR_LU, &KS, &AF, &AF, &YUE, &YUE, &YUE, &YUE];
                static KEYS: [&str; 82usize] = ["af", "ar", "ar-DZ", "ar-LB", "ar-LY", "ar-MA", "ar-MR", "ar-SA", "ar-SO", "ar-TN", "as", "be", "bg", "bgc", "bho", "bn", "br", "cs", "cv", "de-AT", "de-CH", "de-LI", "en-FI", "en-SE", "en-ZA", "es-CR", "et", "eu", "fa", "ff-Adlm", "fi", "fo", "fr", "fr-LU", "fr-MA", "gu", "he", "hi", "hu", "hy", "it-CH", "ka", "kea", "kk", "kn", "kok", "ks", "ky", "lt", "lv", "ml", "mni", "mr", "my", "ne", "no", "or", "pa", "pl", "ps", "pt-PT", "raj", "rm", "ru", "sa", "sat", "sk", "sl", "sq", "sv", "ta", "te", "tk", "uk", "und", "ur", "uz", "uz-Cyrl", "yue", "yue-Hans", "zh", "zh-Hant"];
