    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::ExemplarCharactersNumbersV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersNumbersV1Marker>, icu_provider::DataError> {
                ...
                static UND: <icu_properties::provider::ExemplarCharactersNumbersV1Marker as icu_provider::DataMarker>::Yokeable = icu_properties::provider::PropertyUnicodeSetV1::CPInversionListStrList(icu_collections::codepointinvliststringlist::CodePointInversionListAndStringList::from_parts_unchecked(
                    unsafe {
                        #[allow(unused_unsafe)]
                ...
                static VALUES: [&<icu_properties::provider::ExemplarCharactersNumbersV1Marker as icu_provider::DataMarker>::Yokeable; 83usize] = [&AF, &AR, &AR_DZ, &AR_DZ, &AR_DZ, &AR_DZ, &AR_DZ, &AR_SA, &AR_SA, &AR_DZ, &AS, &AF, &AF, &BGC, &BGC, &AS, &AF, &AF, &AF, &AF, &DE_CH, &DE_CH, &AF, &AF, &AF, &AF, &ET, &EU, &FA, &FF_ADLM, &ET, &EU, &FR, &GU, &AR_DZ, &BGC, &AF, &AF, &DE_CH, &AF, &AF, &AF, &KN, &BGC, &KS, &AF, &ET, &AF, &ML, &AS, &BGC, &MY, &BGC, &ET, &OR, &PA, &PA, &AF, &PS, &AF, &BGC, &RM, &AF, &BGC, &SAT, &AF, &EU, &AF, &ET, &TA, &TE, &AF, &AF, &UND, &KS, &AF, &AF, &YUE, &YUE, &YUE, &YUE, &YUE, &YUE];
                static KEYS: [&str; 83usize] = ["af", "ar", "ar-DZ", "ar-LB", "ar-LY", "ar-MA", "ar-MR", "ar-SA", "ar-SO", "ar-TN", "as", "be", "bg", "bgc", "bho", "bn", "br", "cs", "cv", "de-AT", "de-CH", "de-LI", "en-FI", "en-SE", "en-ZA", "es-CR", "et", "eu", "fa", "ff-Adlm", "fi", "fo", "fr", "gu", "he", "hi", "hu", "hy", "it-CH", "ka", "kea", "kk", "kn", "kok", "ks", "ky", "lt", "lv", "ml", "mni", "mr", "my", "ne", "no", "or", "pa", "pa-Guru", "pl", "ps", "pt-PT", "raj", "rm", "ru", "sa", "sat", "sk", "sl", "sq", "sv", "ta", "te", "tk", "uk", "und", "ur", "uz", "uz-Cyrl", "yue", "yue-Hans", "yue-Hant", "zh", "zh-Hans", "zh-Hant"];
                let mut metadata = icu_provider::DataResponseMetadata::default();
                let payload = if let Ok(payload) = KEYS.binary_search_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse()).map(|i| *unsafe { VALUES.get_unchecked(i) }) {
                    payload
                } else {
                    const FALLBACKER: icu_locid_transform::fallback::LocaleFallbackerWithConfig<'static> = icu_locid_transform::fallback::LocaleFallbacker::new().for_config(icu_locid_transform::fallback::LocaleFallbackConfig::from_key(<icu_properties::provider::ExemplarCharactersNumbersV1Marker as icu_provider::KeyedDataMarker>::KEY));
