            ...
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersNumbersV1Marker>, icu_provider::DataError> {
                ...
                match {
                    ...
                    match ["af", "am", "ar", "as", "az", "be", "bg", "bn", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu", "fa", "fi", "fil", "fr", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hi-Latn", "hr", "hu", "hy", "id", "ig", "is", "it", "ja", "jv", "ka", "kk", "km", "kn", "ko", "kok", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "nn", "no", "or", "pa", "pcm", "pl", "ps", "pt", "ro", "ru", "sd", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta", "te", "th", "tk", "tr", "uk", "ur", "uz", "vi", "yo", "yue", "yue-Hans", "zh", "zh-Hant", "zu"].binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                        Ok(i) => Ok(*unsafe { [&AF, &AM, &AR, &AS, &AM, &AF, &AF, &AS, &AM, &AM, &AF, &AM, &AM, &AM, &AM, &AM, &AM, &ET, &EU, &FA, &ET, &AM, &FR, &AM, &AM, &AM, &GU, &AM, &HE, &HI, &AM, &AM, &AF, &AF, &AM, &AM, &AM, &AM, &AM, &AM, &AF, &AF, &AM, &KN, &AM, &HI, &AF, &AM, &ET, &AF, &AM, &ML, &AM, &HI, &AM, &MY, &HI, &AM, &ET, &ET, &OR, &PA, &AM, &AF, &PS, &AM, &AM, &AF, &AM, &AM, &AF, &EU, &AM, &AF, &AM, &AM, &ET, &AM, &TA, &TE, &AM, &AF, &AM, &AF, &UR, &AF, &AM, &AM, &YUE, &YUE, &YUE, &YUE, &AM].get_unchecked(i) }),
