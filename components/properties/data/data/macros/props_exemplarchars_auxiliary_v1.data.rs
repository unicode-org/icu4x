    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::ExemplarCharactersAuxiliaryV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersAuxiliaryV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu_properties::provider::ExemplarCharactersAuxiliaryV1Marker as icu_provider::DataMarker>::Yokeable; 137usize] = [&AF, &AR, &AR_MA, &AS, &AST, &AZ, &AZ, &BE, &BG, &BGC, &BHO, &BN, &BR, &BRX, &BS, &BS, &CA, &CEB, &CS, &CV, &CY, &DA, &DE, &DOI, &DSB, &EL, &EN, &EN_ZA, &ES, &ET, &EU, &FA, &FA_AF, &FF_ADLM, &FI, &FIL, &FO, &FR, &FR_CA, &GA, &GD, &GL, &GU, &HA, &HA_NE, &HE, &HI, &HI_LATN, &BS, &HSB, &HU, &HY, &EN, &EN, &IG, &IS, &IT, &JA, &JV, &KA, &KEA, &KGP, &KM, &KN, &KO, &HI, &KS, &BRX, &KY, &LO, &LT, &LV, &MAI, &MI, &MK, &MN, &BRX, &HI, &MY, &HI, &NL, &NN, &NO, &BRX, &PA, &PA, &PCM, &PL, &PS, &PS_PK, &PT, &QU, &RAJ, &RM, &RO, &CV, &SA, &SC, &SD, &BRX, &SI, &SK, &SL, &SO, &AZ, &SR, &SR_LATN, &SU, &SU, &SV, &SW, &SW_CD, &BRX, &TE, &TG, &TH, &TI, &TK, &TO, &TR, &TT, &UK, &UND, &UR, &UZ, &TG, &VI, &WO, &EN, &YO, &YRL, &YUE, &YUE_HANS, &YUE, &ZH, &ZH_HANT, &EN];
                static KEYS: [&str; 137usize] = ["af", "ar", "ar-MA", "as", "ast", "az", "az-Latn", "be", "bg", "bgc", "bho", "bn", "br", "brx", "bs", "bs-Latn", "ca", "ceb", "cs", "cv", "cy", "da", "de", "doi", "dsb", "el", "en", "en-ZA", "es", "et", "eu", "fa", "fa-AF", "ff-Adlm", "fi", "fil", "fo", "fr", "fr-CA", "ga", "gd", "gl", "gu", "ha", "ha-NE", "he", "hi", "hi-Latn", "hr", "hsb", "hu", "hy", "ia", "id", "ig", "is", "it", "ja", "jv", "ka", "kea", "kgp", "km", "kn", "ko", "kok", "ks", "ks-Deva", "ky", "lo", "lt", "lv", "mai", "mi", "mk", "mn", "mni", "mr", "my", "ne", "nl", "nn", "no", "or", "pa", "pa-Guru", "pcm", "pl", "ps", "ps-PK", "pt", "qu", "raj", "rm", "ro", "ru", "sa", "sc", "sd", "sd-Deva", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "su", "su-Latn", "sv", "sw", "sw-CD", "ta", "te", "tg", "th", "ti", "tk", "to", "tr", "tt", "uk", "und", "ur", "uz", "uz-Cyrl", "vi", "wo", "xh", "yo", "yrl", "yue", "yue-Hans", "yue-Hant", "zh", "zh-Hant", "zu"];
