    ...
    ($ provider : ty) => {
        ...
        impl icu_provider::DataProvider<icu::properties::provider::ExemplarCharactersAuxiliaryV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu::properties::provider::ExemplarCharactersAuxiliaryV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu::properties::provider::ExemplarCharactersAuxiliaryV1Marker as icu_provider::DataMarker>::Yokeable; 154usize] = [&AF, &AR, &AR_MA, &AS, &AST, &AZ, &BE, &BG, &BGC, &BHO, &BLO, &BN, &BR, &BRX, &BS, &CA, &CEB, &CS, &CV, &CY, &DA, &DE, &DOI, &DSB, &EL, &EN, &EN_ZA, &BS, &ES, &ET, &EU, &FA, &FA_AF, &FF_ADLM, &FI, &FIL, &FO, &FR, &FR_CA, &FY, &GA, &GD, &GL, &GU, &HA, &HA_NE, &HE, &HI, &HI_LATN, &BS, &HSB, &HU, &HY, &EN, &EN, &IE, &IG, &IS, &IT, &JA, &JV, &KA, &KEA, &KGP, &KM, &KN, &KO, &HI, &KS, &BRX, &KU, &KY, &LB, &LIJ, &EN, &LO, &LT, &LV, &MAI, &MI, &MK, &ML, &MN, &BRX, &HI, &MT, &MY, &NDS, &NDS_NL, &HI, &NL, &NN, &NO, &NQO, &OC, &BRX, &PA, &PCM, &PL, &PS, &PS_PK, &PT, &QU, &RAJ, &RM, &RO, &CV, &SA, &SAH, &SC, &SD, &BRX, &SI, &SK, &SL, &SO, &AZ, &SR, &SR_LATN, &SU, &SV, &SW, &SW_CD, &SYR, &SZL, &BRX, &TE, &TG, &TH, &TI, &TK, &TO, &TOK, &TR, &TT, &UG, &UK, &UND, &UR, &UZ, &TG, &VEC, &VI, &VMW, &WO, &EN, &XNR, &YO, &YRL, &YUE, &YUE_HANS, &ZH, &ZH_HANT, &EN];
                static KEYS: [&str; 154usize] = ["af", "ar", "ar-MA", "as", "ast", "az", "be", "bg", "bgc", "bho", "blo", "bn", "br", "brx", "bs", "ca", "ceb", "cs", "cv", "cy", "da", "de", "doi", "dsb", "el", "en", "en-ZA", "eo", "es", "et", "eu", "fa", "fa-AF", "ff-Adlm", "fi", "fil", "fo", "fr", "fr-CA", "fy", "ga", "gd", "gl", "gu", "ha", "ha-NE", "he", "hi", "hi-Latn", "hr", "hsb", "hu", "hy", "ia", "id", "ie", "ig", "is", "it", "ja", "jv", "ka", "kea", "kgp", "km", "kn", "ko", "kok", "ks", "ks-Deva", "ku", "ky", "lb", "lij", "lmo", "lo", "lt", "lv", "mai", "mi", "mk", "ml", "mn", "mni", "mr", "mt", "my", "nds", "nds-NL", "ne", "nl", "nn", "no", "nqo", "oc", "or", "pa", "pcm", "pl", "ps", "ps-PK", "pt", "qu", "raj", "rm", "ro", "ru", "sa", "sah", "sc", "sd", "sd-Deva", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "su", "sv", "sw", "sw-CD", "syr", "szl", "ta", "te", "tg", "th", "ti", "tk", "to", "tok", "tr", "tt", "ug", "uk", "und", "ur", "uz", "uz-Cyrl", "vec", "vi", "vmw", "wo", "xh", "xnr", "yo", "yrl", "yue", "yue-Hans", "zh", "zh-Hant", "zu"];
