    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::ExemplarCharactersIndexV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersIndexV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu_properties::provider::ExemplarCharactersIndexV1Marker as icu_provider::DataMarker>::Yokeable; 130usize] = [&AF, &AM, &AR, &AS, &AST, &AZ, &BE, &BG, &BN, &BR, &BRX, &BS, &BS_CYRL, &BS, &AF, &AF, &CHR, &CS, &CV, &CY, &DA, &AF, &DE_AT, &DOI, &DSB, &EL, &AF, &ES, &ET, &AF, &FA, &FF_ADLM, &FI, &FIL, &FO, &AF, &AF, &GD, &ES, &GU, &HA, &HA_NE, &HE, &HI, &HR, &HSB, &HU, &HY, &AF, &AF, &AF, &IS, &AF, &JA, &JV, &KA, &KEA, &KGP, &KK, &KM, &KN, &KO, &KOK, &KY, &LO, &LT, &LV, &MAI, &MI, &MK, &ML, &MN, &MR, &AF, &MY, &HI, &AF, &DA, &OR, &PA, &PA, &PCM, &PL, &PS, &AF, &QU, &RM, &RO, &RU, &DOI, &SC, &SD, &SD, &SI, &SK, &SL, &SO, &SQ, &BS_CYRL, &BS_CYRL, &BS, &SU, &SU, &FI, &PCM, &TA, &TE, &TG, &TH, &TI, &TK, &TO, &TR, &TT, &UK, &UND, &UR, &UZ, &UZ, &VI, &WO, &AF, &YO, &YRL, &YUE, &AF, &YUE, &AF, &ZH_HANT, &AF];
                static KEYS: [&str; 130usize] = ["af", "am", "ar", "as", "ast", "az", "be", "bg", "bn", "br", "brx", "bs", "bs-Cyrl", "bs-Latn", "ca", "ceb", "chr", "cs", "cv", "cy", "da", "de", "de-AT", "doi", "dsb", "el", "en", "es", "et", "eu", "fa", "ff-Adlm", "fi", "fil", "fo", "fr", "ga", "gd", "gl", "gu", "ha", "ha-NE", "he", "hi", "hr", "hsb", "hu", "hy", "ia", "id", "ig", "is", "it", "ja", "jv", "ka", "kea", "kgp", "kk", "km", "kn", "ko", "kok", "ky", "lo", "lt", "lv", "mai", "mi", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "no", "or", "pa", "pa-Guru", "pcm", "pl", "ps", "pt", "qu", "rm", "ro", "ru", "sa", "sc", "sd", "sd-Arab", "si", "sk", "sl", "so", "sq", "sr", "sr-Cyrl", "sr-Latn", "su", "su-Latn", "sv", "sw", "ta", "te", "tg", "th", "ti", "tk", "to", "tr", "tt", "uk", "und", "ur", "uz", "uz-Latn", "vi", "wo", "xh", "yo", "yrl", "yue", "yue-Hans", "yue-Hant", "zh", "zh-Hant", "zu"];
