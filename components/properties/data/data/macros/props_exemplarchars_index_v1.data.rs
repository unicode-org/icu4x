            ...
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::ExemplarCharactersIndexV1Marker>, icu_provider::DataError> {
                ...
                match {
                    ...
                    match ["af", "am", "ar", "as", "az", "be", "bg", "bn", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu", "fa", "fi", "fil", "fr", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hi-Latn", "hr", "hu", "hy", "id", "ig", "is", "it", "ja", "jv", "ka", "kk", "km", "kn", "ko", "kok", "ky", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "nn", "no", "or", "pa", "pcm", "pl", "ps", "pt", "ro", "ru", "sd", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta", "te", "th", "tk", "tr", "uk", "ur", "uz", "vi", "yo", "yue", "yue-Hans", "zh", "zh-Hant", "zu"].binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                        Ok(i) => Ok(*unsafe { [&AF, &AM, &AR, &AS, &AZ, &BE, &BG, &BN, &BS, &AF, &CS, &CY, &DA, &AF, &EL, &AF, &ES, &ET, &AF, &FA, &FI, &FIL, &AF, &AF, &GD, &ES, &GU, &HA, &HE, &HI, &AF, &HR, &HU, &HY, &AF, &AF, &IS, &AF, &JA, &JV, &KA, &KK, &KM, &KN, &KO, &KOK, &KY, &LO, &LT, &LV, &MK, &ML, &MN, &MR, &AF, &MY, &HI, &AF, &DA, &DA, &OR, &PA, &PCM, &PL, &PS, &AF, &RO, &RU, &SD, &SI, &SK, &SL, &SO, &SQ, &SR, &BS, &FI, &PCM, &TA, &TE, &TH, &TK, &TR, &UK, &UR, &UZ, &VI, &YO, &YUE, &AF, &AF, &ZH_HANT, &AF].get_unchecked(i) }),
