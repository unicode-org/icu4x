...
/// ```
pub fn get_ascii_hex_digit<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::ASCII_HEX_DIGIT_V1)
}

/// Characters with the Alphabetic or Decimal_Number property
/// This is defined for POSIX compatibility.
pub fn get_alnum<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::ALNUM_V1)
}
...
/// ```
pub fn get_alphabetic<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::ALPHABETIC_V1)
}
...
/// ```
pub fn get_bidi_control<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::BIDI_CONTROL_V1)
}
...
/// ```
pub fn get_bidi_mirrored<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::BIDI_MIRRORED_V1)
}

/// Horizontal whitespace characters
pub fn get_blank<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::BLANK_V1)
}
...
/// ```
pub fn get_cased<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CASED_V1)
}
...
/// ```
pub fn get_case_ignorable<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CASE_IGNORABLE_V1)
}

/// Characters that are excluded from composition
/// See <https://unicode.org/Public/UNIDATA/CompositionExclusions.txt>
pub fn get_full_composition_exclusion<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::FULL_COMPOSITION_EXCLUSION_V1)
}
...
/// ```
pub fn get_changes_when_casefolded<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_CASEFOLDED_V1)
}

/// Characters which may change when they undergo case mapping
pub fn get_changes_when_casemapped<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_CASEMAPPED_V1)
}
...
/// ```
pub fn get_changes_when_nfkc_casefolded<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_NFKC_CASEFOLDED_V1)
}
...
/// ```
pub fn get_changes_when_lowercased<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_LOWERCASED_V1)
}
...
/// ```
pub fn get_changes_when_titlecased<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_TITLECASED_V1)
}
...
/// ```
pub fn get_changes_when_uppercased<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CHANGES_WHEN_UPPERCASED_V1)
}
...
/// ```
pub fn get_dash<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::DASH_V1)
}
...
/// ```
pub fn get_deprecated<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::DEPRECATED_V1)
}
...
/// ```
pub fn get_default_ignorable_code_point<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::DEFAULT_IGNORABLE_CODE_POINT_V1)
}
...
/// ```
pub fn get_diacritic<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::DIACRITIC_V1)
}
...
/// ```
pub fn get_emoji_modifier_base<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EMOJI_MODIFIER_BASE_V1)
}
...
/// ```
pub fn get_emoji_component<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EMOJI_COMPONENT_V1)
}
...
/// ```
pub fn get_emoji_modifier<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EMOJI_MODIFIER_V1)
}
...
/// ```
pub fn get_emoji<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EMOJI_V1)
}
...
/// ```
pub fn get_emoji_presentation<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EMOJI_PRESENTATION_V1)
}
...
/// ```
pub fn get_extender<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EXTENDER_V1)
}
...
/// ```
pub fn get_extended_pictographic<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::EXTENDED_PICTOGRAPHIC_V1)
}

/// Visible characters.
/// This is defined for POSIX compatibility.
pub fn get_graph<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::GRAPH_V1)
}
...
/// ```
pub fn get_grapheme_base<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::GRAPHEME_BASE_V1)
}
...
/// ```
pub fn get_grapheme_extend<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::GRAPHEME_EXTEND_V1)
}

/// Deprecated property. Formerly proposed for programmatic determination of grapheme
/// cluster boundaries.
pub fn get_grapheme_link<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::GRAPHEME_LINK_V1)
}
...
/// ```
pub fn get_hex_digit<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::HEX_DIGIT_V1)
}

/// Deprecated property. Dashes which are used to mark connections between pieces of
/// words, plus the Katakana middle dot.
pub fn get_hyphen<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::HYPHEN_V1)
}
...
/// ```
pub fn get_id_continue<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::ID_CONTINUE_V1)
}
...
/// ```
pub fn get_ideographic<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::IDEOGRAPHIC_V1)
}
...
/// ```
pub fn get_id_start<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::ID_START_V1)
}
...
/// ```
pub fn get_ids_binary_operator<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::IDS_BINARY_OPERATOR_V1)
}
...
/// ```
pub fn get_ids_trinary_operator<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::IDS_TRINARY_OPERATOR_V1)
}
...
/// ```
pub fn get_join_control<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::JOIN_CONTROL_V1)
}
...
/// ```
pub fn get_logical_order_exception<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::LOGICAL_ORDER_EXCEPTION_V1)
}
...
/// assert!(!lowercase.contains('A'));
/// ```
pub fn get_lowercase<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::LOWERCASE_V1)
}
...
/// ```
pub fn get_math<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::MATH_V1)
}
...
/// ```
pub fn get_noncharacter_code_point<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::NONCHARACTER_CODE_POINT_V1)
}

/// Characters that are inert under NFC, i.e., they do not interact with adjacent characters
pub fn get_nfc_inert<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::NFC_INERT_V1)
}

/// Characters that are inert under NFD, i.e., they do not interact with adjacent characters
pub fn get_nfd_inert<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::NFD_INERT_V1)
}

/// Characters that are inert under NFKC, i.e., they do not interact with adjacent characters
pub fn get_nfkc_inert<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::NFKC_INERT_V1)
}

/// Characters that are inert under NFKD, i.e., they do not interact with adjacent characters
pub fn get_nfkd_inert<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::NFKD_INERT_V1)
}
...
/// ```
pub fn get_pattern_syntax<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::PATTERN_SYNTAX_V1)
}
...
/// ```
pub fn get_pattern_white_space<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::PATTERN_WHITE_SPACE_V1)
}

/// A small class of visible format controls, which precede and then span a sequence of
/// other characters, usually digits.
pub fn get_prepended_concatenation_mark<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::PREPENDED_CONCATENATION_MARK_V1)
}

/// Printable characters (visible characters and whitespace).
/// This is defined for POSIX compatibility.
pub fn get_print<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::PRINT_V1)
}
...
/// assert!(!quotation_mark.contains('<'));
/// ```
pub fn get_quotation_mark<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::QUOTATION_MARK_V1)
}
...
/// ```
pub fn get_radical<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::RADICAL_V1)
}
...
/// ```
pub fn get_regional_indicator<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::REGIONAL_INDICATOR_V1)
}
...
/// ```
pub fn get_soft_dotted<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::SOFT_DOTTED_V1)
}

/// Characters that are starters in terms of Unicode normalization and combining character
/// sequences
pub fn get_segment_starter<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::SEGMENT_STARTER_V1)
}

/// Characters that are either the source of a case mapping or in the target of a case
/// mapping
pub fn get_case_sensitive<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::CASE_SENSITIVE_V1)
}
...
/// ```
pub fn get_sentence_terminal<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::SENTENCE_TERMINAL_V1)
}
...
/// ```
pub fn get_terminal_punctuation<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::TERMINAL_PUNCTUATION_V1)
}
...
/// ```
pub fn get_unified_ideograph<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::UNIFIED_IDEOGRAPH_V1)
}
...
/// assert!(!uppercase.contains('u'));
/// ```
pub fn get_uppercase<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::UPPERCASE_V1)
}
...
/// ```
pub fn get_variation_selector<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::VARIATION_SELECTOR_V1)
}
...
/// ```
pub fn get_white_space<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::WHITE_SPACE_V1)
}

/// Hexadecimal digits
/// This is defined for POSIX compatibility.
pub fn get_xdigit<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::XDIGIT_V1)
}
...
/// ```
pub fn get_xid_continue<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::XID_CONTINUE_V1)
}
...
/// ```
pub fn get_xid_start<D>(provider: &D) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    get_codepointset(provider, key::XID_START_V1)
}
...
/// Return a [`CodePointSet`] for a particular value of the General_Category Unicode enumerated property. See [`GeneralCategory`].
///
/// [`CodePointSet`]: icu_codepointset::CodePointSet
pub fn get_for_general_category<D>(provider: &D, enum_val: GeneralCategory) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    ...
    get_codepointset(provider, key)
}

/// Return a [`CodePointSet`] for a particular value of the Script Unicode enumerated property. See [`Script`].
///
/// [`CodePointSet`]: icu_codepointset::CodePointSet
pub fn get_for_script<D>(provider: &D, enum_val: Script) -> CodePointSetResult
where
    D: DataProvider<UnicodePropertyV1Marker> + ?Sized,
{
    let key = match enum_val {
