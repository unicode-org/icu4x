...
const _: () = {
    ...
    make_provider!(Baked);
    impl_propnames_from_gcb_v1!(Baked);
    impl_propnames_from_bc_v1!(Baked);
    impl_propnames_from_ccc_v1!(Baked);
    impl_propnames_from_ea_v1!(Baked);
    impl_propnames_from_gc_v1!(Baked);
    impl_propnames_from_gcm_v1!(Baked);
    impl_propnames_from_hst_v1!(Baked);
    impl_propnames_from_insc_v1!(Baked);
    impl_propnames_from_jt_v1!(Baked);
    impl_propnames_from_lb_v1!(Baked);
    impl_propnames_from_sb_v1!(Baked);
    impl_propnames_from_sc_v1!(Baked);
    impl_propnames_from_wb_v1!(Baked);
    impl_propnames_to_long_linear_bc_v1!(Baked);
    impl_propnames_to_long_linear_ea_v1!(Baked);
    impl_propnames_to_long_linear_gc_v1!(Baked);
    impl_propnames_to_long_linear_gcb_v1!(Baked);
    impl_propnames_to_long_linear_hst_v1!(Baked);
    impl_propnames_to_long_linear_insc_v1!(Baked);
    impl_propnames_to_long_linear_jt_v1!(Baked);
    impl_propnames_to_long_linear_lb_v1!(Baked);
    impl_propnames_to_long_linear_sb_v1!(Baked);
    impl_propnames_to_long_linear_sc_v1!(Baked);
    impl_propnames_to_long_linear_wb_v1!(Baked);
    impl_propnames_to_long_sparse_ccc_v1!(Baked);
    impl_propnames_to_short_linear_bc_v1!(Baked);
    impl_propnames_to_short_linear_ea_v1!(Baked);
    impl_propnames_to_short_linear_gc_v1!(Baked);
    impl_propnames_to_short_linear_gcb_v1!(Baked);
    impl_propnames_to_short_linear_hst_v1!(Baked);
    impl_propnames_to_short_linear_insc_v1!(Baked);
    impl_propnames_to_short_linear_jt_v1!(Baked);
    impl_propnames_to_short_linear_lb_v1!(Baked);
    impl_propnames_to_short_linear_sb_v1!(Baked);
    impl_propnames_to_short_linear_wb_v1!(Baked);
    impl_propnames_to_short_linear4_sc_v1!(Baked);
    impl_propnames_to_short_sparse_ccc_v1!(Baked);
    impl_props_ahex_v1!(Baked);
    impl_props_alnum_v1!(Baked);
    impl_props_alpha_v1!(Baked);
    impl_props_basic_emoji_v1!(Baked);
    impl_props_bc_v1!(Baked);
    impl_props_bidi_c_v1!(Baked);
    impl_props_bidi_m_v1!(Baked);
    impl_props_bidiauxiliaryprops_v1!(Baked);
    impl_props_blank_v1!(Baked);
    impl_props_cased_v1!(Baked);
    impl_props_ccc_v1!(Baked);
    impl_props_ci_v1!(Baked);
    impl_props_comp_ex_v1!(Baked);
    impl_props_cwcf_v1!(Baked);
    impl_props_cwcm_v1!(Baked);
    impl_props_cwkcf_v1!(Baked);
    impl_props_cwl_v1!(Baked);
    impl_props_cwt_v1!(Baked);
    impl_props_cwu_v1!(Baked);
    impl_props_dash_v1!(Baked);
    impl_props_dep_v1!(Baked);
    impl_props_di_v1!(Baked);
    impl_props_dia_v1!(Baked);
    impl_props_ea_v1!(Baked);
    impl_props_ebase_v1!(Baked);
    impl_props_ecomp_v1!(Baked);
    impl_props_emod_v1!(Baked);
    impl_props_emoji_v1!(Baked);
    impl_props_epres_v1!(Baked);
    impl_props_exemplarchars_auxiliary_v1!(Baked);
    impl_props_exemplarchars_index_v1!(Baked);
    impl_props_exemplarchars_main_v1!(Baked);
    impl_props_exemplarchars_numbers_v1!(Baked);
    impl_props_exemplarchars_punctuation_v1!(Baked);
    impl_props_ext_v1!(Baked);
    impl_props_extpict_v1!(Baked);
    impl_props_gc_v1!(Baked);
    impl_props_gcb_v1!(Baked);
    impl_props_gr_base_v1!(Baked);
    impl_props_gr_ext_v1!(Baked);
    impl_props_gr_link_v1!(Baked);
    impl_props_graph_v1!(Baked);
    impl_props_hex_v1!(Baked);
    impl_props_hst_v1!(Baked);
    impl_props_hyphen_v1!(Baked);
    impl_props_idc_v1!(Baked);
    impl_props_ideo_v1!(Baked);
    impl_props_ids_v1!(Baked);
    impl_props_idsb_v1!(Baked);
    impl_props_idst_v1!(Baked);
    impl_props_insc_v1!(Baked);
    impl_props_join_c_v1!(Baked);
    impl_props_jt_v1!(Baked);
    impl_props_lb_v1!(Baked);
    impl_props_loe_v1!(Baked);
    impl_props_lower_v1!(Baked);
    impl_props_math_v1!(Baked);
    impl_props_nchar_v1!(Baked);
    impl_props_nfcinert_v1!(Baked);
    impl_props_nfdinert_v1!(Baked);
    impl_props_nfkcinert_v1!(Baked);
    impl_props_nfkdinert_v1!(Baked);
    impl_props_pat_syn_v1!(Baked);
    impl_props_pat_ws_v1!(Baked);
    impl_props_pcm_v1!(Baked);
    impl_props_print_v1!(Baked);
    impl_props_qmark_v1!(Baked);
    impl_props_radical_v1!(Baked);
    impl_props_ri_v1!(Baked);
    impl_props_sb_v1!(Baked);
    impl_props_sc_v1!(Baked);
    impl_props_scx_v1!(Baked);
    impl_props_sd_v1!(Baked);
    impl_props_segstart_v1!(Baked);
    impl_props_sensitive_v1!(Baked);
    impl_props_sterm_v1!(Baked);
    impl_props_term_v1!(Baked);
    impl_props_uideo_v1!(Baked);
    impl_props_upper_v1!(Baked);
    impl_props_vs_v1!(Baked);
    impl_props_wb_v1!(Baked);
    impl_props_wspace_v1!(Baked);
    impl_props_xdigit_v1!(Baked);
    impl_props_xidc_v1!(Baked);
    impl_props_xids_v1!(Baked);
};
