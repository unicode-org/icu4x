...
#[inline]
pub(crate) fn is_tz_name_separator(ch: char) -> bool {
    ch == '/'
}
...
#[inline]
pub(crate) fn is_time_separator(ch: char) -> bool {
    ch == ':'
}

/// Checks if char is a `TimeDesignator`.
#[inline]
pub(crate) fn is_time_designator(ch: char) -> bool {
    ch == 'T' || ch == 't'
}
...
pub(crate) fn is_duration_designator(ch: char) -> bool {
    ch == 'P' || ch == 'p'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_year_designator(ch: char) -> bool {
    ch == 'Y' || ch == 'y'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_month_designator(ch: char) -> bool {
    ch == 'M' || ch == 'm'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_week_designator(ch: char) -> bool {
    ch == 'W' || ch == 'w'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_day_designator(ch: char) -> bool {
    ch == 'D' || ch == 'd'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_hour_designator(ch: char) -> bool {
    ch == 'H' || ch == 'h'
}
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_minute_designator(ch: char) -> bool {
...
#[inline]
#[cfg(feature = "duration")]
pub(crate) fn is_second_designator(ch: char) -> bool {
    ch == 'S' || ch == 's'
}
...
#[inline]
pub(crate) fn is_annotation_open(ch: char) -> bool {
    ch == '['
}

/// Checks if char is an `AnnotationClose`.
#[inline]
pub(crate) fn is_annotation_close(ch: char) -> bool {
    ch == ']'
}

/// Checks if char is an `CriticalFlag`.
#[inline]
pub(crate) fn is_critical_flag(ch: char) -> bool {
    ch == '!'
}

/// Checks if char is the `AnnotationKeyValueSeparator`.
#[inline]
pub(crate) fn is_annotation_key_value_separator(ch: char) -> bool {
    ch == '='
}
