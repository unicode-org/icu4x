...
impl databake::Bake for CodePointInversionList<'_> {
    fn bake(&self, env: &databake::CrateEnv) -> databake::TokenStream {
        ...
        databake::quote! { unsafe {
            #[allow(unused_unsafe)]
            ::icu_uniset::CodePointInversionList::from_parts_unchecked(#inv_list, #size)
        }}
    }
}
...
impl<'data> CodePointInversionList<'data> {
    ...
    /// assert_eq!(CodePointInversionList::all().get_inversion_list(), expected);
    /// assert_eq!(
    ...
    /// assert_eq!(CodePointInversionList::bmp().get_inversion_list(), expected);
    /// assert_eq!(
...
mod tests {
    ...
    fn databake() {
        databake::test_bake!(
            ...
            const: unsafe {
                #[allow(unused_unsafe)]
                crate::CodePointInversionList::from_parts_unchecked(
                    unsafe {
