...
impl databake::Bake for CodePointSet<'_> {
    fn bake(&self, env: &databake::CrateEnv) -> databake::TokenStream {
        ...
        databake::quote! { unsafe {
            #[allow(unused_unsafe)]
            ::icu_uniset::CodePointSet::from_parts_unchecked(#inv_list, #size)
        }}
    }
}
...
impl<'data> CodePointSet<'data> {
    ...
    /// use icu_uniset::CodePointSetError;
    /// use zerovec::ZeroVec;
    ...
    ///     CodePointSet::clone_from_inversion_list_slice(inv_list).unwrap()
    /// }
    ///
    ...
    /// let codepointsets: Vec<CodePointSet> = inv_lists
    ///     .iter()
...
mod tests {
    ...
    fn test_serde_serialize() {
        ...
        let uniset = CodePointSet::from_inversion_list_slice(&inv_list).unwrap();
    ...
    fn test_serde_deserialize() {
        ...
        let exp_uniset = CodePointSet::from_inversion_list_slice(&exp_inv_list).unwrap();
        let act_uniset: CodePointSet = serde_json::from_str(inv_list_str).unwrap();
    ...
    fn databake() {
        databake::test_bake!(
            ...
            const: unsafe {
                #[allow(unused_unsafe)]
                crate::CodePointSet::from_parts_unchecked(
                    unsafe {
