...
include!("day_period_rules_design2_v1.rs.data");
...
include!("day_period_rules_design3_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_day_period_rules_design2_v1!($provider);
        ...
        impl_day_period_rules_design3_v1!($provider);
