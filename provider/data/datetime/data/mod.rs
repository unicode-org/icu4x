// @generated
include!("hijri_year_names_v1.rs.data");
...
include!("hijri_date_neo_skeleton_patterns_v1.rs.data");
...
include!("hijri_month_names_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_hijri_year_names_v1!($provider);
        ...
        impl_hijri_date_neo_skeleton_patterns_v1!($provider);
        ...
        impl_hijri_month_names_v1!($provider);
