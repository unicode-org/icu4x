...
include!("datetime_names_year_japanese_extended_v1.rs.data");
include!("datetime_names_year_roc_v1.rs.data");
include!("datetime_patterns_date_japanese_extended_v1.rs.data");
...
include!("datetime_patterns_date_japanese_modern_v1.rs.data");
include!("datetime_names_month_japanese_extended_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_datetime_names_year_japanese_extended_v1!($provider);
        impl_datetime_names_year_roc_v1!($provider);
        impl_datetime_patterns_date_japanese_extended_v1!($provider);
        ...
        impl_datetime_patterns_date_japanese_modern_v1!($provider);
        impl_datetime_names_month_japanese_extended_v1!($provider);
