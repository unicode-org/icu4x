...
include!("currency_essentials_core_v1.rs.data");
...
include!("currency_essentials_regional_v1.rs.data");
include!("currency_essentials_complete_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_currency_essentials_core_v1!($provider);
        ...
        impl_currency_essentials_regional_v1!($provider);
        impl_currency_essentials_complete_v1!($provider);
