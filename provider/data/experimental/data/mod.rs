...
include!("units_name_length_v1.rs.data");
...
include!("units_name_volume_v1.rs.data");
...
include!("units_name_mass_v1.rs.data");
include!("units_name_duration_v1.rs.data");
...
include!("units_name_area_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_units_name_length_v1!($provider);
        ...
        impl_units_name_volume_v1!($provider);
        ...
        impl_units_name_mass_v1!($provider);
        impl_units_name_duration_v1!($provider);
        ...
        impl_units_name_area_v1!($provider);
