...
include!("locale_names_script_medium_v1.rs.data");
...
include!("locale_names_language_medium_v1.rs.data");
include!("language_display_names_v1.rs.data");
include!("locale_names_region_medium_v1.rs.data");
...
include!("locale_names_variant_medium_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_locale_names_script_medium_v1!($provider);
        ...
        impl_locale_names_language_medium_v1!($provider);
        impl_language_display_names_v1!($provider);
        impl_locale_names_region_medium_v1!($provider);
        ...
        impl_locale_names_variant_medium_v1!($provider);
