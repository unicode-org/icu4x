...
include!("units_name_volume_core_v1.rs.data");
...
include!("units_name_area_outlier_v1.rs.data");
...
include!("units_name_area_extended_v1.rs.data");
...
include!("units_name_area_core_v1.rs.data");
include!("units_name_duration_outlier_v1.rs.data");
...
include!("units_name_duration_core_v1.rs.data");
...
include!("units_name_duration_extended_v1.rs.data");
include!("units_name_volume_outlier_v1.rs.data");
include!("script_display_names_v1.rs.data");
include!("units_name_volume_extended_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_units_name_volume_core_v1!($provider);
        ...
        impl_units_name_area_outlier_v1!($provider);
        ...
        impl_units_name_area_extended_v1!($provider);
        ...
        impl_units_name_area_core_v1!($provider);
        impl_units_name_duration_outlier_v1!($provider);
        ...
        impl_units_name_duration_core_v1!($provider);
        ...
        impl_units_name_duration_extended_v1!($provider);
        impl_units_name_volume_outlier_v1!($provider);
        impl_script_display_names_v1!($provider);
        impl_units_name_volume_extended_v1!($provider);
