...
include!("long_week_relative_time_format_data_v1.rs.data");
include!("narrow_minute_relative_time_format_data_v1.rs.data");
...
include!("narrow_week_relative_time_format_data_v1.rs.data");
include!("short_second_relative_time_format_data_v1.rs.data");
include!("long_month_relative_time_format_data_v1.rs.data");
include!("short_year_relative_time_format_data_v1.rs.data");
include!("currency_essentials_v1.rs.data");
include!("short_week_relative_time_format_data_v1.rs.data");
include!("narrow_second_relative_time_format_data_v1.rs.data");
include!("short_quarter_relative_time_format_data_v1.rs.data");
include!("narrow_hour_relative_time_format_data_v1.rs.data");
include!("short_minute_relative_time_format_data_v1.rs.data");
include!("narrow_quarter_relative_time_format_data_v1.rs.data");
include!("long_minute_relative_time_format_data_v1.rs.data");
include!("region_display_names_v1.rs.data");
include!("units_trie_v1.rs.data");
include!("language_display_names_v1.rs.data");
include!("long_quarter_relative_time_format_data_v1.rs.data");
include!("short_day_relative_time_format_data_v1.rs.data");
include!("narrow_day_relative_time_format_data_v1.rs.data");
include!("units_essentials_v1.rs.data");
include!("percent_essentials_v1.rs.data");
include!("variant_display_names_v1.rs.data");
include!("short_month_relative_time_format_data_v1.rs.data");
include!("person_names_format_v1.rs.data");
include!("long_day_relative_time_format_data_v1.rs.data");
include!("units_info_v1.rs.data");
include!("short_hour_relative_time_format_data_v1.rs.data");
include!("long_year_relative_time_format_data_v1.rs.data");
include!("long_second_relative_time_format_data_v1.rs.data");
include!("long_hour_relative_time_format_data_v1.rs.data");
...
include!("narrow_year_relative_time_format_data_v1.rs.data");
include!("currency_extended_data_v1.rs.data");
include!("units_display_name_v1.rs.data");
include!("narrow_month_relative_time_format_data_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_long_week_relative_time_format_data_v1!($provider);
        impl_narrow_minute_relative_time_format_data_v1!($provider);
        ...
        impl_narrow_week_relative_time_format_data_v1!($provider);
        impl_short_second_relative_time_format_data_v1!($provider);
        impl_long_month_relative_time_format_data_v1!($provider);
        impl_short_year_relative_time_format_data_v1!($provider);
        impl_currency_essentials_v1!($provider);
        impl_short_week_relative_time_format_data_v1!($provider);
        impl_narrow_second_relative_time_format_data_v1!($provider);
        impl_short_quarter_relative_time_format_data_v1!($provider);
        impl_narrow_hour_relative_time_format_data_v1!($provider);
        impl_short_minute_relative_time_format_data_v1!($provider);
        impl_narrow_quarter_relative_time_format_data_v1!($provider);
        impl_long_minute_relative_time_format_data_v1!($provider);
        impl_region_display_names_v1!($provider);
        impl_units_trie_v1!($provider);
        impl_language_display_names_v1!($provider);
        impl_long_quarter_relative_time_format_data_v1!($provider);
        impl_short_day_relative_time_format_data_v1!($provider);
        impl_narrow_day_relative_time_format_data_v1!($provider);
        impl_units_essentials_v1!($provider);
        impl_percent_essentials_v1!($provider);
        impl_variant_display_names_v1!($provider);
        impl_short_month_relative_time_format_data_v1!($provider);
        impl_person_names_format_v1!($provider);
        impl_long_day_relative_time_format_data_v1!($provider);
        impl_units_info_v1!($provider);
        impl_short_hour_relative_time_format_data_v1!($provider);
        impl_long_year_relative_time_format_data_v1!($provider);
        impl_long_second_relative_time_format_data_v1!($provider);
        impl_long_hour_relative_time_format_data_v1!($provider);
        ...
        impl_narrow_year_relative_time_format_data_v1!($provider);
        impl_currency_extended_data_v1!($provider);
        impl_units_display_name_v1!($provider);
        impl_narrow_month_relative_time_format_data_v1!($provider);
