...
include!("locale_names_region_minimal_short_v1.rs.data");
include!("locale_names_script_extended_medium_v1.rs.data");
...
include!("locale_names_script_minimal_medium_v1.rs.data");
include!("locale_names_language_menu_extended_medium_v1.rs.data");
include!("currency_extended_data_v1.rs.data");
include!("locale_names_language_minimal_medium_v1.rs.data");
include!("units_names_volume_extended_v1.rs.data");
include!("locale_names_language_extended_medium_v1.rs.data");
include!("narrow_hour_relative_v1.rs.data");
include!("locale_names_region_core_medium_v1.rs.data");
...
include!("locale_names_script_core_medium_v1.rs.data");
include!("unit_ids_v1.rs.data");
include!("locale_names_region_minimal_medium_v1.rs.data");
...
include!("locale_names_region_core_short_v1.rs.data");
include!("language_display_names_v1.rs.data");
include!("locale_names_language_menu_core_medium_v1.rs.data");
...
include!("locale_names_script_extended_short_v1.rs.data");
...
include!("locale_names_region_extended_short_v1.rs.data");
...
include!("locale_names_language_core_medium_v1.rs.data");
include!("locale_names_language_extended_long_v1.rs.data");
include!("locale_names_language_core_short_v1.rs.data");
...
include!("locale_names_variant_extended_medium_v1.rs.data");
include!("locale_names_language_core_long_v1.rs.data");
include!("units_names_duration_core_v1.rs.data");
include!("currency_fractions_v1.rs.data");
include!("units_info_v1.rs.data");
include!("locale_names_language_extended_short_v1.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_locale_names_region_minimal_short_v1!($provider);
        impl_locale_names_script_extended_medium_v1!($provider);
        ...
        impl_locale_names_script_minimal_medium_v1!($provider);
        impl_locale_names_language_menu_extended_medium_v1!($provider);
        impl_currency_extended_data_v1!($provider);
        impl_locale_names_language_minimal_medium_v1!($provider);
        impl_units_names_volume_extended_v1!($provider);
        impl_locale_names_language_extended_medium_v1!($provider);
        impl_narrow_hour_relative_v1!($provider);
        impl_locale_names_region_core_medium_v1!($provider);
        ...
        impl_locale_names_script_core_medium_v1!($provider);
        impl_unit_ids_v1!($provider);
        impl_locale_names_region_minimal_medium_v1!($provider);
        ...
        impl_locale_names_region_core_short_v1!($provider);
        impl_language_display_names_v1!($provider);
        impl_locale_names_language_menu_core_medium_v1!($provider);
        ...
        impl_locale_names_script_extended_short_v1!($provider);
        ...
        impl_locale_names_region_extended_short_v1!($provider);
        impl_long_hour_relative_v1!($provider);
        impl_units_names_length_outlier_v1!($provider);
        impl_short_second_relative_v1!($provider);
        impl_locale_names_language_core_medium_v1!($provider);
        impl_locale_names_language_extended_long_v1!($provider);
        impl_locale_names_language_core_short_v1!($provider);
        ...
        impl_locale_names_variant_extended_medium_v1!($provider);
        impl_locale_names_language_core_long_v1!($provider);
        impl_units_names_duration_core_v1!($provider);
        impl_currency_fractions_v1!($provider);
        impl_units_info_v1!($provider);
        impl_locale_names_language_extended_short_v1!($provider);
