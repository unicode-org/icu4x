...
include!("canonical_decomposition_data_v2_marker.rs.data");
include!("canonical_decomposition_tables_v1_marker.rs.data");
include!("compatibility_decomposition_data_v2_marker.rs.data");
include!("compatibility_decomposition_tables_v1_marker.rs.data");
include!("uts46_decomposition_data_v2_marker.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_canonical_decomposition_data_v2_marker!($provider);
        impl_canonical_decomposition_tables_v1_marker!($provider);
        impl_compatibility_decomposition_data_v2_marker!($provider);
        impl_compatibility_decomposition_tables_v1_marker!($provider);
        impl_uts46_decomposition_data_v2_marker!($provider);
    };
}
#[allow(unused_macros)]
        ...
        impl icu_provider::any::AnyProvider for $provider {
            fn load_any(&self, marker: icu_provider::DataMarkerInfo, req: icu_provider::DataRequest) -> Result<icu_provider::AnyResponse, icu_provider::DataError> {
                match marker.path.hashed() {
                    ...
                    h if h == <icu::normalizer::provider::CanonicalDecompositionDataV2Marker as icu_provider::DataMarker>::INFO.path.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::CanonicalDecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
                    ...
                    h if h == <icu::normalizer::provider::CompatibilityDecompositionDataV2Marker as icu_provider::DataMarker>::INFO.path.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::CompatibilityDecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
                    ...
                    h if h == <icu::normalizer::provider::Uts46DecompositionDataV2Marker as icu_provider::DataMarker>::INFO.path.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::Uts46DecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
