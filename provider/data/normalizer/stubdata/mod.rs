        ...
        impl icu_provider::any::AnyProvider for $provider {
            fn load_any(&self, marker: icu_provider::DataMarkerInfo, req: icu_provider::DataRequest) -> Result<icu_provider::AnyResponse, icu_provider::DataError> {
                match marker.id.hashed() {
                    h if h == <icu::normalizer::provider::Uts46DecompositionDataV2Marker as icu_provider::DataMarker>::INFO.id.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::Uts46DecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
                    ...
                    h if h == <icu::normalizer::provider::CanonicalDecompositionDataV2Marker as icu_provider::DataMarker>::INFO.id.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::CanonicalDecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
                    h if h == <icu::normalizer::provider::CompatibilityDecompositionDataV2Marker as icu_provider::DataMarker>::INFO.id.hashed() => icu_provider::DataProvider::<icu::normalizer::provider::CompatibilityDecompositionDataV2Marker>::load(self, req).map(icu_provider::DataResponse::wrap_into_any_response),
