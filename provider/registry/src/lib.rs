...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameAreaV1: UnitsNameAreaV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameDurationV1: UnitsNameDurationV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameLengthV1: UnitsNameLengthV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameMassV1: UnitsNameMassV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameVolumeV1: UnitsNameVolumeV1,
