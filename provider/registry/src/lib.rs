...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::units::categorized_display_name::AreaDisplayNameV1: AreaDisplayNameV1,
            icu::experimental::dimension::provider::units::categorized_display_name::DurationDisplayNameV1: DurationDisplayNameV1,
            icu::experimental::dimension::provider::units::categorized_display_name::LengthDisplayNameV1: LengthDisplayNameV1,
            icu::experimental::dimension::provider::units::categorized_display_name::MassDisplayNameV1: MassDisplayNameV1,
            icu::experimental::dimension::provider::units::categorized_display_name::VolumeDisplayNameV1: VolumeDisplayNameV1,
