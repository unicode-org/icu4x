...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::displaynames::provider::LocaleNamesRegionMediumTinyV1: LocaleNamesRegionMediumTinyV1,
            icu::experimental::displaynames::provider::LocaleNamesRegionMediumLightV1: LocaleNamesRegionMediumLightV1,
            icu::experimental::displaynames::provider::LocaleNamesRegionShortTinyV1: LocaleNamesRegionShortTinyV1,
            icu::experimental::displaynames::provider::LocaleNamesRegionShortLightV1: LocaleNamesRegionShortLightV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMediumTinyV1: LocaleNamesLanguageMediumTinyV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMediumLightV1: LocaleNamesLanguageMediumLightV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMediumHeavyV1: LocaleNamesLanguageMediumHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageShortLightV1: LocaleNamesLanguageShortLightV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageShortHeavyV1: LocaleNamesLanguageShortHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageLongLightV1: LocaleNamesLanguageLongLightV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageLongHeavyV1: LocaleNamesLanguageLongHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMenuMediumLightV1: LocaleNamesLanguageMenuMediumLightV1,
            icu::experimental::displaynames::provider::LocaleNamesLanguageMenuMediumHeavyV1: LocaleNamesLanguageMenuMediumHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptMediumTinyV1: LocaleNamesScriptMediumTinyV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptMediumLightV1: LocaleNamesScriptMediumLightV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptMediumHeavyV1: LocaleNamesScriptMediumHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesScriptShortHeavyV1: LocaleNamesScriptShortHeavyV1,
            icu::experimental::displaynames::provider::LocaleNamesVariantMediumHeavyV1: LocaleNamesVariantMediumHeavyV1,
