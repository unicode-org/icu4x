...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::properties::provider::PropertyNameParseBidiClassV2: PropertyNameParseBidiClassV2,
            icu::properties::provider::PropertyNameParseCanonicalCombiningClassV2: PropertyNameParseCanonicalCombiningClassV2,
            icu::properties::provider::PropertyNameParseEastAsianWidthV2: PropertyNameParseEastAsianWidthV2,
            icu::properties::provider::PropertyNameParseGeneralCategoryMaskV2: PropertyNameParseGeneralCategoryMaskV2,
            icu::properties::provider::PropertyNameParseGeneralCategoryV2: PropertyNameParseGeneralCategoryV2,
            icu::properties::provider::PropertyNameParseGraphemeClusterBreakV2: PropertyNameParseGraphemeClusterBreakV2,
            icu::properties::provider::PropertyNameParseHangulSyllableTypeV2: PropertyNameParseHangulSyllableTypeV2,
            icu::properties::provider::PropertyNameParseIndicSyllabicCategoryV2: PropertyNameParseIndicSyllabicCategoryV2,
            icu::properties::provider::PropertyNameParseJoiningTypeV2: PropertyNameParseJoiningTypeV2,
            icu::properties::provider::PropertyNameParseLineBreakV2: PropertyNameParseLineBreakV2,
            icu::properties::provider::PropertyNameParseScriptV2: PropertyNameParseScriptV2,
            icu::properties::provider::PropertyNameParseSentenceBreakV2: PropertyNameParseSentenceBreakV2,
            icu::properties::provider::PropertyNameParseWordBreakV2: PropertyNameParseWordBreakV2,
