...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::units::display_names::UnitsDisplayNameV1: UnitsDisplayNameV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesAreaCoreV1: UnitsNamesAreaCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesAreaExtendedV1: UnitsNamesAreaExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesAreaOutlierV1: UnitsNamesAreaOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesDurationCoreV1: UnitsNamesDurationCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesDurationExtendedV1: UnitsNamesDurationExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesDurationOutlierV1: UnitsNamesDurationOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesLengthCoreV1: UnitsNamesLengthCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesLengthExtendedV1: UnitsNamesLengthExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesLengthOutlierV1: UnitsNamesLengthOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesMassCoreV1: UnitsNamesMassCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesMassExtendedV1: UnitsNamesMassExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesMassOutlierV1: UnitsNamesMassOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesVolumeCoreV1: UnitsNamesVolumeCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesVolumeExtendedV1: UnitsNamesVolumeExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNamesVolumeOutlierV1: UnitsNamesVolumeOutlierV1,
