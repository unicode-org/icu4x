...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameAreaCoreV1: UnitsNameAreaCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameAreaExtendedV1: UnitsNameAreaExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameAreaOutlierV1: UnitsNameAreaOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameDurationCoreV1: UnitsNameDurationCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameDurationExtendedV1: UnitsNameDurationExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameDurationOutlierV1: UnitsNameDurationOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameLengthCoreV1: UnitsNameLengthCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameLengthExtendedV1: UnitsNameLengthExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameLengthOutlierV1: UnitsNameLengthOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameMassCoreV1: UnitsNameMassCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameMassExtendedV1: UnitsNameMassExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameMassOutlierV1: UnitsNameMassOutlierV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameVolumeCoreV1: UnitsNameVolumeCoreV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameVolumeExtendedV1: UnitsNameVolumeExtendedV1,
            icu::experimental::dimension::provider::units::categorized_display_name::UnitsNameVolumeOutlierV1: UnitsNameVolumeOutlierV1,
