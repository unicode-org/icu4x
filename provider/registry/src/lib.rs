...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::time::provider::TimezoneVariantsOffsetsV1: TimezoneVariantsOffsetsV1,
            ...
            icu::experimental::dimension::provider::currency::essential::CurrencyEssentialsV1: CurrencyEssentialsV1,
