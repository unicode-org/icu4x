...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::datetime::provider::time_zones::LocationsRootV1Marker = "time_zone/locations_root@1",
            icu::datetime::provider::time_zones::ExemplarCitiesV1Marker = "time_zone/exemplars@1",
            icu::datetime::provider::time_zones::ExemplarCitiesRootV1Marker = "time_zone/exemplars_root@1",
