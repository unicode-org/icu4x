...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::currency::essentials::CurrencyEssentialsRegionalV1: CurrencyEssentialsRegionalV1,
            icu::experimental::dimension::provider::currency::essentials::CurrencyEssentialsCoreV1: CurrencyEssentialsCoreV1,
            icu::experimental::dimension::provider::currency::essentials::CurrencyEssentialsCompleteV1: CurrencyEssentialsCompleteV1,
            ...
            icu::experimental::dimension::provider::currency::extended::CurrencyExtendedDataV1: CurrencyExtendedDataV1,
            icu::experimental::dimension::provider::currency::extended::CurrencyExtendedDataV1: CurrencyExtendedDataV1,
            icu::experimental::dimension::provider::currency::extended::CurrencyExtendedDataRegionalV1: CurrencyExtendedDataRegionalV1,
            icu::experimental::dimension::provider::currency::extended::CurrencyExtendedDataCoreV1: CurrencyExtendedDataCoreV1,
            icu::experimental::dimension::provider::currency::extended::CurrencyExtendedDataCompleteV1: CurrencyExtendedDataCompleteV1,
