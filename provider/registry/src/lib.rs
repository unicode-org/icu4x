...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::timezone::provider::ZoneOffsetPeriodV1: ZoneOffsetPeriodV1,
            icu::decimal::provider::DecimalDigitsV1: DecimalDigitsV1,
            icu::decimal::provider::DecimalSymbolsV2: DecimalSymbolsV2,
            icu::list::provider::AndListV2: AndListV2,
            icu::list::provider::OrListV2: OrListV2,
            icu::list::provider::UnitListV2: UnitListV2,
            ...
            icu::timezone::provider::names::Bcp47ToIanaMapV1: Bcp47ToIanaMapV1,
            icu::timezone::provider::names::IanaToBcp47MapV3: IanaToBcp47MapV3,
            icu::timezone::provider::windows::WindowsZonesToBcp47MapV1: WindowsZonesToBcp47MapV1,
