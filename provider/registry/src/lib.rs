...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::provider::units::categorized_display_name::ExtendedUnitsNameLengthV1: ExtendedUnitsNameLengthV1,
            icu::experimental::dimension::provider::units::categorized_display_name::OutlierUnitsNameLengthV1: OutlierUnitsNameLengthV1,
            icu::experimental::dimension::provider::units::categorized_display_name::CoreUnitsNameMassV1: CoreUnitsNameMassV1,
            icu::experimental::dimension::provider::units::categorized_display_name::ExtendedUnitsNameMassV1: ExtendedUnitsNameMassV1,
            icu::experimental::dimension::provider::units::categorized_display_name::OutlierUnitsNameMassV1: OutlierUnitsNameMassV1,
