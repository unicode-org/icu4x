    ...
    ($ provider : ty) => {
        ...
        impl icu_provider::DataProvider<icu::plurals::provider::PluralRangesV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu::plurals::provider::PluralRangesV1Marker>, icu_provider::DataError> {
                ...
                static VALUES: [&<icu::plurals::provider::PluralRangesV1Marker as icu_provider::DataMarker>::Yokeable; 85usize] = [&AF, &AM, &AR, &AM, &AM, &AM, &AF, &AM, &AM, &AF, &AM, &AM, &AM, &AM, &AM, &AF, &AF, &AF, &AF, &FA, &AF, &AM, &AM, &AM, &AM, &AM, &HE, &AM, &AM, &AM, &AM, &AF, &AM, &AM, &AM, &AM, &KA, &AM, &AM, &AM, &AM, &AM, &AM, &AM, &AM, &LV, &MK, &AM, &AM, &AM, &AM, &AM, &AM, &AM, &AF, &FA, &AM, &AF, &AM, &AM, &AM, &RO, &AM, &AM, &FA, &AF, &AM, &SL, &AM, &AM, &AF, &AM, &AM, &AM, &AM, &AM, &AM, &AM, &AM, &AF, &AM, &AM, &AM, &AM, &AM];
                static KEYS: [&str; 85usize] = ["af", "am", "ar", "as", "az", "be", "bg", "bn", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu", "fa", "fi", "fil", "fr", "ga", "gl", "gu", "he", "hi", "hr", "hu", "hy", "ia", "id", "is", "it", "ja", "ka", "kk", "km", "kn", "ko", "ky", "lij", "lo", "lt", "lv", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "no", "or", "pa", "pcm", "pl", "ps", "pt", "ro", "ru", "sc", "sd", "si", "sk", "sl", "sq", "sr", "sv", "sw", "ta", "te", "th", "tk", "tr", "ug", "uk", "ur", "uz", "vi", "yue", "zh", "zu"];
