...
#[doc(hidden)]
#[macro_export]
macro_rules! __singleton_locid_transform_likelysubtags_v1 {
    () => {
        icu_locid_transform::provider::LikelySubtagsV1 {
...
#[doc(hidden)]
#[macro_export]
macro_rules! __lookup_locid_transform_likelysubtags_v1 {
    ($ locale : expr) => {{
        static SINGLETON: <icu_locid_transform::provider::LikelySubtagsV1Marker as icu_provider::DataMarker>::Yokeable = singleton_locid_transform_likelysubtags_v1!();
        if $locale.is_empty() {
            Ok(&SINGLETON)
        } else {
    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_locid_transform::provider::LikelySubtagsV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_locid_transform::provider::LikelySubtagsV1Marker>, icu_provider::DataError> {
                match lookup_locid_transform_likelysubtags_v1!(req.locale) {
                    ...
                    Err(e) => Err(e.with_req(<icu_locid_transform::provider::LikelySubtagsV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
