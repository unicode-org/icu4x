...
macro_rules! __impl_locid_transform_likelysubtags_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            ...
            #[doc(hidden)]
            pub fn lookup_locid_transform_likelysubtags_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_locid_transform::provider::LikelySubtagsV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
                if locale.is_empty() {
                    Ok(Self::SINGLETON_LOCID_TRANSFORM_LIKELYSUBTAGS_V1)
                } else {
        ...
        impl icu_provider::DataProvider<icu_locid_transform::provider::LikelySubtagsV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_locid_transform::provider::LikelySubtagsV1Marker>, icu_provider::DataError> {
                match Self::lookup_locid_transform_likelysubtags_v1(&req.locale) {
