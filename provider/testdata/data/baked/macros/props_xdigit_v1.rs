...
#[doc(hidden)]
#[macro_export]
macro_rules! __singleton_props_xdigit_v1 {
    () => {
...
#[doc(hidden)]
#[macro_export]
macro_rules! __lookup_props_xdigit_v1 {
    ($ req : expr) => {
