...
macro_rules! __impl_props_idsb_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            ...
            #[doc(hidden)]
            pub fn lookup_props_idsb_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_properties::provider::IdsBinaryOperatorV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
                if locale.is_empty() {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::IdsBinaryOperatorV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::IdsBinaryOperatorV1Marker>, icu_provider::DataError> {
                match Self::lookup_props_idsb_v1(&req.locale) {
