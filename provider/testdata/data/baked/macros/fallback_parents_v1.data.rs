// @generated
/// Implement [`DataProvider<LocaleFallbackParentsV1Marker>`](icu_provider::DataProvider) on the given struct using the data
...
macro_rules! __impl_fallback_parents_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_FALLBACK_PARENTS_V1: &'static <icu_provider_adapters::fallback::provider::LocaleFallbackParentsV1Marker as icu_provider::DataMarker>::Yokeable = &icu_provider_adapters::fallback::provider::LocaleFallbackParentsV1 {
                parents: unsafe {
                    #[allow(unused_unsafe)]
        ...
        #[clippy::msrv = "1.61"]
        impl icu_provider::DataProvider<icu_provider_adapters::fallback::provider::LocaleFallbackParentsV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_provider_adapters::fallback::provider::LocaleFallbackParentsV1Marker>, icu_provider::DataError> {
                ...
                match {
                    ...
                    Err(e) => Err(e.with_req(<icu_provider_adapters::fallback::provider::LocaleFallbackParentsV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
