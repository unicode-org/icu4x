...
macro_rules! __impl_time_zone_specific_short_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub fn lookup_time_zone_specific_short_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_datetime::provider::time_zones::MetazoneSpecificNamesShortV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
        ...
        impl icu_provider::DataProvider<icu_datetime::provider::time_zones::MetazoneSpecificNamesShortV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_datetime::provider::time_zones::MetazoneSpecificNamesShortV1Marker>, icu_provider::DataError> {
                match Self::lookup_time_zone_specific_short_v1(&req.locale) {
                    ...
                    Err(e) => Err(e.with_req(<icu_datetime::provider::time_zones::MetazoneSpecificNamesShortV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
