...
macro_rules! __impl_propnames_from_lb_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_PROPNAMES_FROM_LB_V1: &<icu_properties::provider::LineBreakNameToValueV1Marker as icu_provider::DataMarker>::Yokeable = &icu_properties::provider::names::PropertyValueNameToEnumMapV1 {
                map: unsafe {
                    #[allow(unused_unsafe)]
            ...
            #[doc(hidden)]
            pub fn lookup_propnames_from_lb_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_properties::provider::LineBreakNameToValueV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
                if locale.is_empty() {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::LineBreakNameToValueV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::LineBreakNameToValueV1Marker>, icu_provider::DataError> {
                match Self::lookup_propnames_from_lb_v1(&req.locale) {
