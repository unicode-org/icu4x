// @generated
/// Implement [`DataProvider<SegmentStarterV1Marker>`](icu_provider::DataProvider) on the given struct using the data
    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::SegmentStarterV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::SegmentStarterV1Marker>, icu_provider::DataError> {
                match Self::lookup_props_segstart_v1(&req.locale) {
                    ...
                    Err(e) => Err(e.with_req(<icu_properties::provider::SegmentStarterV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
