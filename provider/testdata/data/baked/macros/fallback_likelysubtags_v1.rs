...
macro_rules! __impl_fallback_likelysubtags_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_FALLBACK_LIKELYSUBTAGS_V1: &<icu_provider_adapters::fallback::provider::LocaleFallbackLikelySubtagsV1Marker as icu_provider::DataMarker>::Yokeable = &icu_provider_adapters::fallback::provider::LocaleFallbackLikelySubtagsV1 {
                l2s: unsafe {
                    #[allow(unused_unsafe)]
