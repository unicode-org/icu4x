...
macro_rules! __impl_datetime_coptic_datesymbols_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub fn lookup_datetime_coptic_datesymbols_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_datetime::provider::calendar::CopticDateSymbolsV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
        ...
        impl icu_provider::DataProvider<icu_datetime::provider::calendar::CopticDateSymbolsV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_datetime::provider::calendar::CopticDateSymbolsV1Marker>, icu_provider::DataError> {
                match Self::lookup_datetime_coptic_datesymbols_v1(&req.locale) {
