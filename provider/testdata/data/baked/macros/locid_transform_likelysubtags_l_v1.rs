...
#[doc(hidden)]
#[macro_export]
macro_rules! __singleton_locid_transform_likelysubtags_l_v1 {
    () => {
        icu_locid_transform::provider::LikelySubtagsForLanguageV1 {
        ...
        impl icu_provider::DataProvider<icu_locid_transform::provider::LikelySubtagsForLanguageV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_locid_transform::provider::LikelySubtagsForLanguageV1Marker>, icu_provider::DataError> {
                req.locale
                    ...
                    .ok_or_else(|| icu_provider::DataErrorKind::MissingLocale.with_req(<icu_locid_transform::provider::LikelySubtagsForLanguageV1Marker as icu_provider::KeyedDataMarker>::KEY, req))
            }
        }
    };
}
