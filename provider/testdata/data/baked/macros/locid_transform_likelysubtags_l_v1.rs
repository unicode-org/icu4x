...
macro_rules! __impl_locid_transform_likelysubtags_l_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_LOCID_TRANSFORM_LIKELYSUBTAGS_L_V1: &<icu_locid_transform::provider::LikelySubtagsForLanguageV1Marker as icu_provider::DataMarker>::Yokeable = &icu_locid_transform::provider::LikelySubtagsForLanguageV1 {
