...
macro_rules! __impl_propnames_to_long_sparse_ccc_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub const SINGLETON_PROPNAMES_TO_LONG_SPARSE_CCC_V1: &'static <icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker as icu_provider::DataMarker>::Yokeable = &icu_properties::provider::names::PropertyEnumToValueNameSparseMapV1 {
                map: unsafe {
                    #[allow(unused_unsafe)]
            ...
            #[doc(hidden)]
            pub fn lookup_propnames_to_long_sparse_ccc_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
                if locale.is_empty() {
        ...
        impl icu_provider::DataProvider<icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker>, icu_provider::DataError> {
                match Self::lookup_propnames_to_long_sparse_ccc_v1(&req.locale) {
                    ...
                    Err(e) => Err(e.with_req(<icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
