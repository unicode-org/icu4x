...
macro_rules! __impl_compactdecimal_short_v1 {
    ($ provider : path) => {
        ...
        impl $provider {
            #[doc(hidden)]
            pub fn lookup_compactdecimal_short_v1(locale: &icu_provider::DataLocale) -> Result<&'static <icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable, icu_provider::DataErrorKind> {
                ...
                match ["ar", "ar-EG", "ar-EG-u-nu-latn", "ar-u-nu-latn", "bn", "bn-u-nu-latn", "ccp", "ccp-u-nu-latn", "en", "en-001", "en-ZA", "es", "es-AR", "fil", "fr", "ja", "ru", "sr", "sr-Cyrl", "sr-Latn", "th", "th-u-nu-thai", "tr", "und"].binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                    Ok(i) => Ok(*unsafe { [&AR, &AR, &AR, &AR, &BN, &BN, &CCP, &CCP, &EN, &EN, &EN, &ES, &ES_AR, &EN, &FR, &JA, &RU, &SR, &SR, &SR_LATN, &EN, &EN, &TR, &CCP].get_unchecked(i) }),
        ...
        impl icu_provider::DataProvider<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker>, icu_provider::DataError> {
                match Self::lookup_compactdecimal_short_v1(&req.locale) {
