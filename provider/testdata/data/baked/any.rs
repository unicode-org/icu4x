    ...
    fn load_any(&self, key: ResourceKey, req: &DataRequest) -> Result<AnyResponse, DataError> {
        Ok(AnyResponse {
            payload: Some(match key {
                ...
                <::icu_normalizer::provider::NonRecursiveDecompositionSupplementV1Marker as ResourceMarker>::KEY => {
                    AnyPayload::from_static_ref::<<::icu_normalizer::provider::NonRecursiveDecompositionSupplementV1Marker as DataMarker>::Yokeable>(
