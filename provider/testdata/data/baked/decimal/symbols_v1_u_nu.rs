// @generated
type DataStruct = & 'static < :: icu_decimal :: provider :: DecimalSymbolsV1Marker as :: icu_provider :: DataMarker > :: Yokeable ;
pub static DATA: &[(&str, DataStruct)] = &[
    ...
    ("ccp", CCP_CCP_U_NU_LATN),
    ("ccp-u-nu-latn", CCP_CCP_U_NU_LATN),
    ("en", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("en-001", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("en-ZA", EN_ZA_RU),
    ("es", ES),
    ("es-AR", ES_AR_SR_SR_CYRL_SR_LATN_TR),
    ("fil", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("fr", FR),
    ("ja", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("ru", EN_ZA_RU),
    ("sr", ES_AR_SR_SR_CYRL_SR_LATN_TR),
    ("sr-Cyrl", ES_AR_SR_SR_CYRL_SR_LATN_TR),
    ("sr-Latn", ES_AR_SR_SR_CYRL_SR_LATN_TR),
    ("th", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("th-u-nu-thai", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
    ("tr", ES_AR_SR_SR_CYRL_SR_LATN_TR),
    ("und", EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND),
];
...
static BN_BN_U_NU_LATN: DataStruct = &::icu_decimal::provider::DecimalSymbolsV1 {
    minus_sign_affixes: ::icu_decimal::provider::AffixesV1 {
...
static CCP_CCP_U_NU_LATN: DataStruct = &::icu_decimal::provider::DecimalSymbolsV1 {
    minus_sign_affixes: ::icu_decimal::provider::AffixesV1 {
        prefix: alloc::borrow::Cow::Borrowed("-"),
        suffix: alloc::borrow::Cow::Borrowed(""),
    },
...
static EN_EN_001_FIL_JA_TH_TH_U_NU_THAI_UND: DataStruct =
