...
impl DataProvider<::icu_relativetime::provider::NarrowRelativeTimeV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_relativetime::provider::NarrowRelativeTimeV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *relativetime::narrow_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                    .ok_or_else(|| DataErrorKind::MissingLocale.with_req(::icu_relativetime::provider::NarrowRelativeTimeV1Marker::KEY, req))?,
            ))),
        })
    }
}
#[cfg(feature = "icu_relativetime")]
impl DataProvider<::icu_relativetime::provider::ShortRelativeTimeV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_relativetime::provider::ShortRelativeTimeV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *relativetime::short_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                    .ok_or_else(|| DataErrorKind::MissingLocale.with_req(::icu_relativetime::provider::ShortRelativeTimeV1Marker::KEY, req))?,
            ))),
        })
    }
}
#[cfg(feature = "icu_relativetime")]
impl DataProvider<::icu_relativetime::provider::StandardRelativeTimeV1Marker> for BakedDataProvider {
    fn load(&self, req: DataRequest) -> Result<DataResponse<::icu_relativetime::provider::StandardRelativeTimeV1Marker>, DataError> {
        Ok(DataResponse {
            metadata: Default::default(),
            payload: Some(DataPayload::from_owned(zerofrom::ZeroFrom::zero_from(
                *relativetime::standard_v1::DATA
                    .get_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse())
                    .ok_or_else(|| DataErrorKind::MissingLocale.with_req(::icu_relativetime::provider::StandardRelativeTimeV1Marker::KEY, req))?,
            ))),
        })
    }
}
