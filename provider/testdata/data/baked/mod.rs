...
macro_rules! __impl_data_provider {
    ($ provider : path) => {
        ...
        impl_currency_essential_v1!($provider);
    ...
    ($ provider : path) => {
        ...
        impl icu_provider::AnyProvider for $provider {
            fn load_any(&self, key: icu_provider::DataKey, req: icu_provider::DataRequest) -> Result<icu_provider::AnyResponse, icu_provider::DataError> {
                ...
                #[cfg(feature = "icu_singlenumberformatter")]
                const CURRENCY_ESSENTIAL_V1: icu_provider::DataKeyHash = <icu_singlenumberformatter::provider::CurrencyEssentialV1Maker as icu_provider::KeyedDataMarker>::KEY.hashed();
                #[cfg(feature = "icu_datetime")]
                ...
                match key.hashed() {
                    ...
                    #[cfg(feature = "icu_singlenumberformatter")]
                    CURRENCY_ESSENTIAL_V1 => icu_provider::DataProvider::<icu_singlenumberformatter::provider::CurrencyEssentialV1Maker>::load(self, req).and_then(|r| r.take_metadata_and_payload()).map(|(metadata, payload)| icu_provider::AnyResponse { payload: Some(payload.wrap_into_any_payload()), metadata }),
                    #[cfg(feature = "icu_datetime")]
