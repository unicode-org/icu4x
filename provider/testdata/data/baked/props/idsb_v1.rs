...
impl ResourceProvider<icu_properties::provider::IdsBinaryOperatorV1Marker>
        ...
        let value = VALUES
            ...
            .map_err(|_| {
                DataErrorKind::MissingResourceOptions.with_req(
                    <icu_properties::provider::IdsBinaryOperatorV1Marker>::KEY,
                    req,
                )
            })?;
        Ok(DataResponse {
...
type DataStruct =
    &'static <icu_properties::provider::IdsBinaryOperatorV1Marker as DataMarker>::Yokeable;
    ...
    ::icu_uniset::UnicodeSet::from_parts_unchecked(
        unsafe {
            ::zerovec::ZeroVec::from_bytes_unchecked(&[
                240u8, 47u8, 0u8, 0u8, 242u8, 47u8, 0u8, 0u8, 244u8, 47u8, 0u8, 0u8, 252u8, 47u8,
                0u8, 0u8,
            ])
        },
        10usize,
