...
impl ResourceProvider<icu_properties::provider::IdsTrinaryOperatorV1Marker>
        ...
        let value = VALUES
            ...
            .map_err(|_| {
                DataErrorKind::MissingResourceOptions.with_req(
                    <icu_properties::provider::IdsTrinaryOperatorV1Marker>::KEY,
                    req,
                )
            })?;
        Ok(DataResponse {
...
static UND: DataStruct = &::icu_properties::provider::UnicodePropertyV1 {
    inv_list: unsafe {
        ...
        ::icu_uniset::UnicodeSet::from_parts_unchecked(
            unsafe {
                static DATA: &[u8] = &[242u8, 47u8, 0u8, 0u8, 244u8, 47u8, 0u8, 0u8];
