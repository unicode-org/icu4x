...
impl ResourceProvider<::icu_list::provider::AndListV1Marker> for super::super::BakedDataProvider {
    fn load_resource(
        &self,
        req: &DataRequest,
...
type DataStruct = &'static <::icu_list::provider::AndListV1Marker as DataMarker>::Yokeable;
...
static CCP: DataStruct = &::icu_list::provider::ListFormatterPatternsV1([
    ::icu_list::provider::ConditionalListJoinerPattern {
        default: unsafe {
            ::icu_list::provider::ListJoinerPattern::from_parts_unchecked(", ", 2u8)
        },
