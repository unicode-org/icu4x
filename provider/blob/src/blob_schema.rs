...
pub(crate) enum BlobSchema<'data> {
    ...
    #[serde(borrow)]
    V003(BlobSchema<'data, Index16>),
    #[serde(borrow)]
    V003Bigger(BlobSchema<'data, Index32>),
}
...
pub(crate) struct BlobSchema<'data, LocaleVecFormat: VarZeroVecFormat> {
...
impl<LocaleVecFormat: VarZeroVecFormat> Default for BlobSchema<'_, LocaleVecFormat> {
    fn default() -> Self {
        Self {
...
impl<'data, LocaleVecFormat: VarZeroVecFormat> BlobSchema<'data, LocaleVecFormat> {
    pub fn load(
        &self,
        marker: DataMarkerInfo,
        req: DataRequest,
