...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::segmenter::provider::GraphemeClusterBreakDataV1Marker = "segmenter/grapheme@1",
            icu::segmenter::provider::LineBreakDataV1Marker = "segmenter/line@1",
            icu::segmenter::provider::LstmForWordLineAutoV1Marker = "segmenter/lstm/wl_auto@1",
            icu::segmenter::provider::SentenceBreakDataV1Marker = "segmenter/sentence@1",
            ...
            icu::datetime::provider::neo::BuddhistDatePatternV1Marker = "datetime/patterns/buddhist/date@1",
            icu::datetime::provider::neo::ChineseDatePatternV1Marker = "datetime/patterns/chinese/date@1",
            icu::datetime::provider::neo::CopticDatePatternV1Marker = "datetime/patterns/coptic/date@1",
            icu::datetime::provider::neo::DangiDatePatternV1Marker = "datetime/patterns/dangi/date@1",
            icu::datetime::provider::neo::EthiopianDatePatternV1Marker = "datetime/patterns/ethiopic/date@1",
            icu::datetime::provider::neo::GregorianDatePatternV1Marker = "datetime/patterns/gregory/date@1",
            icu::datetime::provider::neo::HebrewDatePatternV1Marker = "datetime/patterns/hebrew/date@1",
            icu::datetime::provider::neo::IndianDatePatternV1Marker = "datetime/patterns/indian/date@1",
            icu::datetime::provider::neo::IslamicDatePatternV1Marker = "datetime/patterns/islamic/date@1",
            icu::datetime::provider::neo::JapaneseDatePatternV1Marker = "datetime/patterns/japanese/date@1",
            icu::datetime::provider::neo::JapaneseExtendedDatePatternV1Marker = "datetime/patterns/japanext/date@1",
            icu::datetime::provider::neo::PersianDatePatternV1Marker = "datetime/patterns/persian/date@1",
            icu::datetime::provider::neo::RocDatePatternV1Marker = "datetime/patterns/roc/date@1",
            icu::datetime::provider::neo::GregorianDateDayNeoSkeletonPatternsV1Marker = "datetime/patterns/gregory/date_day_skeleton@1",
            icu::datetime::provider::neo::GregorianDateExtNeoSkeletonPatternsV1Marker = "datetime/patterns/gregory/date_ext_skeleton@1",
