...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu_calendar::provider::IslamicObservationalCacheV1Marker = "calendar/islamicobservationalcache@1",
            ...
            icu_datetime::provider::calendar::BuddhistDateLengthsV1Marker = "datetime/buddhist/datelengths@1",
            icu_datetime::provider::calendar::BuddhistDateSymbolsV1Marker = "datetime/buddhist/datesymbols@1",
            ...
            icu_datetime::provider::calendar::EthiopianDateLengthsV1Marker = "datetime/ethiopic/datelengths@1",
            icu_datetime::provider::calendar::EthiopianDateSymbolsV1Marker = "datetime/ethiopic/datesymbols@1",
            icu_datetime::provider::calendar::GregorianDateLengthsV1Marker = "datetime/gregory/datelengths@1",
            icu_datetime::provider::calendar::GregorianDateSymbolsV1Marker = "datetime/gregory/datesymbols@1",
            ...
            icu_datetime::provider::calendar::JapaneseDateLengthsV1Marker = "datetime/japanese/datelengths@1",
            icu_datetime::provider::calendar::JapaneseDateSymbolsV1Marker = "datetime/japanese/datesymbols@1",
            icu_datetime::provider::calendar::JapaneseExtendedDateLengthsV1Marker = "datetime/japanext/datelengths@1",
            icu_datetime::provider::calendar::JapaneseExtendedDateSymbolsV1Marker = "datetime/japanext/datesymbols@1",
            ...
            icu_datetime::provider::time_zones::MetazoneGenericNamesLongV1Marker = "time_zone/generic_long@1",
            icu_datetime::provider::time_zones::MetazoneGenericNamesShortV1Marker = "time_zone/generic_short@1",
            icu_datetime::provider::time_zones::MetazoneSpecificNamesLongV1Marker = "time_zone/specific_long@1",
            icu_datetime::provider::time_zones::MetazoneSpecificNamesShortV1Marker = "time_zone/specific_short@1",
            ...
            icu_locid_transform::provider::LikelySubtagsExtendedV1Marker = "locid_transform/likelysubtags_ext@1",
            icu_locid_transform::provider::LikelySubtagsForLanguageV1Marker = "locid_transform/likelysubtags_l@1",
            icu_locid_transform::provider::LikelySubtagsForScriptRegionV1Marker = "locid_transform/likelysubtags_sr@1",
            ...
            icu_properties::provider::bidi_data::BidiAuxiliaryPropertiesV1Marker = "props/bidiauxiliaryprops@1",
            ...
            icu_properties::provider::CanonicalCombiningClassValueToLongNameV1Marker = "propnames/to/long/sparse/ccc@1",
            icu_properties::provider::CanonicalCombiningClassValueToShortNameV1Marker = "propnames/to/short/sparse/ccc@1",
            ...
            icu_properties::provider::EastAsianWidthValueToLongNameV1Marker = "propnames/to/long/linear/ea@1",
            icu_properties::provider::EastAsianWidthValueToShortNameV1Marker = "propnames/to/short/linear/ea@1",
            ...
            icu_properties::provider::ExemplarCharactersAuxiliaryV1Marker = "props/exemplarchars/auxiliary@1",
            ...
            icu_properties::provider::ExemplarCharactersPunctuationV1Marker = "props/exemplarchars/punctuation@1",
            ...
            icu_properties::provider::GeneralCategoryValueToLongNameV1Marker = "propnames/to/long/linear/gc@1",
            icu_properties::provider::GeneralCategoryValueToShortNameV1Marker = "propnames/to/short/linear/gc@1",
            ...
            icu_properties::provider::GraphemeClusterBreakValueToLongNameV1Marker = "propnames/to/long/linear/GCB@1",
            icu_properties::provider::GraphemeClusterBreakValueToShortNameV1Marker = "propnames/to/short/linear/GCB@1",
            ...
            icu_properties::provider::IndicSyllabicCategoryValueToLongNameV1Marker = "propnames/to/long/linear/InSC@1",
            icu_properties::provider::IndicSyllabicCategoryValueToShortNameV1Marker = "propnames/to/short/linear/InSC@1",
            ...
            icu_properties::provider::JoiningTypeValueToShortNameV1Marker = "propnames/to/short/linear/jt@1",
            ...
            icu_properties::provider::SentenceBreakValueToLongNameV1Marker = "propnames/to/long/linear/SB@1",
            icu_properties::provider::SentenceBreakValueToShortNameV1Marker = "propnames/to/short/linear/SB@1",
            ...
            icu_segmenter::provider::DictionaryForWordLineExtendedV1Marker = "segmenter/dictionary/wl_ext@1",
            ...
            icu_datetime::provider::neo::JapaneseExtendedYearNamesV1Marker = "datetime/symbols/japanext/years@1",
            ...
            icu_datetime::provider::neo::JapaneseExtendedMonthNamesV1Marker = "datetime/symbols/japanext/months@1",
            ...
            icu_datetime::provider::neo::JapaneseExtendedDatePatternV1Marker = "datetime/patterns/japanext/date@1",
            ...
            icu_datetime::provider::neo::GregorianDateNeoSkeletonPatternsV1Marker = "datetime/patterns/gregory/date_skeleton@1",
            icu_datetime::provider::neo::TimeNeoSkeletonPatternsV1Marker = "datetime/patterns/time_skeleton@1",
            icu_experimental::compactdecimal::provider::LongCompactDecimalFormatDataV1Marker = "compactdecimal/long@1",
            icu_experimental::compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker = "compactdecimal/short@1",
            icu_experimental::dimension::provider::currency::CurrencyEssentialsV1Marker = "currency/essentials@1",
            icu_experimental::dimension::provider::percent::PercentEssentialsV1Marker = "percent/essentials@1",
            icu_experimental::displaynames::provider::RegionDisplayNamesV1Marker = "displaynames/regions@1",
            icu_experimental::displaynames::provider::LanguageDisplayNamesV1Marker = "displaynames/languages@1",
            ...
            icu_experimental::displaynames::provider::VariantDisplayNamesV1Marker = "displaynames/variants@1",
            icu_experimental::relativetime::provider::LongSecondRelativeTimeFormatDataV1Marker = "relativetime/long/second@1",
            icu_experimental::relativetime::provider::ShortSecondRelativeTimeFormatDataV1Marker = "relativetime/short/second@1",
            icu_experimental::relativetime::provider::NarrowSecondRelativeTimeFormatDataV1Marker = "relativetime/narrow/second@1",
            icu_experimental::relativetime::provider::LongMinuteRelativeTimeFormatDataV1Marker = "relativetime/long/minute@1",
            icu_experimental::relativetime::provider::ShortMinuteRelativeTimeFormatDataV1Marker = "relativetime/short/minute@1",
            icu_experimental::relativetime::provider::NarrowMinuteRelativeTimeFormatDataV1Marker = "relativetime/narrow/minute@1",
            icu_experimental::relativetime::provider::LongHourRelativeTimeFormatDataV1Marker = "relativetime/long/hour@1",
            icu_experimental::relativetime::provider::ShortHourRelativeTimeFormatDataV1Marker = "relativetime/short/hour@1",
            icu_experimental::relativetime::provider::NarrowHourRelativeTimeFormatDataV1Marker = "relativetime/narrow/hour@1",
            icu_experimental::relativetime::provider::LongDayRelativeTimeFormatDataV1Marker = "relativetime/long/day@1",
            icu_experimental::relativetime::provider::ShortDayRelativeTimeFormatDataV1Marker = "relativetime/short/day@1",
            icu_experimental::relativetime::provider::NarrowDayRelativeTimeFormatDataV1Marker = "relativetime/narrow/day@1",
            icu_experimental::relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker = "relativetime/long/week@1",
            icu_experimental::relativetime::provider::ShortWeekRelativeTimeFormatDataV1Marker = "relativetime/short/week@1",
            icu_experimental::relativetime::provider::NarrowWeekRelativeTimeFormatDataV1Marker = "relativetime/narrow/week@1",
            icu_experimental::relativetime::provider::LongMonthRelativeTimeFormatDataV1Marker = "relativetime/long/month@1",
            icu_experimental::relativetime::provider::ShortMonthRelativeTimeFormatDataV1Marker = "relativetime/short/month@1",
            icu_experimental::relativetime::provider::NarrowMonthRelativeTimeFormatDataV1Marker = "relativetime/narrow/month@1",
            icu_experimental::relativetime::provider::LongQuarterRelativeTimeFormatDataV1Marker = "relativetime/long/quarter@1",
            icu_experimental::relativetime::provider::ShortQuarterRelativeTimeFormatDataV1Marker = "relativetime/short/quarter@1",
            icu_experimental::relativetime::provider::NarrowQuarterRelativeTimeFormatDataV1Marker = "relativetime/narrow/quarter@1",
            icu_experimental::relativetime::provider::LongYearRelativeTimeFormatDataV1Marker = "relativetime/long/year@1",
            icu_experimental::relativetime::provider::ShortYearRelativeTimeFormatDataV1Marker = "relativetime/short/year@1",
            icu_experimental::relativetime::provider::NarrowYearRelativeTimeFormatDataV1Marker = "relativetime/narrow/year@1",
            icu_experimental::transliterate::provider::TransliteratorRulesV1Marker = "transliterator/rules@1",
