...
registry!(
    ...
    icu_datetime::provider::calendar::IslamicObservationalDateLengthsV1Marker = "datetime/islamicobservational/datelengths@1",
    icu_datetime::provider::calendar::IslamicObservationalDateSymbolsV1Marker = "datetime/islamicobservational/datesymbols@1",
    icu_datetime::provider::calendar::IslamicCivilDateLengthsV1Marker = "datetime/islamiccivil/datelengths@1",
    icu_datetime::provider::calendar::IslamicCivilDateSymbolsV1Marker = "datetime/islamiccivil/datesymbols@1",
    icu_datetime::provider::calendar::UmmAlQuraDateLengthsV1Marker = "datetime/ummalqura/datelengths@1",
    icu_datetime::provider::calendar::UmmAlQuraDateSymbolsV1Marker = "datetime/ummalqura/datesymbols@1",
    icu_datetime::provider::calendar::IslamicTabularDateLengthsV1Marker = "datetime/islamictabular/datelengths@1",
    icu_datetime::provider::calendar::IslamicTabularDateSymbolsV1Marker = "datetime/islamictabular/datesymbols@1",
