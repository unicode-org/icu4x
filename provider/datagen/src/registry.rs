...
macro_rules! registry(
    ($cb:ident) => {
        cb!(
            ...
            icu::experimental::dimension::currency::provider::currency::CurrencyEssentialsV1Marker = "currency/essentials@1",
            icu::experimental::dimension::currency::provider::percent::PercentEssentialsV1Marker = "percent/essentials@1",
