...
impl DataProvider<ShortCompactDecimalFormatDataV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl DataProvider<LongCompactDecimalFormatDataV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProviderInternal<LongCompactDecimalFormatDataV1Marker>
    for crate::provider::DatagenProvider
{
    fn supported_locales_impl(&self) -> Result<HashSet<DataLocale>, DataError> {
        self.supported_locales_for_numbers()
