...
fn test_missing_locale() {
    ...
    assert!(
        DataProvider::<icu_provider::hello_world::HelloWorldV1Marker>::load(
            &provider,
            DataRequest {
