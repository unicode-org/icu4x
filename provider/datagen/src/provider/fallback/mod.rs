...
impl DataProvider<LocaleFallbackLikelySubtagsV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl DataProvider<LocaleFallbackParentsV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl DataProvider<CollationFallbackSupplementV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProvider<LocaleFallbackLikelySubtagsV1Marker>
    for crate::provider::DatagenProvider
{
...
impl IterableDataProvider<LocaleFallbackParentsV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}

impl IterableDataProvider<CollationFallbackSupplementV1Marker>
    for crate::provider::DatagenProvider
{
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
...
fn test_basic() {
    ...
    let provider = crate::provider::DatagenProvider::new_testing();
