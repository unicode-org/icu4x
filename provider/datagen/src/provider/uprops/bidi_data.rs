...
impl DataProvider<BidiAuxiliaryPropertiesV1Marker> for crate::provider::DatagenProvider {
    #[cfg(any(feature = "use_wasm", feature = "use_icu4c"))]
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProvider<BidiAuxiliaryPropertiesV1Marker> for crate::provider::DatagenProvider {
