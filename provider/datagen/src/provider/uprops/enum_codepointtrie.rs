...
fn load_values_to_names_sparse<M>(
    p: &crate::provider::DatagenProvider,
    prop_name: &str,
    is_short: bool,
...
macro_rules! expand {
    ($(($marker:ident, $marker_n2e:ident,
        ...
        $(
            ...
            impl DataProvider<$marker_n2e> for crate::provider::DatagenProvider
            {
            ...
            impl IterableDataProvider<$marker_n2e> for crate::provider::DatagenProvider {
                fn supported_locales(
                    &self,
                ) -> Result<Vec<DataLocale>, DataError> {
                    self.get_enumerated_prop($prop_name)?;
            ...
            $(
                impl DataProvider<$marker_e2sns> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2sns> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
                ...
                impl DataProvider<$marker_e2lns> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2lns> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
            ...
            $(
                impl DataProvider<$marker_e2snl> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2snl> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
                ...
                impl DataProvider<$marker_e2lnl> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2lnl> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
            ...
            $(
                impl DataProvider<$marker_e2snl4> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2snl4> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
                ...
                impl DataProvider<$marker_e2lnl4> for crate::provider::DatagenProvider
                {
                ...
                impl IterableDataProvider<$marker_e2lnl4> for crate::provider::DatagenProvider {
                    fn supported_locales(
                        &self,
                    ) -> Result<Vec<DataLocale>, DataError> {
                        self.get_enumerated_prop($prop_name)?;
...
impl DataProvider<GeneralCategoryMaskNameToValueV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProvider<GeneralCategoryMaskNameToValueV1Marker>
