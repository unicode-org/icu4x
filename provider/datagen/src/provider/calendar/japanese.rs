...
impl DataProvider<JapaneseErasV1Marker> for crate::provider::DatagenProvider {
...
impl DataProvider<JapaneseExtendedErasV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProvider<JapaneseErasV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}

impl IterableDataProvider<JapaneseExtendedErasV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}
