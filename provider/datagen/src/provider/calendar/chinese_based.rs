...
impl DataProvider<ChineseCacheV1Marker> for crate::provider::DatagenProvider {
...
impl DataProvider<DangiCacheV1Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProvider<ChineseCacheV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}

impl IterableDataProvider<DangiCacheV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}
