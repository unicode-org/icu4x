...
impl DataProvider<TransliteratorRulesV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProvider<TransliteratorRulesV1Marker> for crate::provider::DatagenProvider {
