...
macro_rules! exemplar_chars_impls {
    ($data_marker_name:ident, $cldr_serde_field_name:ident) => {
        impl DataProvider<$data_marker_name> for crate::provider::DatagenProvider {
        ...
        impl IterableDataProviderInternal<$data_marker_name> for crate::provider::DatagenProvider {
