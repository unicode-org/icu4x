...
impl DataProvider<IanaToBcp47MapV1Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProvider<IanaToBcp47MapV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}

impl DataProvider<IanaToBcp47MapV2Marker> for crate::provider::DatagenProvider {
...
impl DataProvider<Bcp47ToIanaMapV1Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProvider<Bcp47ToIanaMapV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}
