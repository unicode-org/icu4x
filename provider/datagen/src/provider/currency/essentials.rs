...
use crate::provider::decimal::decimal_pattern::DecimalPattern;
...
impl DataProvider<CurrencyEssentialsV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProviderInternal<CurrencyEssentialsV1Marker> for crate::provider::DatagenProvider {
