...
fn generate_rule_break_data(
    provider: &crate::provider::DatagenProvider,
    rules_file: &str,
...
macro_rules! implement {
    ($marker:ident, $rules:literal) => {
        impl DataProvider<$marker> for crate::provider::DatagenProvider {
        ...
        impl IterableDataProvider<$marker> for crate::provider::DatagenProvider {
...
fn hardcoded_segmenter_provider() -> crate::provider::DatagenProvider {
    #![allow(deprecated)]
    use crate::provider::{
