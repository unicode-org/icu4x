...
impl IterableDataProviderInternal<WeekDataV1Marker> for crate::provider::DatagenProvider {
...
impl DataProvider<WeekDataV1Marker> for crate::provider::DatagenProvider {
...
impl DataProvider<WeekDataV2Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProviderInternal<WeekDataV2Marker> for crate::provider::DatagenProvider {
    fn supported_locales_impl(&self) -> Result<HashSet<DataLocale>, DataError> {
