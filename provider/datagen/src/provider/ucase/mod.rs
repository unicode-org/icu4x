...
impl DataProvider<CaseMapV1Marker> for crate::provider::DatagenProvider {
...
impl icu_provider::datagen::IterableDataProvider<CaseMapV1Marker>
...
impl DataProvider<CaseMapUnfoldV1Marker> for crate::provider::DatagenProvider {
...
impl icu_provider::datagen::IterableDataProvider<CaseMapUnfoldV1Marker>
    for crate::provider::DatagenProvider
{
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
