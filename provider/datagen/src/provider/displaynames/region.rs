...
impl DataProvider<RegionDisplayNamesV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProviderInternal<RegionDisplayNamesV1Marker> for crate::provider::DatagenProvider {
