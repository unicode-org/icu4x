...
impl DataProvider<LanguageDisplayNamesV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl DataProvider<LocaleDisplayNamesV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProviderInternal<LanguageDisplayNamesV1Marker>
...
impl IterableDataProviderInternal<LocaleDisplayNamesV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales_impl(&self) -> Result<HashSet<DataLocale>, DataError> {
        Ok(self
            .cldr()?
            .displaynames()
