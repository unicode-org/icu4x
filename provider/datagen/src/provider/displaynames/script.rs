...
impl DataProvider<ScriptDisplayNamesV1Marker> for crate::provider::DatagenProvider {
    fn load(
        &self,
        req: DataRequest,
...
impl IterableDataProviderInternal<ScriptDisplayNamesV1Marker> for crate::provider::DatagenProvider {
