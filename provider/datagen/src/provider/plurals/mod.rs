...
impl DataProvider<PluralRangesV1Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProviderInternal<PluralRangesV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales_impl(&self) -> Result<HashSet<DataLocale>, DataError> {
        Ok(self
            .get_plural_ranges()?
            .0
