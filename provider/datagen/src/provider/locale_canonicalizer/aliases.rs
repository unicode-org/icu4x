...
impl DataProvider<AliasesV1Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProvider<AliasesV1Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}

impl DataProvider<AliasesV2Marker> for crate::provider::DatagenProvider {
...
impl IterableDataProvider<AliasesV2Marker> for crate::provider::DatagenProvider {
    fn supported_locales(&self) -> Result<Vec<DataLocale>, DataError> {
        Ok(vec![Default::default()])
    }
}
