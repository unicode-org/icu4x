...
include!("decimal_symbols_v1_marker.rs.data");
...
include!("aliases_v1_marker.rs.data");
include!("aliases_v2_marker.rs.data");
include!("likely_subtags_v1_marker.rs.data");
...
macro_rules! impl_data_provider {
    ($ provider : ty) => {
        ...
        impl_decimal_symbols_v1_marker!($provider);
        ...
        impl_aliases_v1_marker!($provider);
        impl_aliases_v2_marker!($provider);
        impl_likely_subtags_v1_marker!($provider);
