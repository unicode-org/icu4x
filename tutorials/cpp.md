...
[dependencies]
icu_capi = { version = "2.0.0-beta1", default-features = false, features = [] }
```
...
```toml
icu_capi = { version = "2.0.0-beta1", default-features = false, features = ["default", "buffer_provider"] }
...
```toml
icu_capi = { version = "2.0.0-beta1", default-features = false, features = ["default_components", "buffer_provider", "looping_panic_handler", "libc_alloc"] }
