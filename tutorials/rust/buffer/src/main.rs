...
use icu::datetime::{TypedDateTimeFormatter, neo_marker::NeoAutoDateTimeMarker, neo_skeleton::NeoSkeletonLength};
...
fn main() {
    ...
    let formatter = TypedDateTimeFormatter::<Gregorian, _>::try_new_with_buffer_provider(
        &provider,
        &locale!("my").into(),
