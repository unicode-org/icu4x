...
int main() {
    ...
    diplomat_result_box_ICU4XLocale_ICU4XLocaleParseError locale_result = ICU4XLocale_create_from_string("bn", 2);
    ...
    diplomat_result_box_ICU4XFixedDecimal_ICU4XFixedDecimalParseError fd_result = ICU4XFixedDecimal_create_from_string("1000007.070", 11);
    if (!fd_result.is_ok) {
