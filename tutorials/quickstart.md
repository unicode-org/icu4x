...
```javascript
import { Locale, DateFormatter, IsoDate, DateTimeLength } 
    from "https://storage.googleapis.com/static-493776/2_0/npm/lib/index.mjs";
```
...
Next, learn how to [generate optimized data for your binary](data-management.md), [configure your Cargo.toml file](../examples/cargo/README.md), or continue exploring by reading [the docs](https://docs.rs/icu/latest/).
