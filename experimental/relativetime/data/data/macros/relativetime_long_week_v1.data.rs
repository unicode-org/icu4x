    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker>, icu_provider::DataError> {
                ...
                static ZH_HANT_HK: <icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_relativetime::provider::RelativeTimePatternDataV1 {
                    relatives: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static PT_PT: <icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_relativetime::provider::RelativeTimePatternDataV1 {
                    relatives: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static SR_CYRL_BA: <icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_relativetime::provider::RelativeTimePatternDataV1 {
                    relatives: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static VALUES: [&<icu_relativetime::provider::LongWeekRelativeTimeFormatDataV1Marker as icu_provider::DataMarker>::Yokeable; 145usize] = [&AF, &AM, &AR, &AS, &AST, &AZ, &AZ, &BE, &BG, &BGC, &BN, &BR, &BRX, &BS, &BS_CYRL, &BS, &CA, &CEB, &CHR, &CS, &CV, &CY, &DA, &DE, &DE, &DSB, &EL, &EN, &ES, &ES, &ES_MX, &ET, &EU, &FA, &FA, &FF_ADLM, &FI, &FIL, &FO, &FR, &GA, &GD, &GL, &GU, &HA, &HE, &HI, &HI_LATN, &HR, &HSB, &HU, &HY, &IA, &ID, &IG, &IS, &IT, &IT, &JA, &JV, &KA, &KEA, &KGP, &KK, &KM, &KN, &KO, &KOK, &KS, &KS, &KY, &LO, &LT, &LV, &MAI, &MI, &MK, &ML, &MN, &MR, &MS, &MY, &NE, &NL, &NL, &NL, &NN, &NO, &OR, &PA, &PCM, &PL, &PS, &PT, &PT_PT, &QU, &RAJ, &RO, &RU, &SC, &SD, &SD, &SI, &SK, &SL, &SO, &SO, &SQ, &SR, &SR_CYRL_BA, &SR_LATN, &SR_LATN_BA, &SV, &SW, &TA, &TA, &TA, &TE, &TG, &TH, &TI, &TK, &TO, &TR, &TT, &UK, &UND, &UR, &UR_IN, &UZ, &UZ_CYRL, &UZ, &VI, &WO, &XH, &YO, &YO_BJ, &YRL, &YUE, &YUE_HANS, &ZH, &ZH, &ZH_HANT, &ZH_HANT_HK, &ZU];
                static KEYS: [&str; 145usize] = ["af", "am", "ar", "as", "ast", "az", "az-Latn", "be", "bg", "bgc", "bn", "br", "brx", "bs", "bs-Cyrl", "bs-Latn", "ca", "ceb", "chr", "cs", "cv", "cy", "da", "de", "de-AT", "dsb", "el", "en", "es", "es-IC", "es-MX", "et", "eu", "fa", "fa-AF", "ff-Adlm", "fi", "fil", "fo", "fr", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hi-Latn", "hr", "hsb", "hu", "hy", "ia", "id", "ig", "is", "it", "it-CH", "ja", "jv", "ka", "kea", "kgp", "kk", "km", "kn", "ko", "kok", "ks", "ks-Arab", "ky", "lo", "lt", "lv", "mai", "mi", "mk", "ml", "mn", "mr", "ms", "my", "ne", "nl", "nl-AW", "nl-CW", "nn", "no", "or", "pa", "pcm", "pl", "ps", "pt", "pt-PT", "qu", "raj", "ro", "ru", "sc", "sd", "sd-Arab", "si", "sk", "sl", "so", "so-DJ", "sq", "sr", "sr-Cyrl-BA", "sr-Latn", "sr-Latn-BA", "sv", "sw", "ta", "ta-LK", "ta-MY", "te", "tg", "th", "ti", "tk", "to", "tr", "tt", "uk", "und", "ur", "ur-IN", "uz", "uz-Cyrl", "uz-Latn", "vi", "wo", "xh", "yo", "yo-BJ", "yrl", "yue", "yue-Hans", "zh", "zh-Hans", "zh-Hant", "zh-Hant-HK", "zu"];
