    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker>, icu_provider::DataError> {
                ...
                static MI: <icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_compactdecimal::provider::CompactDecimalPatternDataV1 {
                    patterns: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static VALUES: [&<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable; 252usize] = [&AF, &AM, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AS, &AS, &AST, &AZ, &AZ, &BE, &BG, &BN, &BN, &BR, &BRX, &BRX, &BS, &BS_CYRL, &CA, &CHR, &CS, &CY, &DA, &DA, &DE, &DE, &DE, &DSB, &EL, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &EN, &ES, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ES, &ES_419, &ES_419, &ES_419, &ES_419, &ES_419, &ET, &EU, &FA, &FA, &FF_ADLM, &FF_ADLM, &FF_ADLM, &FF_ADLM, &FF_ADLM, &FI, &FIL, &FO, &FO, &FR, &FR, &FR_CA, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &FR, &GA, &GA, &GD, &GL, &GU, &GU, &HA, &HE, &HI, &HR, &HR, &HSB, &HU, &HY, &IA, &ID, &IS, &IT, &IT, &JA, &JV, &KA, &KEA, &KGP, &KK, &KM, &KN, &KO, &KOK, &KOK, &KY, &LO, &LO_U_NU_LAOO, &LT, &LV, &MI, &MK, &ML, &MN, &MR, &MR, &MS, &MS, &MY, &NB, &NE, &NE, &NE, &NL, &NL, &NL, &NL, &NL, &NN, &NB, &OR, &PA, &PCM, &PL, &PT, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &PT_AO, &RO, &RU, &RU, &SC, &SD, &SD, &SI, &SK, &SL, &SO, &SO, &SQ, &SQ, &SQ, &SR, &SR, &SR, &BS, &SV, &SV, &SV, &SW, &SW, &TA, &TA, &TE, &TG, &TH, &TH, &TI, &TI, &TK, &TO, &TR, &UK, &MI, &UR, &UR, &UZ, &UZ_CYRL, &VI, &YO, &YO_BJ, &YRL, &YRL_CO, &YRL_CO, &YUE, &YUE_HANS, &YUE_HANS, &YUE, &YUE, &YUE, &ZH, &ZH, &ZH, &ZH, &ZH, &ZH_HANT, &ZH_HANT, &ZH, &ZU];
                static KEYS: [&str; 252usize] = ["af", "am", "ar", "ar-AE", "ar-BH", "ar-DZ", "ar-EG", "ar-EH-u-nu-arab", "ar-ER-u-nu-latn", "ar-IL", "ar-IQ-u-nu-latn", "ar-JO", "ar-KM-u-nu-latn", "ar-KW", "ar-LY", "ar-LY-u-nu-arab", "ar-MA-u-nu-arab", "ar-MR", "ar-OM", "ar-PS-u-nu-latn", "ar-QA-u-nu-latn", "ar-SD", "ar-SO", "ar-TN", "as", "as-u-nu-latn", "ast", "az", "az-Latn", "be", "bg", "bn", "bn-u-nu-latn", "br", "brx", "brx-u-nu-deva", "bs", "bs-Cyrl", "ca", "chr", "cs", "cy", "da", "da-GL", "de", "de-CH", "de-LI", "dsb", "el", "en", "en-150", "en-AE", "en-BB", "en-BS", "en-CC", "en-CY", "en-ER", "en-GM", "en-GU", "en-IM", "en-MP", "en-MT", "en-MY", "en-NA", "en-NG", "en-NU", "en-PH", "en-PK", "en-PW", "en-TT", "en-TV", "en-TZ", "en-UM", "en-VU", "es", "es-419", "es-AR", "es-BO", "es-BR", "es-CL", "es-CO", "es-CR", "es-CU", "es-DO", "es-EA", "es-EC", "es-GT", "es-HN", "es-PA", "es-PE", "es-PH", "es-PR", "es-PY", "es-US", "es-UY", "es-VE", "et", "eu", "fa", "fa-u-nu-latn", "ff-Adlm", "ff-Adlm-GH", "ff-Adlm-GW", "ff-Adlm-NG-u-nu-latn", "ff-Adlm-SL-u-nu-latn", "fi", "fil", "fo", "fo-DK", "fr", "fr-BL", "fr-CA", "fr-CM", "fr-DJ", "fr-GA", "fr-HT", "fr-KM", "fr-MC", "fr-MG", "fr-ML", "fr-NC", "fr-RE", "fr-RW", "fr-TN", "fr-VU", "fr-YT", "ga", "ga-GB", "gd", "gl", "gu", "gu-u-nu-gujr", "ha", "he", "hi", "hr", "hr-BA", "hsb", "hu", "hy", "ia", "id", "is", "it", "it-CH", "ja", "jv", "ka", "kea", "kgp", "kk", "km", "kn", "ko", "kok", "kok-u-nu-deva", "ky", "lo", "lo-u-nu-laoo", "lt", "lv", "mi", "mk", "ml", "mn", "mr", "mr-u-nu-latn", "ms", "ms-BN", "my", "nb", "ne", "ne-IN", "ne-u-nu-latn", "nl", "nl-AW", "nl-BQ", "nl-CW", "nl-SX", "nn", "no", "or", "pa", "pcm", "pl", "pt", "pt-AO", "pt-GQ", "pt-LU", "pt-PT", "pt-ST", "ro", "ru", "ru-KG", "sc", "sd", "sd-Arab-u-nu-latn", "si", "sk", "sl", "so", "so-DJ", "sq", "sq-MK", "sq-XK", "sr", "sr-Cyrl", "sr-Cyrl-XK", "sr-Latn", "sv", "sv-AX", "sv-FI", "sw", "sw-CD", "ta", "ta-LK", "te", "tg", "th", "th-u-nu-thai", "ti", "ti-ER", "tk", "to", "tr", "uk", "und", "ur", "ur-u-nu-arabext", "uz", "uz-Cyrl", "vi", "yo", "yo-BJ", "yrl", "yrl-CO", "yrl-VE", "yue", "yue-Hans", "yue-Hans-u-nu-hanidec", "yue-Hant", "yue-Hant-u-nu-hanidec", "yue-u-nu-hanidec", "zh", "zh-Hans", "zh-Hans-SG", "zh-Hans-SG-u-nu-hanidec", "zh-Hans-u-nu-hanidec", "zh-Hant", "zh-Hant-u-nu-hanidec", "zh-u-nu-hanidec", "zu"];
                let mut metadata = icu_provider::DataResponseMetadata::default();
                let payload = if let Ok(payload) = KEYS.binary_search_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse()).map(|i| *unsafe { VALUES.get_unchecked(i) }) {
                    payload
                } else {
                    const FALLBACKER: icu_locid_transform::fallback::LocaleFallbackerWithConfig<'static> = icu_locid_transform::fallback::LocaleFallbacker::new().for_config(icu_locid_transform::fallback::LocaleFallbackConfig::from_key(<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker as icu_provider::KeyedDataMarker>::KEY));
