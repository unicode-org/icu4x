            ...
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker>, icu_provider::DataError> {
                ...
                match {
                    ...
                    match ["af", "am", "ar", "ar-u-nu-latn", "as", "as-u-nu-latn", "az", "be", "bg", "bn", "bn-u-nu-latn", "bs", "ca", "cs", "cy", "da", "de", "el", "en", "es", "et", "eu", "fa", "fa-u-nu-latn", "fi", "fil", "fr", "ga", "gd", "gl", "gu", "gu-u-nu-gujr", "ha", "he", "hi", "hi-Latn", "hi-u-nu-deva", "hr", "hu", "hy", "id", "ig", "is", "it", "ja", "jv", "jv-u-nu-java", "ka", "kk", "km", "km-u-nu-khmr", "kn", "kn-u-nu-knda", "ko", "kok", "kok-u-nu-deva", "ky", "lo", "lo-u-nu-laoo", "lt", "lv", "mk", "ml", "ml-u-nu-mlym", "mn", "mr", "mr-u-nu-latn", "ms", "my", "my-u-nu-latn", "ne", "ne-u-nu-latn", "nl", "nn", "no", "or", "or-u-nu-orya", "pa", "pa-u-nu-guru", "pcm", "pl", "ps", "ps-u-nu-latn", "pt", "ro", "ru", "sd", "sd-u-nu-latn", "si", "sk", "sl", "so", "sq", "sr", "sr-Latn", "sv", "sw", "ta", "ta-u-nu-tamldec", "te", "te-u-nu-telu", "th", "th-u-nu-thai", "tk", "tr", "uk", "ur", "ur-u-nu-arabext", "uz", "vi", "yo", "yue", "yue-Hans", "yue-Hans-u-nu-hanidec", "yue-u-nu-hanidec", "zh", "zh-Hant", "zh-Hant-u-nu-hanidec", "zh-u-nu-hanidec", "zu"].binary_search_by(|k| locale.strict_cmp(k.as_bytes()).reverse()) {
                        Ok(i) => Ok(*unsafe { [&AF, &AM, &AR, &AR, &AS, &AS, &AZ, &BE, &BG, &BN, &BN, &BS, &CA, &CS, &CY, &DA, &DE, &EL, &EN, &ES, &ET, &EU, &FA, &FA, &FI, &FIL, &FR, &GA, &GD, &GL, &GU, &GU, &HA, &HE, &HI, &EN, &HI, &HR, &HU, &HY, &ID, &IG, &IS, &IT, &JA, &JV, &JV, &KA, &KK, &KM, &KM, &KN, &KN, &KO, &KOK, &KOK, &KY, &LO, &LO_U_NU_LAOO, &LT, &LV, &MK, &ML, &ML, &MN, &MR, &MR, &MS, &MY, &MY, &NE, &NE, &NL, &NN, &NO, &OR, &OR, &PA, &PA, &PCM, &PL, &IG, &IG, &PT, &RO, &RU, &SD, &SD, &SI, &SK, &SL, &SO, &SQ, &SR, &BS, &SV, &SW, &TA, &TA, &TE, &TE, &TH, &TH, &TK, &TR, &UK, &UR, &UR, &UZ, &VI, &YO, &YUE, &YUE_HANS, &YUE_HANS, &YUE, &ZH, &ZH_HANT, &ZH_HANT, &ZH, &ZU].get_unchecked(i) }),
                        Err(_) => Err(icu_provider::DataErrorKind::MissingLocale),
                    }
                } {
                    Ok(payload) => Ok(icu_provider::DataResponse { metadata: Default::default(), payload: Some(icu_provider::DataPayload::from_static_ref(payload)) }),
                    Err(e) => Err(e.with_req(<icu_compactdecimal::provider::LongCompactDecimalFormatDataV1Marker as icu_provider::KeyedDataMarker>::KEY, req)),
                }
            }
        }
    };
