    ...
    ($ provider : path) => {
        ...
        impl icu_provider::DataProvider<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker> for $provider {
            fn load(&self, req: icu_provider::DataRequest) -> Result<icu_provider::DataResponse<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker>, icu_provider::DataError> {
                ...
                static UND: <icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_compactdecimal::provider::CompactDecimalPatternDataV1 {
                    patterns: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static NO: <icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable = icu_compactdecimal::provider::CompactDecimalPatternDataV1 {
                    patterns: unsafe {
                        #[allow(unused_unsafe)]
                ...
                static VALUES: [&<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker as icu_provider::DataMarker>::Yokeable; 158usize] = [&AF, &AF, &AM, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AR, &AS, &AS, &AZ, &BE, &BG, &BN, &BR, &BRX, &BS, &BS_CYRL, &BS, &CA, &CHR, &CS, &CHR, &DA, &DE, &DSB, &EL, &CHR, &EN_IN, &CHR, &ES, &ES_419, &ES_MX, &ES_US, &ET, &EU, &FA, &FA, &FF_ADLM, &FF_ADLM, &FI, &CHR, &FO, &FO, &FR, &FR_CA, &FR, &FR, &GA, &CHR, &EU, &GU, &HA, &HE, &HI, &EN_IN, &HR, &DSB, &HU, &HY, &IA, &ID, &IS, &IT, &IT, &JA, &JV, &KA, &KEA, &KGP, &KK, &KM, &KN, &KN, &KO, &CHR, &KY, &LO, &LO_U_NU_LAOO, &LT, &LV, &MK, &CHR, &CHR, &MN, &MR, &MS, &MY, &MY, &NE, &NL, &NL, &NO, &OR, &OR, &PA, &PA, &CHR, &PL, &PS, &PS, &KGP, &PT_AO, &PT_AO, &RO, &BE, &SC, &SD, &SD, &SD, &SD, &SI, &CS, &SL, &CHR, &CHR, &SQ, &SR, &SR, &SR_LATN, &SV, &SW, &SW_KE, &TA, &TA, &TE, &TG, &CHR, &TI, &TK, &TO, &TR, &UK, &UND, &UR, &UZ, &UZ_CYRL, &VI, &YRL, &YUE, &YUE_HANS, &YUE_HANS, &YUE, &YUE, &ZH, &ZH_HANT, &CHR, &CHR, &CHR, &CHR, &CHR];
                static KEYS: [&str; 158usize] = ["af", "af-NA", "am", "ar", "ar-DJ-u-nu-latn", "ar-EH", "ar-IQ", "ar-KW", "ar-LB-u-nu-latn", "ar-MA", "ar-SA", "ar-SD-u-nu-latn", "ar-TD", "ar-YE-u-nu-latn", "ar-u-nu-latn", "as", "as-u-nu-latn", "az", "be", "bg", "bn", "br", "brx", "bs", "bs-Cyrl", "bs-Latn", "ca", "chr", "cs", "cy", "da", "de", "dsb", "el", "en", "en-IN", "en-UM", "es", "es-419", "es-MX", "es-US", "et", "eu", "fa", "fa-u-nu-latn", "ff-Adlm", "ff-Adlm-BF-u-nu-latn", "fi", "fil", "fo", "fo-DK", "fr", "fr-CA", "fr-RE", "fr-WF", "ga", "gd", "gl", "gu", "ha", "he", "hi", "hi-Latn", "hr", "hsb", "hu", "hy", "ia", "id", "is", "it", "it-CH", "ja", "jv", "ka", "kea", "kgp", "kk", "km", "kn", "kn-u-nu-knda", "ko", "kok", "ky", "lo", "lo-u-nu-laoo", "lt", "lv", "mk", "ml", "ml-u-nu-mlym", "mn", "mr", "ms", "my", "my-u-nu-latn", "ne", "nl", "nl-AW", "no", "or", "or-u-nu-orya", "pa", "pa-Guru-u-nu-guru", "pcm", "pl", "ps", "ps-u-nu-latn", "pt", "pt-AO", "pt-PT", "ro", "ru", "sc", "sd", "sd-Arab", "sd-Arab-u-nu-latn", "sd-u-nu-latn", "si", "sk", "sl", "so", "so-KE", "sq", "sr", "sr-Cyrl", "sr-Latn", "sv", "sw", "sw-KE", "ta", "ta-u-nu-tamldec", "te", "tg", "th", "ti", "tk", "to", "tr", "uk", "und", "ur", "uz", "uz-Cyrl", "vi", "yrl", "yue", "yue-Hans", "yue-Hans-u-nu-hanidec", "yue-Hant", "yue-u-nu-hanidec", "zh", "zh-Hant", "zh-Hant-HK", "zh-Hant-HK-u-nu-hanidec", "zh-Hant-MO", "zh-Hant-MO-u-nu-hanidec", "zu"];
                let mut metadata = icu_provider::DataResponseMetadata::default();
                let payload = if let Ok(payload) = KEYS.binary_search_by(|k| req.locale.strict_cmp(k.as_bytes()).reverse()).map(|i| *unsafe { VALUES.get_unchecked(i) }) {
                    payload
                } else {
                    const FALLBACKER: icu_locid_transform::fallback::LocaleFallbackerWithConfig<'static> = icu_locid_transform::fallback::LocaleFallbacker::new().for_config(icu_locid_transform::fallback::LocaleFallbackConfig::from_key(<icu_compactdecimal::provider::ShortCompactDecimalFormatDataV1Marker as icu_provider::KeyedDataMarker>::KEY));
