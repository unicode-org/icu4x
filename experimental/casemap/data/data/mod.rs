    ...
    ($ provider : path) => {
        ...
        impl icu_provider::AnyProvider for $provider {
            fn load_any(&self, key: icu_provider::DataKey, req: icu_provider::DataRequest) -> Result<icu_provider::AnyResponse, icu_provider::DataError> {
                ...
                const PROPS_CASEMAP_UNFOLD_V1: icu_provider::DataKeyHash = <icu_casemap::provider::unfold::CaseMapUnfoldV1Marker as icu_provider::KeyedDataMarker>::KEY.hashed();
                match key.hashed() {
                    ...
                    PROPS_CASEMAP_UNFOLD_V1 => icu_provider::DataProvider::<icu_casemap::provider::unfold::CaseMapUnfoldV1Marker>::load(self, req).and_then(|r| r.take_metadata_and_payload()).map(|(metadata, payload)| icu_provider::AnyResponse { payload: Some(payload.wrap_into_any_payload()), metadata }),
