...
impl TzifHeader {
    ...
    pub const fn time_size<const V: usize>(&self) -> usize {
        match V {
            1 => 4,
            _ => 8,
        }
    ...
    pub const fn block_size<const V: usize>(&self) -> usize {
...
pub struct DataBlock {
    /// A series of four- or eight-octet UNIX leap-time
    ...
    /// A series of one-octet unsigned integers specifying
