...
Headers can be found under [`ffi/capi/cpp/include`], with docs [here](https://unicode-org.github.io/icu4x/docs/ffi/cpp/). The port is header-only; no additional C++ translation units need to be compiled to use ICU4X from C++.
