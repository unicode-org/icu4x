...
lazy_static::lazy_static! {
    ...
    pub static ref IGNORED_PATHS: HashSet<Vec<String>> = [
        ...
        "icu::calendar::Date::try_new_japanese_date_with_calendar",
        "icu::calendar::Date::try_new_japanese_extended_date_with_calendar",
        "icu::calendar::Date::try_new_julian_date",
        "icu::calendar::Date::try_new_observational_islamic_date_with_calendar",
        "icu::calendar::Date::try_new_persian_date",
        "icu::calendar::Date::try_new_roc_date",
        "icu::calendar::Date::try_new_ummalqura_date_with_calendar",
        ...
        "icu::calendar::DateTime::try_new_japanese_datetime_with_calendar",
        "icu::calendar::DateTime::try_new_japanese_extended_datetime_with_calendar",
        "icu::calendar::DateTime::try_new_julian_datetime",
        "icu::calendar::DateTime::try_new_observational_islamic_datetime_with_calendar",
        "icu::calendar::DateTime::try_new_persian_datetime",
        "icu::calendar::DateTime::try_new_roc_datetime",
        "icu::calendar::DateTime::try_new_ummalqura_datetime_with_calendar",
